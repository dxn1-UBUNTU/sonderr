#!/usr/bin/env bun
/**
 * Preserve Sonderr package versions during upstream merge
 *
 * This script ensures that Sonderr's package versions are not overwritten
...
/**
 * Get the current Sonderr version from the main package.json
 */
