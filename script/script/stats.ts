...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Sonderr-Org/sonderr/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Sonderr-Org/sonderr...\n")
...
console.log("Fetching npm all-time downloads for sonderr-ai...\n")
const npmDownloads = await fetchNpmDownloads("sonderr-ai")
