// Sonderr-specific translations and overrides
// Keys here will override any matching keys from upstream translations
export const dict = {
  // Sonderr Gateway provider translations
  "provider.connect.sonderrGateway.byok.prefix": "Per ulteriori statistiche sull'utilizzo, utilizza ",
  "provider.connect.sonderrGateway.byok.link": "BYOK tramite Sonderr's Gateway",
  "provider.connect.sonderrGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Consigliati",
  "settings.providers.note.sonderr": "Accesso a oltre 500 modelli AI",
  "settings.providers.note.sonderr": "Modelli selezionati, inclusi Claude, GPT, Gemini e altri",
  ...
  "marketplace.install.about.mcp":
    "Un server MCP fornisce a Sonderr strumenti aggiuntivi per interagire con servizi esterni o programmi locali.",
  "marketplace.install.about.agent":
    "Un agente aggiunge un ruolo riutilizzabile con istruzioni e autorizzazioni proprie.",
  "marketplace.install.about.skill":
    "Una skill aggiunge istruzioni e risorse specifiche per un'attività che Sonderr può caricare quando necessario.",
  "marketplace.install.mcp.warning":
    "I server MCP possono eseguire comandi locali o connettersi a servizi esterni. Sonderr chiederà l'autorizzazione prima di usare i loro strumenti, a meno che le tue autorizzazioni non lo consentano automaticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Disattiva gli snapshot di Sonderr per questo progetto. Perderai annulla/ripeti sulle modifiche ai file fatte da Sonderr, ma git continuerà a tracciare tutto.",
