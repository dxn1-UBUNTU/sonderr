export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "Daha fazla kullanım istatistiği için ",
  "provider.connect.sonderrGateway.byok.link": "Sonderr's Gateway üzerinden BYOK",
  "provider.connect.sonderrGateway.byok.suffix": " kullanın.",

  // Provider settings translations
  "settings.providers.group.recommended": "Önerilen",
  "settings.providers.note.sonderr": "500+ AI modeline erişim",
  "settings.providers.note.sonderr": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  ...
  "marketplace.install.about.mcp":
    "Bir MCP sunucusu, harici hizmetler veya yerel programlarla çalışmak için Sonderr'ya ek araçlar sağlar.",
  "marketplace.install.about.agent":
    "Bir ajan, kendi talimatları ve izinleri olan yeniden kullanılabilir bir rol ekler.",
  "marketplace.install.about.skill":
    "Bir yetenek, Sonderr'nun gerektiğinde yükleyebileceği göreve özel talimatlar ve kaynaklar ekler.",
  "marketplace.install.mcp.warning":
    "MCP sunucuları yerel komutları çalıştırabilir veya harici hizmetlere bağlanabilir. İzinleriniz otomatik olarak izin vermediği sürece Sonderr, araçlarını kullanmadan önce izin ister.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Bu proje için Sonderr anlık görüntülerini kapat. Sonderr değişiklikleri için geri alma/yeniden yapmayı kaybedersiniz, ancak git her şeyi izlemeye devam eder.",
