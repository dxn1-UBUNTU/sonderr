export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "للحصول على المزيد من إحصائيات الاستخدام، استخدم ",
  "provider.connect.sonderrGateway.byok.link": "BYOK عبر Sonderr's Gateway",
  "provider.connect.sonderrGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "موصى به",
  "settings.providers.note.sonderr": "الوصول إلى أكثر من 500 نموذج ذكاء اصطناعي",
  "settings.providers.note.sonderr": "نماذج منتقاة تشمل Claude وGPT وGemini والمزيد",
  ...
  "marketplace.install.about.mcp": "يمنح خادم MCP منصة Sonderr أدوات إضافية للعمل مع الخدمات الخارجية أو البرامج المحلية.",
  "marketplace.install.about.agent": "يضيف الوكيل دورًا قابلاً لإعادة الاستخدام بتعليماته وأذوناته الخاصة.",
  "marketplace.install.about.skill": "تضيف المهارة تعليمات وموارد خاصة بمهام معينة يمكن لـ Sonderr تحميلها عند الحاجة.",
  "marketplace.install.mcp.warning":
    "يمكن لخوادم MCP تشغيل أوامر محلية أو الاتصال بخدمات خارجية. ستطلب Sonderr الإذن قبل استخدام أدواتها ما لم تسمح أذوناتك بذلك تلقائيًا.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "أوقف لقطات Sonderr لهذا المشروع. ستفقد ميزة التراجع/الإعادة لتعديلات Sonderr، لكن git سيستمر في تتبع كل شيء.",
