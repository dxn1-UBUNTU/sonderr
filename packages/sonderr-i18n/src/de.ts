export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "Für weitere Nutzungsstatistiken ",
  "provider.connect.sonderrGateway.byok.link": "BYOK via Sonderr's Gateway",
  "provider.connect.sonderrGateway.byok.suffix": " nutzen.",

  // Provider settings translations
  "settings.providers.group.recommended": "Empfohlen",
  "settings.providers.note.sonderr": "Zugriff auf 500+ KI-Modelle",
  "settings.providers.note.sonderr": "Kuratierte Modelle, darunter Claude, GPT, Gemini und mehr",
  ...
  "marketplace.install.about.mcp":
    "Ein MCP-Server stellt Sonderr zusätzliche Werkzeuge für die Arbeit mit externen Diensten oder lokalen Programmen bereit.",
  ...
  "marketplace.install.about.skill":
    "Ein Skill fügt aufgabenspezifische Anweisungen und Ressourcen hinzu, die Sonderr bei Bedarf laden kann.",
  "marketplace.install.mcp.warning":
    "MCP-Server können lokale Befehle ausführen oder eine Verbindung zu externen Diensten herstellen. Sonderr fragt vor der Verwendung ihrer Werkzeuge um Erlaubnis, sofern Ihre Berechtigungen dies nicht automatisch erlauben.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Sonderr-Snapshots für dieses Projekt ausschalten. Rückgängig/Wiederherstellen für Sonderr-Änderungen ist nicht mehr möglich, aber git verfolgt weiterhin alles.",
