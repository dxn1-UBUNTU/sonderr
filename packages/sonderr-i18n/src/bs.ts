export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "Za više statistika korištenja, koristite ",
  "provider.connect.sonderrGateway.byok.link": "BYOK putem Sonderr's Gateway",
  ...
  "marketplace.install.about.skill":
    "Vještina dodaje upute i resurse za određene zadatke koje Sonderr može učitati kada su potrebni.",
  "marketplace.install.mcp.warning":
    "MCP serveri mogu pokretati lokalne naredbe ili se povezivati s vanjskim servisima. Sonderr će zatražiti dozvolu prije korištenja njihovih alata, osim ako vaše dozvole to automatski dopuštaju.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Isključi Sonderr snapshotove za ovaj projekat. Izgubićete poništi/vrati za izmjene koje napravi Sonderr, ali git i dalje prati sve.",
