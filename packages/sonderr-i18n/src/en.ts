...
export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "For more usage stats, ",
  ...
  "settings.providers.note.sonderr": "Access 500+ AI models",
  "settings.providers.note.sonderr": "Curated models including Claude, GPT, Gemini and more",
  ...
  "marketplace.install.about.mcp":
    "An MCP server gives Sonderr additional tools for working with external services or local programs.",
  "marketplace.install.about.agent": "An agent adds a reusable role with its own instructions and permissions.",
  "marketplace.install.about.skill":
    "A skill adds task-specific instructions and resources that Sonderr can load when needed.",
  "marketplace.install.mcp.warning":
    "MCP servers can run local commands or connect to external services. Sonderr will ask for permission before using their tools unless your permissions allow them automatically.",
  ...
  // are still what the backend matches on (see packages/cli/src/sonderr/plan-followup.ts).
  ...
  // packages/cli/src/sonderr/snapshot/track.ts.
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Turn off Sonderr's snapshots for this project. You will lose undo/redo of Sonderr file changes, but git still tracks everything.",
