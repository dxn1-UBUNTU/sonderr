export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "For flere brugsstatistikker, brug ",
  ...
  "marketplace.install.about.mcp":
    "En MCP-server giver Sonderr yderligere værktøjer til at arbejde med eksterne tjenester eller lokale programmer.",
  "marketplace.install.about.agent": "En agent tilføjer en genanvendelig rolle med egne instruktioner og tilladelser.",
  "marketplace.install.about.skill":
    "En færdighed tilføjer opgavespecifikke instruktioner og ressourcer, som Sonderr kan indlæse efter behov.",
  "marketplace.install.mcp.warning":
    "MCP-servere kan køre lokale kommandoer eller oprette forbindelse til eksterne tjenester. Sonderr beder om tilladelse, før deres værktøjer bruges, medmindre dine tilladelser automatisk tillader det.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Slå Sonderrs snapshots fra for dette projekt. Du mister fortryd/gentag for Sonderr-ændringer, men git sporer stadig alt.",
