export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "詳細な使用統計については、",
  "provider.connect.sonderrGateway.byok.link": "Sonderr's Gateway経由でBYOK",
  "provider.connect.sonderrGateway.byok.suffix": "をご利用ください。",

  // Provider settings translations
  "settings.providers.group.recommended": "おすすめ",
  "settings.providers.note.sonderr": "500以上のAIモデルにアクセス",
  "settings.providers.note.sonderr": "Claude、GPT、Geminiなどの厳選モデル",
  ...
  "marketplace.install.about.mcp":
    "MCPサーバーは、外部サービスやローカルプログラムを操作するための追加ツールをSonderrに提供します。",
  "marketplace.install.about.agent": "エージェントは、独自の指示と権限を持つ再利用可能な役割を追加します。",
  "marketplace.install.about.skill": "スキルは、必要に応じてSonderrが読み込めるタスク固有の指示とリソースを追加します。",
  "marketplace.install.mcp.warning":
    "MCPサーバーはローカルコマンドを実行したり、外部サービスに接続したりできます。権限で自動的に許可されていない限り、Sonderrはツールを使用する前に許可を求めます。",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "このプロジェクトでは Sonderr のスナップショットを無効にします。Sonderr による変更の取り消し/やり直しはできなくなりますが、git は引き続きすべてを追跡します。",
