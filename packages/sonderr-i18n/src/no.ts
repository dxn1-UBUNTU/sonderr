export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "For mer bruksstatistikk, bruk ",
  ...
  "settings.providers.note.sonderr": "Tilgang til 500+ AI-modeller",
  "settings.providers.note.sonderr": "Utvalgte modeller, inkludert Claude, GPT, Gemini og mer",
  ...
  "marketplace.install.about.mcp":
    "En MCP-server gir Sonderr flere verktøy for å arbeide med eksterne tjenester eller lokale programmer.",
  "marketplace.install.about.agent": "En agent legger til en gjenbrukbar rolle med egne instruksjoner og tillatelser.",
  "marketplace.install.about.skill":
    "En ferdighet legger til oppgavespesifikke instruksjoner og ressurser som Sonderr kan laste inn ved behov.",
  "marketplace.install.mcp.warning":
    "MCP-servere kan kjøre lokale kommandoer eller koble til eksterne tjenester. Sonderr ber om tillatelse før verktøyene brukes, med mindre tillatelsene dine automatisk tillater det.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Slå av Sonderrs snapshots for dette prosjektet. Du mister angre/gjør om for Sonderr-endringer, men git fortsetter å spore alt.",
