export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "Para más estadísticas de uso, utiliza ",
  "provider.connect.sonderrGateway.byok.link": "BYOK a través de Sonderr's Gateway",
  "provider.connect.sonderrGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Recomendados",
  "settings.providers.note.sonderr": "Acceso a más de 500 modelos de IA",
  "settings.providers.note.sonderr": "Modelos seleccionados, incluidos Claude, GPT, Gemini y más",
  ...
  "marketplace.install.about.mcp":
    "Un servidor MCP proporciona a Sonderr herramientas adicionales para trabajar con servicios externos o programas locales.",
  "marketplace.install.about.agent": "Un agente añade un rol reutilizable con sus propias instrucciones y permisos.",
  "marketplace.install.about.skill":
    "Una habilidad añade instrucciones y recursos específicos para tareas que Sonderr puede cargar cuando sea necesario.",
  "marketplace.install.mcp.warning":
    "Los servidores MCP pueden ejecutar comandos locales o conectarse a servicios externos. Sonderr pedirá permiso antes de usar sus herramientas, a menos que tus permisos lo permitan automáticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Apaga las instantáneas de Sonderr para este proyecto. Perderás deshacer/rehacer de los cambios de Sonderr, pero git seguirá rastreando todo.",
