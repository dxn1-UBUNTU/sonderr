export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "Aby uzyskać więcej statystyk użycia, użyj ",
  "provider.connect.sonderrGateway.byok.link": "BYOK przez Sonderr's Gateway",
  "provider.connect.sonderrGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Polecane",
  "settings.providers.note.sonderr": "Dostęp do ponad 500 modeli AI",
  "settings.providers.note.sonderr": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "marketplace.install.about.mcp":
    "Serwer MCP zapewnia Sonderr dodatkowe narzędzia do pracy z usługami zewnętrznymi lub programami lokalnymi.",
  "marketplace.install.about.agent": "Agent dodaje rolę wielokrotnego użytku z własnymi instrukcjami i uprawnieniami.",
  "marketplace.install.about.skill":
    "Umiejętność dodaje instrukcje i zasoby dotyczące określonych zadań, które Sonderr może wczytać w razie potrzeby.",
  "marketplace.install.mcp.warning":
    "Serwery MCP mogą uruchamiać lokalne polecenia lub łączyć się z usługami zewnętrznymi. Sonderr poprosi o pozwolenie przed użyciem ich narzędzi, chyba że uprawnienia zezwalają na to automatycznie.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Wyłącz snapshoty Sonderr dla tego projektu. Stracisz cofanie/przywracanie zmian Sonderr, ale git nadal śledzi wszystko.",
