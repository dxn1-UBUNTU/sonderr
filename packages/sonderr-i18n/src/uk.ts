export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "Для отримання додаткової статистики використання використовуйте ",
  "provider.connect.sonderrGateway.byok.link": "BYOK через Sonderr's Gateway",
  "provider.connect.sonderrGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Рекомендовані",
  "settings.providers.note.sonderr": "Доступ до 500+ моделей ШІ",
  "settings.providers.note.sonderr": "Добірні моделі, зокрема Claude, GPT, Gemini та інші",
  ...
  "marketplace.install.about.mcp":
    "MCP-сервер надає Sonderr додаткові інструменти для роботи із зовнішніми сервісами або локальними програмами.",
  "marketplace.install.about.agent": "Агент додає багаторазову роль із власними інструкціями та дозволами.",
  "marketplace.install.about.skill":
    "Навичка додає інструкції та ресурси для певних завдань, які Sonderr може завантажити за потреби.",
  "marketplace.install.mcp.warning":
    "MCP-сервери можуть виконувати локальні команди або підключатися до зовнішніх сервісів. Sonderr запитає дозвіл перед використанням їхніх інструментів, якщо ваші дозволи не дають змоги робити це автоматично.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Вимкніть знімки Sonderr для цього проєкту. Ви втратите скасування/повторення для змін Sonderr, але git продовжить відстежувати все.",
