export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "如需更多使用统计信息，请",
  "provider.connect.sonderrGateway.byok.link": "通过 Sonderr's Gateway 进行 BYOK",
  "provider.connect.sonderrGateway.byok.suffix": "。",

  // Provider settings translations
  "settings.providers.group.recommended": "推荐",
  "settings.providers.note.sonderr": "访问 500+ AI 模型",
  "settings.providers.note.sonderr": "精选模型，包括 Claude、GPT、Gemini 等",
  ...
  "marketplace.install.about.mcp": "MCP 服务器为 Sonderr 提供用于处理外部服务或本地程序的额外工具。",
  "marketplace.install.about.agent": "智能体会添加一个具有专属指令和权限的可复用角色。",
  "marketplace.install.about.skill": "技能会添加特定任务的指令和资源，Sonderr 可在需要时加载它们。",
  "marketplace.install.mcp.warning":
    "MCP 服务器可以运行本地命令或连接外部服务。除非你的权限允许自动使用，否则 Sonderr 会在使用其工具前请求许可。",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "关闭本项目的 Sonderr 快照。你将失去对 Sonderr 更改的撤销/重做，但 git 仍会追踪所有内容。",
