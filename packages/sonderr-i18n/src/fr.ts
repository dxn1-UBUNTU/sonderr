export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "Pour plus de statistiques d'utilisation, utilisez ",
  "provider.connect.sonderrGateway.byok.link": "BYOK via Sonderr's Gateway",
  "provider.connect.sonderrGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Recommandés",
  "settings.providers.note.sonderr": "Accès à plus de 500 modèles d'IA",
  "settings.providers.note.sonderr": "Modèles sélectionnés, dont Claude, GPT, Gemini et plus encore",
  ...
  "marketplace.install.about.mcp":
    "Un serveur MCP fournit à Sonderr des outils supplémentaires pour interagir avec des services externes ou des programmes locaux.",
  "marketplace.install.about.agent":
    "Un agent ajoute un rôle réutilisable avec ses propres instructions et autorisations.",
  "marketplace.install.about.skill":
    "Une compétence ajoute des instructions et des ressources propres à une tâche que Sonderr peut charger en cas de besoin.",
  "marketplace.install.mcp.warning":
    "Les serveurs MCP peuvent exécuter des commandes locales ou se connecter à des services externes. Sonderr demandera votre autorisation avant d'utiliser leurs outils, sauf si vos autorisations le permettent automatiquement.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Désactivez les instantanés Sonderr pour ce projet. Vous perdez l'annulation/restauration des modifications faites par Sonderr, mais git continue de tout suivre.",
