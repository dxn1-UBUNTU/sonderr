export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "Для получения дополнительной статистики использования используйте ",
  ...
  "marketplace.install.about.mcp":
    "MCP-сервер предоставляет Sonderr дополнительные инструменты для работы с внешними сервисами или локальными программами.",
  ...
  "marketplace.install.about.skill":
    "Навык добавляет инструкции и ресурсы для определённых задач, которые Sonderr может загрузить при необходимости.",
  "marketplace.install.mcp.warning":
    "MCP-серверы могут выполнять локальные команды или подключаться к внешним сервисам. Sonderr запросит разрешение перед использованием их инструментов, если только ваши разрешения не допускают это автоматически.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Выключите снимки Sonderr для этого проекта. Вы потеряете отмену/повтор изменений Sonderr, но git по-прежнему отслеживает всё.",
