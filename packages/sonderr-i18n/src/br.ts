export const dict = {
  ...
  "provider.connect.sonderrGateway.byok.prefix": "Para mais estatísticas de uso, utilize ",
  ...
  "settings.providers.note.sonderr": "Acesso a mais de 500 modelos de IA",
  "settings.providers.note.sonderr": "Modelos selecionados, incluindo Claude, GPT, Gemini e mais",
  ...
  "marketplace.install.about.mcp":
    "Um servidor MCP fornece ao Sonderr ferramentas adicionais para trabalhar com serviços externos ou programas locais.",
  "marketplace.install.about.agent": "Um agente adiciona uma função reutilizável com instruções e permissões próprias.",
  "marketplace.install.about.skill":
    "Uma habilidade adiciona instruções e recursos específicos para tarefas que o Sonderr pode carregar quando necessário.",
  "marketplace.install.mcp.warning":
    "Servidores MCP podem executar comandos locais ou se conectar a serviços externos. O Sonderr solicitará permissão antes de usar suas ferramentas, a menos que suas permissões permitam isso automaticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Desligue os snapshots do Sonderr para este projeto. Você perde desfazer/refazer das mudanças feitas pelo Sonderr, mas o git continua rastreando tudo.",
