...
**Priority:** P0
**Issue:** [#6083](https://github.com/Sonderr-Org/sonderr/issues/6083)
...
- Check if both versions attempt to spawn `sonderr serve` simultaneously causing port/race conflicts
