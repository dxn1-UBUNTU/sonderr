...
- Diagram colors are derived from the active VS Code/Sonderr CSS variables so light, dark, and high-contrast themes can render with matching backgrounds, text, borders, and link colors.
