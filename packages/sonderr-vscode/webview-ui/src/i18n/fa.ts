...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Anaconda Desktop را روی این دستگاه نصب کنید، سپس به اینجا بازگردید. Sonderr نصب‌کننده را برای شما اجرا نمی‌کند.",
  ...
  "provider.anaconda.state.signedOut": "قبل از اتصال Sonderr، Anaconda Desktop را باز کرده و وارد شوید.",
  "provider.anaconda.state.unauthorized":
    "Sonderr نتوانست به Anaconda Desktop دسترسی پیدا کند. Desktop را باز کنید، دوباره وارد شوید و در صورت نیاز آن را مجدداً راه‌اندازی کنید.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr یک سرور تولید متن محلی سالم پیدا کرد و می‌تواند تنظیمات اتصال فعلی آن را وارد کند.",
  ...
  "provider.anaconda.toast.refreshed.description": "سرور محلی فعال و مدل‌ها در Sonderr به‌روز هستند.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "کلید API {{provider}} خود را وارد کنید تا حساب‌تان متصل شود و از مدل‌های {{provider}} در Sonderr استفاده کنید.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " مراجعه کنید تا کد مجوز خود را دریافت کرده، حساب خود را متصل کنید و از مدل‌های {{provider}} در Sonderr استفاده کنید.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " مراجعه کنید و کد زیر را وارد کنید تا حساب خود را متصل کرده و از مدل‌های {{provider}} در Sonderr استفاده کنید.",
  ...
  "prompt.action.sandbox.enabled": "سندباکس فعال است. دستورات شل عامل به پوشه‌های پروژه و Sonderr محدود شده‌اند.",
  "prompt.action.sandbox.disabled":
    "سندباکس غیرفعال است. برای محدود کردن نوشتن دستورات شل عامل به پوشه‌های پروژه و Sonderr کلیک کنید.",
  ...
  "prompt.action.sandbox.description.enabled": "نوشتن‌ها به پوشه‌های پروژه و Sonderr محدود شده‌اند.",
  ...
  "speechToText.tooltip.start": "شروع ورودی صوتی با Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "برای استفاده از ورودی صوتی وارد Sonderr شوید.",
  ...
  "settings.config.title": "باز کردن فایل پیکربندی {{scope}} Sonderr",
  ...
  "settings.config.noWorkspace": "یک پوشه کاری باز کنید تا فایل پیکربندی محلی Sonderr را ویرایش کنید.",
  "settings.config.openFailed": "باز کردن فایل پیکربندی {{scope}} Sonderr با شکست مواجه شد: {{message}}",
  "settings.config.source.xdg": "پیکربندی سراسری XDG",
  "settings.config.source.homeSonderr": "پیکربندی .sonderr در پوشه خانگی",
  "settings.config.source.homeSonderr": "پیکربندی .sonderr در پوشه خانگی",
  "settings.config.source.homeSonderr": "پیکربندی .sonderr در پوشه خانگی",
  "settings.config.source.envFile": "فایل محیطی SONDERR_CONFIG",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "پیکربندی محیطی درون‌خطی",
  "settings.config.source.projectSonderr": "پیکربندی .sonderr پروژه",
  "settings.config.source.projectRoot": "پیکربندی ریشه پروژه",
  "settings.config.source.projectSonderr": "پیکربندی قدیمی .sonderr",
  "settings.config.source.projectSonderr": "پیکربندی قدیمی .sonderr",
  ...
  "workStyle.onboarding.welcome": "به Sonderr خوش آمدید",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr در حین کار مکث می‌کند و برنامه خود را به شما نشان می‌دهد.",
  ...
  "session.cloud.import.placeholder": "شناسه جلسه، URL، یا دستور sonderr import",
  ...
  "deviceAuth.title": "ورود به Sonderr",
  ...
  "profile.action.login": "ورود با Sonderr",
  ...
  "profile.usage.routing": "صورتحساب طرح فعال است. مسیریابی Sonderr Gateway {{state}} است.",
  ...
  "profile.pass.subscribe": "Sonderr Pass را دریافت کنید تا اعتبار اضافه کنید و پاداش کسب کنید",
  "profile.pass.bonus": "پاداش",
  "profile.pass.usage": "مصرف این ماه",
  "profile.pass.paid": "پرداخت‌شده",
  "profile.pass.meter": "مصرف ماهانه Sonderr Pass",
  ...
  "settings.indexing.sonderrModel.title": "پیش‌تنظیم مدل Sonderr",
  "settings.indexing.sonderrModel.description": "یک مدل جاسازی میزبانی‌شده توسط Sonderr را انتخاب کنید.",
  "settings.indexing.sonderrSignIn.title": "ورود به Sonderr الزامی است",
  "settings.indexing.sonderrSignIn.description": "برای استفاده از جاسازی‌های میزبانی‌شده، وارد Sonderr شوید.",
  ...
  "settings.aboutSonderr.title": "درباره Sonderr",

  "session.messages.welcome":
    "Sonderr یک دستیار هوش مصنوعی برای کدنویسی است. از آن بخواهید ویژگی‌ها بسازد، باگ‌ها را رفع کند یا کدبیس شما را توضیح دهد.",
  ...
  "sidebar.topBar.label": "پیمایش Sonderr",
  ...
  "settings.aboutSonderr.status.connected": "متصل",
  "settings.aboutSonderr.status.connecting": "در حال اتصال...",
  "settings.aboutSonderr.status.disconnected": "قطع شده",
  "settings.aboutSonderr.status.error": "خطا",
  "settings.aboutSonderr.cliServer": "سرور CLI",
  "settings.aboutSonderr.status.label": "وضعیت:",
  "settings.aboutSonderr.port.label": "پورت:",
  "settings.aboutSonderr.versionInfo": "اطلاعات نسخه",
  "settings.aboutSonderr.version.label": "نسخه:",
  "settings.aboutSonderr.community": "جامعه و پشتیبانی",
  "settings.aboutSonderr.feedback.prefix": "اگر سؤال یا بازخوردی دارید، می‌توانید یک issue در",
  "settings.aboutSonderr.feedback.or": "یا",
  "settings.aboutSonderr.support.prefix": "برای سؤالات مربوط به صورت‌حساب یا حساب کاربری، با پشتیبانی مشتریان در",
  "settings.aboutSonderr.resetSettings.title": "بازنشانی تنظیمات",
  ...
  "settings.aboutSonderr.resetSettings.button": "بازنشانی همه تنظیمات",
  "settings.aboutSonderr.resetSettings.notificationsButton": "بازنشانی اعلان‌های خوانده‌شده",
  "settings.aboutSonderr.settingsTransfer.title": "انتقال تنظیمات",
  "settings.aboutSonderr.settingsTransfer.description":
    "تنظیمات خود را برای انتقال بین نمونه‌های VS Code صادر یا وارد کنید.",
  "settings.aboutSonderr.exportSettings": "صادر کردن",
  "settings.aboutSonderr.importSettings": "وارد کردن",
  "settings.aboutSonderr.importSettings.invalidJson":
    "فایل JSON نامعتبر است. لطفاً یک فایل تنظیمات معتبر انتخاب کنید.",
  "settings.aboutSonderr.importSettings.invalidConfig": "فایل حاوی تنظیمات معتبر Sonderr نیست.",
  ...
  "settings.aboutSonderr.importSettings.newerVersion":
    "این فایل از نسخه جدیدتری از Sonderr صادر شده است. برخی تنظیمات ممکن است نادیده گرفته شوند.",
  "settings.aboutSonderr.importSettings.success":
    "تنظیمات وارد شد. تغییرات بالا را بررسی کنید، سپس روی ذخیره کلیک کنید.",

  "settings.aboutSonderr.telemetry.title": "تله‌متری",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "باز کردن تنظیمات تله‌متری",
  ...
  "settings.language.description":
    "زبان رابط کاربری Sonderr را انتخاب کنید. «Auto» از زبان نمایشی VS Code شما استفاده می‌کند.",
  ...
  "settings.models.speechToText.disabledDescription":
    "برای استفاده از تبدیل گفتار به متن، ارائه‌دهنده Sonderr را فعال کرده و وارد شوید. تبدیل گفتار به متن در حال حاضر فقط از طریق Sonderr Gateway پشتیبانی می‌شود.",
  "settings.models.speechToTextModel.title": "مدل تبدیل گفتار به متن",
  "settings.models.speechToTextModel.description": "مدل رونویسی Sonderr Gateway را برای ورودی صوتی انتخاب کنید.",
  ...
  "settings.sandboxing.enabled.description":
    "اجرای دستورات شل عامل در یک Sandbox سطح سیستم‌عامل که نوشتن را به پوشه‌های پروژه و وضعیت Sonderr محدود می‌کند",
  ...
  "settings.experimental.remote.description":
    "فعال‌سازی کنترل از راه دور جلسات از طریق Sonderr Cloud. این تنظیم بر CLIهای این دستگاه نیز تأثیر می‌گذارد.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "دستورالعمل‌ها و مهارت‌های CLAUDE.md را از پوشه پیکربندی Claude Code شما در جلسات بارگذاری می‌کند. اگر می‌خواهید Sonderr از دستورالعمل‌ها و مهارت‌های Claude Code شما استفاده کند، این گزینه را فعال کنید. نیاز به راه‌اندازی مجدد دارد.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "هیچ سرور MCP پیکربندی نشده است. سرورهای MCP را در sonderr.jsonc اضافه کنید، یا از agent بخواهید آن‌ها را برایتان اضافه کند.",
  "settings.agentBehaviour.workflows.description":
    "Workflow‌ها دستورات slash سفارشی هستند که در پیکربندی شما تعریف شده‌اند. برای فراخوانی آن‌ها /command-name را در چت تایپ کنید. دستورات در sonderr.json زیر بخش 'command' پیکربندی می‌شوند.",
  "settings.agentBehaviour.workflows.empty":
    "هیچ دستور سفارشی پیکربندی نشده است. دستورات را به sonderr.json خود اضافه کنید تا اینجا نمایش داده شوند.",
  ...
  "chat.memory.project.empty": "این پروژه هنوز هیچ حافظه‌ای ندارد. پس از استفاده از Sonderr نمایش داده خواهد شد.",
  ...
  "settings.display.fontSize.description": "اندازه قلم رابط کاربری وب‌ویو Sonderr را مستقل از VS Code تنظیم کنید.",
  ...
  "settings.models.hidePromptTraining.description":
    "مدل‌های Sonderr Gateway را که ارائه‌دهندگانشان ممکن است از پرامپت‌های شما برای آموزش استفاده کنند پنهان کنید.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "انتقال از نسخه قدیمی",
  "settings.aboutSonderr.legacyMigration.description":
    "تنظیمات را از نصب قبلی Sonderr منتقل کنید، از جمله کلیدهای API ارائه‌دهنده و مدل پیش‌فرض.",
  "settings.aboutSonderr.rooImport.description": "تاریخچه مکالمات را از یک نصب Roo Code وارد کنید.",
  "settings.aboutSonderr.rooImport.button": "وارد کردن جلسات از Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "تازه‌های Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "یک هسته کوچک و کارآمد در تمام محصولات Sonderr. تجربه‌ای آشنا، هر طور که انتخاب کنید کار کنید.",
  ...
  "diffViewer.source.session.tooltip":
    "فایل‌هایی که توسط Sonderr در جلسه جاری تغییر کرده‌اند، بر اساس عکس‌های فوری هر نوبت. با شروع جلسه جدید بازنشانی می‌شود.",
