...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installieren Sie Anaconda Desktop auf diesem Computer und kehren Sie dann hierher zurück. Sonderr führt das Installationsprogramm nicht für Sie aus.",
  ...
  "provider.anaconda.state.signedOut": "Öffnen Sie Anaconda Desktop und melden Sie sich an, bevor Sie Sonderr verbinden.",
  "provider.anaconda.state.unauthorized":
    "Sonderr konnte nicht auf Anaconda Desktop zugreifen. Öffnen Sie Desktop, melden Sie sich erneut an und starten Sie es bei Bedarf neu.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr hat einen funktionsfähigen lokalen Textgenerierungsserver gefunden und kann dessen aktuelle Verbindungseinstellungen importieren.",
  ...
  "provider.anaconda.toast.refreshed.description":
    "Der aktive lokale Server und die Modelle sind in Sonderr auf dem neuesten Stand.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Sonderr zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Sonderr zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Sonderr zu nutzen.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox ist aktiviert. Shell-Befehle des Agenten sind auf die Projekt- und Sonderr-Verzeichnisse beschränkt.",
  "prompt.action.sandbox.disabled":
    "Sandbox ist deaktiviert. Klicken, um Schreibvorgänge der Shell-Befehle des Agenten auf die Projekt- und Sonderr-Verzeichnisse zu beschränken.",
  ...
  "prompt.action.sandbox.description.enabled":
    "Schreibvorgänge sind auf die Projekt- und Sonderr-Verzeichnisse beschränkt.",
  ...
  "speechToText.tooltip.start": "Spracheingabe mit Sonderr Gateway starten",
  ...
  "speechToText.error.loginRequired": "Melden Sie sich bei Sonderr an, um die Spracheingabe zu verwenden.",
  ...
  "sidebar.topBar.label": "Sonderr Navigation",
  "sidebar.topBar.newTask": "Neue Aufgabe",
  "sidebar.topBar.history": "Verlauf",
  "sidebar.topBar.agentManager": "Agent Manager",
  "sidebar.topBar.sonderrClaw": "SonderrClaw",
  ...
  "settings.indexing.sonderrModel.title": "Sonderr-Modellvoreinstellung",
  "settings.indexing.sonderrModel.description": "Wählen Sie ein unterstütztes von Sonderr gehostetes Embedding-Modell.",
  "settings.indexing.sonderrSignIn.title": "Sonderr-Anmeldung erforderlich",
  "settings.indexing.sonderrSignIn.description": "Melden Sie sich bei Sonderr an, um gehostete Embeddings zu verwenden.",
  ...
  "settings.models.hidePromptTraining.description":
    "Blendet Sonderr-Gateway-Modelle aus, deren Anbieter Ihre Prompts möglicherweise zum Training verwenden.",
  ...
  "settings.config.title": "{{scope}} Sonderr-Konfigurationsdatei öffnen",
  ...
  "settings.config.noWorkspace":
    "Öffnen Sie einen Arbeitsbereichsordner, um die lokale Sonderr-Konfigurationsdatei zu bearbeiten.",
  "settings.config.openFailed": "Fehler beim Öffnen der {{scope}} Sonderr-Konfigurationsdatei: {{message}}",
  "settings.config.source.xdg": "Globale XDG-Konfiguration",
  "settings.config.source.homeSonderr": "Home .sonderr-Konfiguration",
  "settings.config.source.homeSonderr": "Home .sonderr-Konfiguration",
  "settings.config.source.homeSonderr": "Home .sonderr-Konfiguration",
  "settings.config.source.envFile": "SONDERR_CONFIG Umgebungsdatei",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Inline-Umgebungskonfiguration",
  "settings.config.source.projectSonderr": "Projekt .sonderr-Konfiguration",
  "settings.config.source.projectRoot": "Projektstamm-Konfiguration",
  "settings.config.source.projectSonderr": "Veraltete .sonderr-Konfiguration",
  "settings.config.source.projectSonderr": "Veraltete .sonderr-Konfiguration",
  ...
  "workStyle.onboarding.welcome": "Willkommen bei Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr pausiert und zeigt dir während der Arbeit seinen Plan.",
  ...
  "session.cloud.import.placeholder": "Sitzungs-ID, URL oder sonderr import-Befehl",
  ...
  "deviceAuth.title": "Bei Sonderr anmelden",
  ...
  "profile.action.login": "Mit Sonderr anmelden",
  ...
  "profile.usage.routing": "Tarifabrechnung ist aktiv. Sonderr-Gateway-Routing ist {{state}}.",
  ...
  "profile.pass.subscribe": "Hol dir Sonderr Pass, um Guthaben hinzuzufügen und Boni zu verdienen",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "Verbrauch in diesem Monat",
  "profile.pass.paid": "Bezahlt",
  "profile.pass.meter": "Monatlicher Verbrauch des Sonderr Pass",
  ...
  "settings.aboutSonderr.title": "Über Sonderr",

  "session.messages.welcome":
    "Sonderr ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutSonderr.status.connected": "Verbunden",
  "settings.aboutSonderr.status.connecting": "Verbindung wird hergestellt...",
  "settings.aboutSonderr.status.disconnected": "Getrennt",
  "settings.aboutSonderr.status.error": "Fehler",
  "settings.aboutSonderr.cliServer": "CLI-Server",
  "settings.aboutSonderr.status.label": "Status:",
  "settings.aboutSonderr.port.label": "Port:",
  "settings.aboutSonderr.versionInfo": "Versionsinformationen",
  "settings.aboutSonderr.version.label": "Version:",
  "settings.aboutSonderr.community": "Community & Support",
  "settings.aboutSonderr.feedback.prefix": "Bei Fragen oder Feedback können Sie ein Issue eröffnen auf",
  "settings.aboutSonderr.feedback.or": "oder",
  "settings.aboutSonderr.support.prefix":
    "Bei Abrechnungs- oder Kontofragen wenden Sie sich an den Kundensupport unter",
  "settings.aboutSonderr.resetSettings.title": "Einstellungen zurücksetzen",
  "settings.aboutSonderr.resetSettings.description":
  ...
  "settings.aboutSonderr.resetSettings.button": "Alle Einstellungen zurücksetzen",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Einstellungen übertragen",
  "settings.aboutSonderr.settingsTransfer.description":
    "Exportieren oder importieren Sie Ihre Einstellungen, um sie zwischen VS Code-Instanzen zu übertragen.",
  "settings.aboutSonderr.exportSettings": "Exportieren",
  "settings.aboutSonderr.importSettings": "Importieren",
  "settings.aboutSonderr.importSettings.invalidJson":
    "Ungültige JSON-Datei. Bitte wählen Sie eine gültige Einstellungsdatei aus.",
  "settings.aboutSonderr.importSettings.invalidConfig": "Die Datei enthält keine gültigen Sonderr-Einstellungen.",
  "settings.aboutSonderr.importSettings.tooLarge":
    "Die Datei ist zu groß. Einstellungsdateien müssen kleiner als 1 MB sein.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "Diese Datei wurde mit einer neueren Version von Sonderr exportiert. Einige Einstellungen werden möglicherweise ignoriert.",
  "settings.aboutSonderr.importSettings.success":
    "Einstellungen importiert. Überprüfen Sie die obigen Änderungen und klicken Sie dann auf Speichern.",

  "settings.aboutSonderr.telemetry.title": "Telemetrie",
  "settings.aboutSonderr.telemetry.description":
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Telemetrie-Einstellungen öffnen",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die Sonderr Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Aktivieren Sie den Sonderr-Anbieter und melden Sie sich an, um Speech to Text zu verwenden. Speech to Text wird derzeit nur mit Sonderr Gateway unterstützt.",
  "settings.models.speechToTextModel.title": "Sprache-zu-Text-Modell",
  "settings.models.speechToTextModel.description":
    "Wählen Sie das Sonderr Gateway-Transkriptionsmodell für die Spracheingabe.",
  ...
  "settings.experimental.remote.description":
    "Aktivieren Sie die Remote-Steuerung von Sitzungen über Sonderr Cloud. Dies betrifft auch CLIs auf diesem Computer.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Lädt CLAUDE.md-Anweisungen und Skills aus Ihrem Claude Code-Konfigurationsverzeichnis in Sitzungen. Aktivieren Sie dies, wenn Sonderr Ihre Claude Code-Anweisungen und Skills verwenden soll. Neustart erforderlich.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Keine MCP-Server konfiguriert. Fügen Sie MCP-Server in sonderr.jsonc hinzu oder bitten Sie den Agenten, sie hinzuzufügen.",
  "settings.agentBehaviour.workflows.description":
    "Workflows sind benutzerdefinierte Slash-Befehle, die in Ihrer Konfiguration definiert sind. Geben Sie /command-name im Chat ein, um sie aufzurufen. Befehle werden in sonderr.json im Abschnitt 'command' konfiguriert.",
  "settings.agentBehaviour.workflows.empty":
    "Keine benutzerdefinierten Befehle konfiguriert. Fügen Sie Befehle zu sonderr.json hinzu, um sie hier zu sehen.",
  ...
  "settings.sandboxing.enabled.description":
    "Shell-Befehle des Agenten in einer Sandbox auf Betriebssystemebene ausführen, die Schreibvorgänge auf die Projekt- und Sonderr-Statusverzeichnisse beschränkt",
  ...
  "chat.memory.project.empty": "This project doesn't have any memory yet. It will start showing after you use Sonderr.",
  ...
  "settings.display.fontSize.description": "Passen Sie die Schriftgröße der Sonderr webview UI unabhängig von VS Code an.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Legacy-Migration",
  "settings.aboutSonderr.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von Sonderr, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",
  "settings.aboutSonderr.rooImport.description":
    "Importieren Sie den Konversationsverlauf von einer Installation von Roo Code.",
  "settings.aboutSonderr.rooImport.button": "Sitzungen aus Roo Code importieren",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle Sonderr-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
  ...
  "diffViewer.source.session.tooltip":
    "Von Sonderr während der aktuellen Sitzung geänderte Dateien, basierend auf Snapshots pro Runde. Wird beim Start einer neuen Sitzung zurückgesetzt.",
