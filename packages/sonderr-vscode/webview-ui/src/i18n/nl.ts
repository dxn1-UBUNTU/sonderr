...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installeer Anaconda Desktop op deze machine en kom hier dan terug. Sonderr voert het installatieprogramma niet voor je uit.",
  ...
  "provider.anaconda.state.signedOut": "Open Anaconda Desktop en meld je aan voordat je Sonderr verbindt.",
  "provider.anaconda.state.unauthorized":
    "Sonderr kon geen toegang krijgen tot Anaconda Desktop. Open Desktop, meld je opnieuw aan en herstart het indien nodig.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr heeft een gezonde lokale tekstgeneratieserver gevonden en kan de huidige verbindingsinstellingen importeren.",
  ...
  "provider.anaconda.toast.refreshed.description": "De actieve lokale server en modellen zijn up-to-date in Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Voer uw {{provider}} API-sleutel in om uw account te verbinden en {{provider}} modellen te gebruiken in Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om uw autorisatiecode op te halen waarmee u uw account kunt verbinden en {{provider}} modellen kunt gebruiken in Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om uw account te verbinden en {{provider}} modellen te gebruiken in Sonderr.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox is ingeschakeld. Shell-opdrachten van de agent zijn beperkt tot de project- en Sonderr-mappen.",
  "prompt.action.sandbox.disabled":
    "Sandbox is uitgeschakeld. Klik om schrijfbewerkingen van shell-opdrachten van de agent te beperken tot de project- en Sonderr-mappen.",
  ...
  "prompt.action.sandbox.description.enabled": "Schrijfbewerkingen zijn beperkt tot de project- en Sonderr-mappen.",
  ...
  "speechToText.tooltip.start": "Spraakinvoer starten met Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Meld u aan bij Sonderr om spraakinvoer te gebruiken.",
  ...
  "sidebar.topBar.label": "Sonderr-navigatie",
  ...
  "settings.config.title": "Open {{scope}} Sonderr-configuratiebestand",
  ...
  "settings.config.noWorkspace": "Open een werkruimtemap om het lokale Sonderr-configuratiebestand te bewerken.",
  "settings.config.openFailed": "Kan {{scope}} Sonderr-configuratiebestand niet openen: {{message}}",
  "settings.config.source.xdg": "XDG globale configuratie",
  "settings.config.source.homeSonderr": "Home .sonderr-configuratie",
  "settings.config.source.homeSonderr": "Home .sonderr-configuratie",
  "settings.config.source.homeSonderr": "Home .sonderr-configuratie",
  "settings.config.source.envFile": "SONDERR_CONFIG omgevingsbestand",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Inline omgevingsconfiguratie",
  "settings.config.source.projectSonderr": "Project .sonderr-configuratie",
  "settings.config.source.projectRoot": "Project root configuratie",
  "settings.config.source.projectSonderr": "Verouderde .sonderr-configuratie",
  "settings.config.source.projectSonderr": "Verouderde .sonderr-configuratie",
  ...
  "workStyle.onboarding.welcome": "Welkom bij Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr pauzeert en toont tijdens het werk zijn plan.",
  ...
  "session.cloud.import.placeholder": "Sessie-ID, URL, of sonderr import commando",
  ...
  "deviceAuth.title": "Meld je aan bij Sonderr",
  ...
  "profile.action.login": "Inloggen met Sonderr",
  ...
  "profile.usage.routing": "De abonnementsfacturering is actief. Sonderr Gateway-routering is {{state}}.",
  ...
  "profile.pass.subscribe": "Schaf Sonderr Pass aan om tegoed toe te voegen en bonussen te verdienen",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "Verbruik deze maand",
  "profile.pass.paid": "Betaald",
  "profile.pass.meter": "Maandelijks Sonderr Pass-verbruik",
  ...
  "settings.aboutSonderr.title": "Over Sonderr",

  "session.messages.welcome":
    "Sonderr is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutSonderr.status.connected": "Verbonden",
  "settings.aboutSonderr.status.connecting": "Verbinden...",
  "settings.aboutSonderr.status.disconnected": "Verbinding verbroken",
  "settings.aboutSonderr.status.error": "Fout",
  "settings.aboutSonderr.cliServer": "CLI Server",
  "settings.aboutSonderr.status.label": "Status:",
  "settings.aboutSonderr.port.label": "Poort:",
  "settings.aboutSonderr.versionInfo": "Versie-informatie",
  "settings.aboutSonderr.version.label": "Versie:",
  "settings.aboutSonderr.community": "Community & Ondersteuning",
  "settings.aboutSonderr.feedback.prefix": "Als je vragen of feedback hebt, voel je vrij om een issue aan te maken op",
  "settings.aboutSonderr.feedback.or": "of",
  "settings.aboutSonderr.support.prefix":
    "Voor vragen over facturering of je account, neem contact op met Klantenservice op",
  "settings.aboutSonderr.resetSettings.title": "Instellingen resetten",
  ...
  "settings.aboutSonderr.resetSettings.button": "Alle instellingen resetten",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Instellingen overdragen",
  ...
  "settings.aboutSonderr.exportSettings": "Exporteren",
  "settings.aboutSonderr.importSettings": "Importeren",
  "settings.aboutSonderr.importSettings.invalidJson":
    "Ongeldig JSON-bestand. Selecteer een geldig instellingenbestand.",
  "settings.aboutSonderr.importSettings.invalidConfig": "Het bestand bevat geen geldige Sonderr-instellingen.",
  ...
  "settings.aboutSonderr.importSettings.newerVersion":
    "Dit bestand is geëxporteerd vanuit een nieuwere versie van Sonderr. Sommige instellingen worden mogelijk genegeerd.",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Telemetrie-instellingen openen",
  ...
  "settings.language.description": 'Kies de taal voor de Sonderr UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Schakel de Sonderr-provider in en meld u aan om Speech to Text te gebruiken. Speech to Text wordt momenteel alleen ondersteund met Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Spraak-naar-tekst-model",
  "settings.models.speechToTextModel.description": "Kies het Sonderr Gateway-transcriptiemodel voor spraakinvoer.",
  ...
  "settings.experimental.remote.description":
    "Schakel Remote-bediening van sessies in via Sonderr Cloud. Dit heeft ook invloed op CLI's op deze machine.",
  ...
  "settings.sandboxing.enabled.description":
    "Shell-opdrachten van de agent uitvoeren in een sandbox op besturingssysteemniveau die schrijfbewerkingen beperkt tot de project- en Sonderr-statusmappen",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Laad CLAUDE.md instructies en vaardigheden uit je Claude Code configuratiemap in sessies. Schakel dit in als je wilt dat Sonderr je Claude Code instructies en vaardigheden gebruikt. Herstart vereist.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Geen MCP-servers geconfigureerd. Voeg MCP-servers toe in sonderr.jsonc of vraag de agent om ze toe te voegen.",
  "settings.agentBehaviour.workflows.description":
    "Workflows zijn aangepaste slash-commando's gedefinieerd in je configuratie. Typ /command-name in de chat om ze aan te roepen. Commando's worden geconfigureerd in sonderr.json onder de sectie 'command'.",
  "settings.agentBehaviour.workflows.empty":
    "Geen aangepaste commando's geconfigureerd. Voeg commando's toe aan sonderr.json om ze hier te zien.",
  ...
  "settings.display.fontSize.description": "Pas de lettergrootte van de Sonderr webview UI onafhankelijk van VS Code aan.",
  ...
  "settings.models.hidePromptTraining.description":
    "Verberg Sonderr Gateway-modellen waarvan providers je prompts mogelijk voor training gebruiken.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Legacy Migratie",
  "settings.aboutSonderr.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van Sonderr, inclusief provider API-sleutels en standaard model.",
  "settings.aboutSonderr.rooImport.description": "Importeer gespreksgeschiedenis van een Roo Code installatie.",
  "settings.aboutSonderr.rooImport.button": "Sessies importeren uit Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Één kleine, efficiënte kern voor elk Sonderr-product. Een vertrouwde ervaring, hoe je ook wilt werken.",
  ...
  "settings.indexing.sonderrModel.title": "Sonderr-model voorinstelling",
  "settings.indexing.sonderrModel.description": "Kies een ondersteund Sonderr-hosted embeddings model.",
  "settings.indexing.sonderrSignIn.title": "Sonderr-aanmelding vereist",
  "settings.indexing.sonderrSignIn.description": "Log in op Sonderr om hosted embeddings te gebruiken.",
  ...
  "diffViewer.source.session.tooltip":
    "Bestanden die door Sonderr tijdens de huidige sessie zijn gewijzigd, gebaseerd op snapshots per beurt. Wordt gereset bij het starten van een nieuwe sessie.",
