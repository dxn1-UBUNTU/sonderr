...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "請在此機器上安裝 Anaconda Desktop，然後返回此處。Sonderr 不會為您執行安裝程式。",
  ...
  "provider.anaconda.state.signedOut": "請開啟 Anaconda Desktop 並登入，然後再連接 Sonderr。",
  "provider.anaconda.state.unauthorized":
    "Sonderr 無法存取 Anaconda Desktop。請開啟 Desktop，重新登入，並在需要時重新啟動它。",
  ...
  "provider.anaconda.state.ready": "Sonderr 找到了一個正常運作的本機文字生成伺服器，並可匯入其目前的連接設定。",
  ...
  "provider.anaconda.toast.refreshed.description": "使用中的本機伺服器與模型在 Sonderr 中已是最新狀態。",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Sonderr 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Sonderr 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Sonderr 中使用 {{provider}} 模型。",
  ...
  "prompt.action.sandbox.enabled": "沙盒已啟用。代理 shell 指令被限制在專案和 Sonderr 目錄內。",
  "prompt.action.sandbox.disabled": "沙盒已停用。點擊以將代理 shell 指令的寫入限制在專案和 Sonderr 目錄內。",
  ...
  "prompt.action.sandbox.description.enabled": "寫入僅限於專案和 Sonderr 目錄。",
  ...
  "speechToText.tooltip.start": "使用 Sonderr Gateway 開始語音輸入",
  ...
  "speechToText.error.loginRequired": "登入 Sonderr 以使用語音輸入。",
  ...
  "sidebar.topBar.label": "Sonderr 導覽",
  ...
  "settings.models.hidePromptTraining.description": "隱藏供應商可能會使用您的提示詞進行訓練的 Sonderr Gateway 模型。",
  ...
  "settings.config.title": "開啟 {{scope}} Sonderr 設定檔",
  "settings.config.placeholder": "設定檔會按順序合併；標記為已載入的檔案目前會影響設定。",
  "settings.config.noWorkspace": "開啟工作區資料夾以編輯本地 Sonderr 設定檔。",
  "settings.config.openFailed": "無法開啟 {{scope}} Sonderr 設定檔：{{message}}",
  "settings.config.source.xdg": "XDG 全域設定",
  "settings.config.source.homeSonderr": "主目錄 .sonderr 設定",
  "settings.config.source.homeSonderr": "主目錄 .sonderr 設定",
  "settings.config.source.homeSonderr": "主目錄 .sonderr 設定",
  "settings.config.source.envFile": "SONDERR_CONFIG 環境變數檔案",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "內聯環境設定",
  "settings.config.source.projectSonderr": "專案 .sonderr 設定",
  "settings.config.source.projectRoot": "專案根目錄設定",
  "settings.config.source.projectSonderr": "舊版 .sonderr 設定",
  "settings.config.source.projectSonderr": "舊版 .sonderr 設定",
  ...
  "workStyle.onboarding.welcome": "歡迎使用 Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr 會在工作過程中暫停並向你顯示其計畫。",
  ...
  "session.cloud.import.placeholder": "工作階段 ID、URL 或 sonderr import 指令",
  ...
  "profile.action.login": "使用 Sonderr 登入",
  ...
  "profile.usage.routing": "方案帳單目前有效。Sonderr Gateway 路由狀態為 {{state}}。",
  ...
  "profile.pass.subscribe": "訂閱 Sonderr Pass 以新增額度並賺取獎勵",
  "profile.pass.bonus": "獎勵",
  "profile.pass.usage": "本月用量",
  "profile.pass.paid": "付費",
  "profile.pass.meter": "Sonderr Pass 每月用量",
  ...
  "settings.aboutSonderr.title": "關於 Sonderr",

  "session.messages.welcome": "Sonderr 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutSonderr.status.connected": "已連線",
  "settings.aboutSonderr.status.connecting": "連線中...",
  "settings.aboutSonderr.status.disconnected": "已中斷",
  "settings.aboutSonderr.status.error": "錯誤",
  "settings.aboutSonderr.cliServer": "CLI 伺服器",
  "settings.aboutSonderr.status.label": "狀態：",
  "settings.aboutSonderr.port.label": "連接埠：",
  "settings.aboutSonderr.versionInfo": "版本資訊",
  "settings.aboutSonderr.version.label": "版本：",
  "settings.aboutSonderr.community": "社群與支援",
  "settings.aboutSonderr.feedback.prefix": "如果您有任何問題或回饋，歡迎在以下平台提交 issue",
  "settings.aboutSonderr.feedback.or": "或",
  "settings.aboutSonderr.support.prefix": "如有帳單或帳戶問題，請聯繫客戶支援",
  "settings.aboutSonderr.resetSettings.title": "重置設定",
  "settings.aboutSonderr.resetSettings.description":
    "此操作僅將 VS Code 擴充功能專屬設定重置為預設值。與 CLI 共享的設定（例如模式和自動核准規則）儲存在 CLI 設定中，不會被重置。",
  "settings.aboutSonderr.resetSettings.button": "重置所有設定",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "設定轉移",
  "settings.aboutSonderr.settingsTransfer.description": "匯出或匯入設定，以便在 VS Code 實例之間轉移。",
  "settings.aboutSonderr.exportSettings": "匯出",
  "settings.aboutSonderr.importSettings": "匯入",
  "settings.aboutSonderr.importSettings.invalidJson": "無效的 JSON 檔案。請選擇有效的設定檔。",
  "settings.aboutSonderr.importSettings.invalidConfig": "檔案不包含有效的 Sonderr 設定。",
  "settings.aboutSonderr.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutSonderr.importSettings.newerVersion": "此檔案由較新版本的 Sonderr 匯出。部分設定可能會被忽略。",
  "settings.aboutSonderr.importSettings.success": "設定已匯入。請檢視上方的變更，然後點擊儲存。",

  "settings.aboutSonderr.telemetry.title": "遙測",
  "settings.aboutSonderr.telemetry.description":
    '遙測由 VS Code 內建的遙測設定控制。若要停用，請前往「設定」>「遙測」>「遙測層級」並將其設為 "off"。重新啟動 VS Code 以套用變更。',
  "settings.aboutSonderr.telemetry.openSettings": "開啟遙測設定",
  ...
  "settings.language.description": "選擇 Sonderr 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.models.speechToText.disabledDescription":
    "啟用並登入 Sonderr 供應商以使用 Speech to Text。Speech to Text 目前僅支援透過 Sonderr Gateway 使用。",
  "settings.models.speechToTextModel.title": "語音轉文字模型",
  "settings.models.speechToTextModel.description": "選擇用於語音輸入的 Sonderr Gateway 轉錄模型。",
  ...
  "settings.experimental.remote.description": "透過 Sonderr Cloud 啟用工作階段的 Remote 控制。這也會影響此電腦上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "從您的 Claude Code 設定目錄將 CLAUDE.md 指示與技能載入至工作階段中。如果您希望 Sonderr 使用您的 Claude Code 指示與技能，請啟用此選項。需要重新啟動。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未設定 MCP 伺服器。在 sonderr.jsonc 中新增 MCP 伺服器，或請代理為您新增。",
  "settings.agentBehaviour.workflows.description":
    "工作流程是在設定中定義的自訂斜線命令。在聊天中輸入 /command-name 來呼叫它們。命令在 sonderr.json 的 'command' 區段中設定。",
  "settings.agentBehaviour.workflows.empty": "未設定自訂命令。將命令新增至 sonderr.json 即可在此處看到。",
  ...
  "settings.sandboxing.enabled.description":
    "在作業系統層級沙盒中執行代理 shell 指令，將寫入限制在專案和 Sonderr 狀態目錄內",
  ...
  "settings.display.fontSize.description": "獨立於 VS Code 調整 Sonderr webview UI 的字體大小。",
  ...
  "settings.indexing.sonderrModel.title": "Sonderr 模型預設",
  "settings.indexing.sonderrModel.description": "選擇支援的 Sonderr 託管嵌入模型。",
  "settings.indexing.sonderrSignIn.title": "需要登入 Sonderr",
  "settings.indexing.sonderrSignIn.description": "登入 Sonderr 以使用託管嵌入。",
  ...
  "settings.aboutSonderr.legacyMigration.title": "舊版遷移",
  "settings.aboutSonderr.legacyMigration.description":
    "從舊版 Sonderr 安裝遷移設定，包括供應商 API 金鑰和預設模型。",
  "settings.aboutSonderr.rooImport.description": "從 Roo Code 安裝匯入對話歷史記錄。",
  "settings.aboutSonderr.rooImport.button": "從 Roo Code 匯入工作階段",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Sonderr 新功能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Sonderr 產品共享一個小巧高效的核心。無論你選擇哪種方式工作，都能獲得熟悉的體驗。",
  ...
  "diffViewer.source.session.tooltip": "Sonderr 在目前工作階段中變更的檔案，依據每輪快照。開始新工作階段時重置。",
