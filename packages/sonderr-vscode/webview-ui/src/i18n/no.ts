...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installer Anaconda Desktop på denne maskinen, og kom deretter tilbake hit. Sonderr kjører ikke installasjonsprogrammet for deg.",
  ...
  "provider.anaconda.state.signedOut": "Åpne Anaconda Desktop og logg inn før du kobler til Sonderr.",
  "provider.anaconda.state.unauthorized":
    "Sonderr fikk ikke tilgang til Anaconda Desktop. Åpne Desktop, logg inn på nytt, og start det på nytt om nødvendig.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr fant en sunn lokal tekstgenereringsserver og kan importere de gjeldende tilkoblingsinnstillingene.",
  ...
  "provider.anaconda.toast.refreshed.description": "Den aktive lokale serveren og modellene er oppdatert i Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Sonderr.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox er aktivert. Shell-kommandoer for agenten er begrenset til prosjekt- og Sonderr-mappene.",
  "prompt.action.sandbox.disabled":
    "Sandbox er deaktivert. Klikk for å begrense skriving av shell-kommandoer for agenten til prosjekt- og Sonderr-mappene.",
  ...
  "prompt.action.sandbox.description.enabled": "Skrivetilgang er begrenset til prosjekt- og Sonderr-mappene.",
  ...
  "speechToText.tooltip.start": "Start taleinndata med Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Logg på Sonderr for å bruke taleinndata.",
  ...
  "sidebar.topBar.label": "Sonderr-navigasjon",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul Sonderr Gateway-modeller der leverandørene kan bruke ledetekstene dine til trening.",
  ...
  "settings.config.title": "Åpne {{scope}} Sonderr-konfigurasjonsfil",
  "settings.config.placeholder":
    "Konfigurasjonsfiler slås sammen i rekkefølge; filer merket som lastet påvirker for øyeblikket innstillingene.",
  "settings.config.noWorkspace": "Åpne en arbeidsområdemappe for å redigere den lokale Sonderr-konfigurasjonsfilen.",
  "settings.config.openFailed": "Klarte ikke å åpne {{scope}} Sonderr-konfigurasjonsfil: {{message}}",
  "settings.config.source.xdg": "XDG global konfigurasjon",
  "settings.config.source.homeSonderr": "Home .sonderr-konfigurasjon",
  "settings.config.source.homeSonderr": "Home .sonderr-konfigurasjon",
  "settings.config.source.homeSonderr": "Home .sonderr-konfigurasjon",
  "settings.config.source.envFile": "SONDERR_CONFIG miljøfil",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Innebygd miljøkonfigurasjon",
  "settings.config.source.projectSonderr": "Prosjekt .sonderr-konfigurasjon",
  "settings.config.source.projectRoot": "Prosjektets rotkonfigurasjon",
  "settings.config.source.projectSonderr": "Eldre .sonderr-konfigurasjon",
  "settings.config.source.projectSonderr": "Eldre .sonderr-konfigurasjon",
  ...
  "workStyle.onboarding.welcome": "Velkommen til Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr tar pause og viser deg planen sin mens den arbeider.",
  ...
  "session.cloud.import.placeholder": "Økt-ID, URL eller sonderr import-kommando",
  ...
  "deviceAuth.title": "Logg inn på Sonderr",
  ...
  "profile.action.login": "Logg inn med Sonderr",
  ...
  "profile.usage.routing": "Abonnementsfakturering er aktiv. Sonderr Gateway-ruting er {{state}}.",
  ...
  "profile.pass.subscribe": "Få Sonderr Pass for å legge til kreditt og tjene bonuser",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "Denne månedens forbruk",
  "profile.pass.paid": "Betalt",
  "profile.pass.meter": "Månedlig Sonderr Pass-forbruk",
  ...
  "settings.aboutSonderr.title": "Om Sonderr",

  "session.messages.welcome":
    "Sonderr er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutSonderr.status.connected": "Tilkoblet",
  "settings.aboutSonderr.status.connecting": "Kobler til...",
  "settings.aboutSonderr.status.disconnected": "Frakoblet",
  "settings.aboutSonderr.status.error": "Feil",
  "settings.aboutSonderr.cliServer": "CLI-server",
  "settings.aboutSonderr.status.label": "Status:",
  "settings.aboutSonderr.port.label": "Port:",
  "settings.aboutSonderr.versionInfo": "Versjonsinformasjon",
  "settings.aboutSonderr.version.label": "Versjon:",
  "settings.aboutSonderr.community": "Fellesskap og støtte",
  "settings.aboutSonderr.feedback.prefix": "Hvis du har spørsmål eller tilbakemeldinger, åpne gjerne en issue på",
  "settings.aboutSonderr.feedback.or": "eller",
  "settings.aboutSonderr.support.prefix": "For fakturerings- eller kontospørsmål, kontakt kundestøtte på",
  "settings.aboutSonderr.resetSettings.title": "Tilbakestill innstillinger",
  ...
  "settings.aboutSonderr.resetSettings.button": "Tilbakestill alle innstillinger",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Overføring av innstillinger",
  ...
  "settings.aboutSonderr.exportSettings": "Eksporter",
  "settings.aboutSonderr.importSettings": "Importer",
  "settings.aboutSonderr.importSettings.invalidJson": "Ugyldig JSON-fil. Vennligst velg en gyldig innstillingsfil.",
  "settings.aboutSonderr.importSettings.invalidConfig": "Filen inneholder ikke gyldige Sonderr-innstillinger.",
  "settings.aboutSonderr.importSettings.tooLarge": "Filen er for stor. Innstillingsfiler må være under 1 MB.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "Denne filen ble eksportert fra en nyere versjon av Sonderr. Noen innstillinger kan bli ignorert.",
  ...
  "settings.aboutSonderr.telemetry.title": "Telemetri",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Åpne innstillinger for telemetri",
  ...
  "settings.language.description": 'Velg språket for Sonderr-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Aktiver og logg på Sonderr-leverandøren for å bruke Speech to Text. Speech to Text støttes for øyeblikket bare med Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Tale-til-tekst-modell",
  "settings.models.speechToTextModel.description": "Velg Sonderr Gateway-transkripsjonsmodellen for taleinndata.",
  ...
  "settings.experimental.remote.description":
    "Aktiver Remote-kontroll av økter via Sonderr Cloud. Dette vil også påvirke CLI-er på denne maskinen.",
  ...
  "settings.indexing.sonderrModel.title": "Sonderr-modellforhåndsvalg",
  "settings.indexing.sonderrModel.description": "Velg en støttet Sonderr-hostet embedding-modell.",
  "settings.indexing.sonderrSignIn.title": "Sonderr-pålogging kreves",
  "settings.indexing.sonderrSignIn.description": "Logg inn på Sonderr for å bruke hostede embeddings.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Last inn CLAUDE.md-instruksjoner og ferdigheter fra Claude Code-konfigurasjonsmappen din i økter. Aktiver dette hvis du vil at Sonderr skal bruke dine Claude Code-instruksjoner og ferdigheter. Krever omstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigurert. Legg til MCP-servere i sonderr.jsonc, eller be agenten om å legge dem til.",
  "settings.agentBehaviour.workflows.description":
    "Arbeidsflyter er egendefinerte skråstrekkommandoer definert i konfigurasjonen din. Skriv /command-name i chatten for å kjøre dem. Kommandoer konfigureres i sonderr.json under seksjonen 'command'.",
  "settings.agentBehaviour.workflows.empty":
    "Ingen egendefinerte kommandoer konfigurert. Legg til kommandoer i sonderr.json for å se dem her.",
  ...
  "settings.sandboxing.enabled.description":
    "Kjør shell-kommandoer for agenten i en sandbox på operativsystemnivå som begrenser skriving til prosjekt- og Sonderr-tilstandsmapper",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Sonderr webview UI uavhengig av VS Code.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Migrering fra eldre versjon",
  "settings.aboutSonderr.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av Sonderr, inkludert API-nøkler for leverandører og standardmodell.",
  "settings.aboutSonderr.rooImport.description": "Importer samtalehistorikk fra en installasjon av Roo Code.",
  "settings.aboutSonderr.rooImport.button": "Importer økter fra Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én liten, effektiv kjerne på tvers av alle Sonderr-produkter. En kjent opplevelse uansett hvordan du velger å jobbe.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer endret av Sonderr i løpet av gjeldende økt, basert på øyeblikksbilder per tur. Tilbakestilles når du starter en ny økt.",
