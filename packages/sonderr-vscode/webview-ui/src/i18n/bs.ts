...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instalirajte Anaconda Desktop na ovom računaru, zatim se vratite ovdje. Sonderr ne pokreće instalacijski program umjesto vas.",
  ...
  "provider.anaconda.state.unauthorized":
    "Sonderr nije mogao pristupiti Anaconda Desktopu. Otvorite Desktop, ponovo se prijavite i ponovo ga pokrenite ako je potrebno.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr je pronašao ispravan lokalni server za generisanje teksta i može uvesti njegove trenutne postavke veze.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Sonderr-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Sonderr-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Sonderr-u.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox je omogućen. Shell komande agenta su ograničene na direktorije projekta i Sonderr.",
  "prompt.action.sandbox.disabled":
    "Sandbox je onemogućen. Kliknite da ograničite pisanje shell komandi agenta na direktorije projekta i Sonderr.",
  ...
  "prompt.action.sandbox.description.enabled": "Pisanje je ograničeno na direktorije projekta i Sonderr.",
  ...
  "speechToText.tooltip.start": "Započni glasovni unos sa Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Prijavite se na Sonderr da koristite glasovni unos.",
  ...
  "sidebar.topBar.label": "Navigacija Sonderr",
  ...
  "settings.indexing.sonderrModel.title": "Preset Sonderr modela",
  "settings.indexing.sonderrModel.description": "Odaberite podržani model embeddinga hostovan na Sonderr.",
  "settings.indexing.sonderrSignIn.title": "Potrebna je prijava na Sonderr",
  "settings.indexing.sonderrSignIn.description": "Prijavite se na Sonderr za korištenje hostovanih embeddinga.",
  ...
  "settings.models.hidePromptTraining.description":
    "Sakrij Sonderr Gateway modele čiji pružaoci mogu koristiti vaše promptove za treniranje.",
  ...
  "settings.config.title": "Otvori {{scope}} Sonderr konfiguracijsku datoteku",
  "settings.config.placeholder":
    "Konfiguracijske datoteke se spajaju po redu; datoteke označene kao učitane trenutno utiču na postavke.",
  "settings.config.noWorkspace": "Otvorite fasciklu radnog prostora da uredite lokalnu Sonderr konfiguracijsku datoteku.",
  "settings.config.openFailed": "Nije uspjelo otvaranje {{scope}} Sonderr konfiguracijske datoteke: {{message}}",
  "settings.config.source.xdg": "XDG globalna konfiguracija",
  "settings.config.source.homeSonderr": "Home .sonderr konfiguracija",
  "settings.config.source.homeSonderr": "Home .sonderr konfiguracija",
  "settings.config.source.homeSonderr": "Home .sonderr konfiguracija",
  "settings.config.source.envFile": "SONDERR_CONFIG datoteka okruženja",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Ugrađena konfiguracija okruženja",
  "settings.config.source.projectSonderr": "Projektna .sonderr konfiguracija",
  "settings.config.source.projectRoot": "Konfiguracija korijena projekta",
  "settings.config.source.projectSonderr": "Zastarjela .sonderr konfiguracija",
  "settings.config.source.projectSonderr": "Zastarjela .sonderr konfiguracija",
  ...
  "workStyle.onboarding.welcome": "Dobro došli u Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr zastaje i prikazuje vam svoj plan tokom rada.",
  ...
  "session.cloud.import.placeholder": "ID sesije, URL ili sonderr import naredba",
  ...
  "deviceAuth.title": "Prijavite se u Sonderr",
  ...
  "profile.action.login": "Prijavite se putem Sonderr",
  ...
  "profile.usage.routing": "Naplata plana je aktivna. Sonderr Gateway usmjeravanje je {{state}}.",
  ...
  "profile.pass.subscribe": "Nabavite Sonderr Pass da dodate kredite i zaradite bonuse",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "Potrošnja ovog mjeseca",
  "profile.pass.paid": "Plaćeno",
  "profile.pass.meter": "Mjesečna potrošnja Sonderr Passa",
  ...
  "settings.aboutSonderr.title": "O Sonderr-u",

  "session.messages.welcome":
    "Sonderr je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutSonderr.status.connected": "Povezano",
  "settings.aboutSonderr.status.connecting": "Povezivanje...",
  "settings.aboutSonderr.status.disconnected": "Odspojeno",
  "settings.aboutSonderr.status.error": "Greška",
  "settings.aboutSonderr.cliServer": "CLI server",
  "settings.aboutSonderr.status.label": "Status:",
  "settings.aboutSonderr.port.label": "Port:",
  "settings.aboutSonderr.versionInfo": "Informacije o verziji",
  "settings.aboutSonderr.version.label": "Verzija:",
  "settings.aboutSonderr.community": "Zajednica i podrška",
  "settings.aboutSonderr.feedback.prefix": "Ako imate pitanja ili povratne informacije, slobodno otvorite issue na",
  "settings.aboutSonderr.feedback.or": "ili",
  "settings.aboutSonderr.support.prefix": "Za pitanja o naplati ili računu, kontaktirajte korisničku podršku na",
  "settings.aboutSonderr.resetSettings.title": "Resetovanje postavki",
  ...
  "settings.aboutSonderr.resetSettings.button": "Resetuj sve postavke",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Prijenos postavki",
  "settings.aboutSonderr.settingsTransfer.description":
    "Izvezite ili uvezite postavke za prijenos između VS Code instanci.",
  "settings.aboutSonderr.exportSettings": "Izvezi",
  "settings.aboutSonderr.importSettings": "Uvezi",
  "settings.aboutSonderr.importSettings.invalidJson": "Nevažeći JSON fajl. Odaberite važeći fajl s postavkama.",
  "settings.aboutSonderr.importSettings.invalidConfig": "Fajl ne sadrži važeće Sonderr postavke.",
  "settings.aboutSonderr.importSettings.tooLarge": "Fajl je prevelik. Fajlovi s postavkama moraju biti manji od 1 MB.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "Ovaj fajl je izvezen iz novije verzije Sonderr-a. Neke postavke mogu biti zanemarene.",
  "settings.aboutSonderr.importSettings.success":
    "Postavke su uvezene. Pregledajte promjene iznad, a zatim kliknite Sačuvaj.",

  "settings.aboutSonderr.telemetry.title": "Telemetrija",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Otvori postavke telemetrije",
  ...
  "settings.language.description": 'Odaberite jezik za Sonderr sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Omogućite i prijavite se na Sonderr provajder da biste koristili Speech to Text. Speech to Text je trenutno podržan samo uz Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Model govora u tekst",
  "settings.models.speechToTextModel.description": "Odaberite Sonderr Gateway model za transkripciju za glasovni unos.",
  ...
  "settings.experimental.remote.description":
    "Omogućite Remote kontrolu sesija putem Sonderr Cloud. Ovo će također utjecati na CLI-jeve na ovoj mašini.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Učitajte CLAUDE.md instrukcije i vještine iz vašeg Claude Code konfiguracijskog direktorija u sesije. Omogućite ovo ako želite da Sonderr koristi vaše Claude Code instrukcije i vještine. Zahtijeva ponovno pokretanje.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nema konfiguriranih MCP servera. Dodajte MCP servere u sonderr.jsonc ili zamolite agenta da ih doda.",
  "settings.agentBehaviour.workflows.description":
    "Tokovi rada su prilagođene slash komande definirane u vašoj konfiguraciji. Upišite /command-name u chat da ih pokrenete. Komande se konfiguriraju u sonderr.json pod sekcijom 'command'.",
  "settings.agentBehaviour.workflows.empty":
    "Nema konfiguriranih prilagođenih komandi. Dodajte komande u sonderr.json da ih vidite ovdje.",
  ...
  "settings.sandboxing.enabled.description":
    "Pokrenite shell komande agenta unutar sandboxa na nivou operativnog sistema koji ograničava pisanje na direktorije stanja projekta i Sonderr",
  ...
  "settings.display.fontSize.description": "Prilagodite veličinu fonta za Sonderr webview UI nezavisno od VS Code-a.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Migracija sa prethodne verzije",
  "settings.aboutSonderr.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije Sonderr, uključujući API ključeve provajdera i podrazumijevani model.",
  "settings.aboutSonderr.rooImport.description": "Uvezite historiju razgovora iz instalacije Roo Code.",
  "settings.aboutSonderr.rooImport.button": "Uvezi sesije iz Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Šta je novo u Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno malo, efikasno jezgro kroz sve Sonderr proizvode. Poznato iskustvo bez obzira na to kako odaberete raditi.",
  ...
  "diffViewer.source.session.tooltip":
    "Datoteke koje je Sonderr promijenio tokom trenutne sesije, na osnovu snapshota po koraku. Resetuje se kada pokrenete novu sesiju.",
