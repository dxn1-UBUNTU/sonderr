...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Zainstaluj Anaconda Desktop na tym komputerze, a następnie wróć tutaj. Sonderr nie uruchamia instalatora za Ciebie.",
  ...
  "provider.anaconda.state.signedOut": "Otwórz Anaconda Desktop i zaloguj się przed połączeniem Sonderr.",
  "provider.anaconda.state.unauthorized":
    "Sonderr nie mógł uzyskać dostępu do Anaconda Desktop. Otwórz Desktop, zaloguj się ponownie i w razie potrzeby uruchom ją ponownie.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr znalazł sprawny lokalny serwer generowania tekstu i może zaimportować jego bieżące ustawienia połączenia.",
  ...
  "provider.anaconda.toast.refreshed.description": "Aktywny serwer lokalny i modele są aktualne w Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Sonderr.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox jest włączony. Polecenia shell agenta są ograniczone do katalogów projektu i Sonderr.",
  "prompt.action.sandbox.disabled":
    "Sandbox jest wyłączony. Kliknij, aby ograniczyć zapisy poleceń shell agenta do katalogów projektu i Sonderr.",
  ...
  "prompt.action.sandbox.description.enabled": "Zapisy są ograniczone do katalogów projektu i Sonderr.",
  ...
  "speechToText.tooltip.start": "Rozpocznij wprowadzanie głosowe z Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Zaloguj się do Sonderr, aby korzystać z wprowadzania głosowego.",
  ...
  "sidebar.topBar.label": "Nawigacja Sonderr",
  ...
  "settings.models.hidePromptTraining.description":
    "Ukryj modele Sonderr Gateway, których dostawcy mogą używać Twoich promptów do trenowania.",
  ...
  "settings.config.title": "Otwórz plik konfiguracyjny Sonderr ({{scope}})",
  "settings.config.placeholder":
    "Pliki konfiguracyjne są scalane po kolei; pliki oznaczone jako wczytane mają obecnie wpływ na ustawienia.",
  "settings.config.noWorkspace": "Otwórz folder obszaru roboczego, aby edytować lokalny plik konfiguracyjny Sonderr.",
  "settings.config.openFailed": "Nie udało się otworzyć pliku konfiguracyjnego Sonderr ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Globalna konfiguracja XDG",
  "settings.config.source.homeSonderr": "Konfiguracja .sonderr (Home)",
  "settings.config.source.homeSonderr": "Konfiguracja .sonderr (Home)",
  "settings.config.source.homeSonderr": "Konfiguracja .sonderr (Home)",
  "settings.config.source.envFile": "Plik środowiskowy SONDERR_CONFIG",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Wbudowana konfiguracja środowiska",
  "settings.config.source.projectSonderr": "Konfiguracja .sonderr projektu",
  "settings.config.source.projectRoot": "Konfiguracja główna projektu",
  "settings.config.source.projectSonderr": "Przestarzała konfiguracja .sonderr",
  "settings.config.source.projectSonderr": "Przestarzała konfiguracja .sonderr",
  ...
  "workStyle.onboarding.welcome": "Witamy w Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr wstrzymuje pracę i pokazuje swój plan w trakcie działania.",
  ...
  "session.cloud.import.placeholder": "ID sesji, URL lub polecenie sonderr import",
  ...
  "deviceAuth.title": "Zaloguj się do Sonderr",
  ...
  "profile.action.login": "Zaloguj się przez Sonderr",
  ...
  "profile.usage.routing": "Rozliczanie planu jest aktywne. Routing przez Sonderr Gateway jest {{state}}.",
  ...
  "profile.pass.subscribe": "Zdobądź Sonderr Pass, aby dodać środki i zdobywać bonusy",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "Zużycie w tym miesiącu",
  "profile.pass.paid": "Opłacone",
  "profile.pass.meter": "Miesięczne zużycie Sonderr Pass",
  ...
  "settings.aboutSonderr.title": "O Sonderr",

  "session.messages.welcome":
    "Sonderr to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutSonderr.status.connected": "Połączono",
  "settings.aboutSonderr.status.connecting": "Łączenie...",
  "settings.aboutSonderr.status.disconnected": "Rozłączono",
  "settings.aboutSonderr.status.error": "Błąd",
  "settings.aboutSonderr.cliServer": "Serwer CLI",
  "settings.aboutSonderr.status.label": "Status:",
  "settings.aboutSonderr.port.label": "Port:",
  "settings.aboutSonderr.versionInfo": "Informacje o wersji",
  "settings.aboutSonderr.version.label": "Wersja:",
  "settings.aboutSonderr.community": "Społeczność i wsparcie",
  "settings.aboutSonderr.feedback.prefix": "Jeśli masz pytania lub uwagi, śmiało otwórz zgłoszenie na",
  "settings.aboutSonderr.feedback.or": "lub",
  "settings.aboutSonderr.support.prefix":
    "W sprawach rozliczeń lub konta skontaktuj się z obsługą klienta pod adresem",
  "settings.aboutSonderr.resetSettings.title": "Resetuj ustawienia",
  ...
  "settings.aboutSonderr.resetSettings.button": "Resetuj wszystkie ustawienia",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Przenoszenie ustawień",
  ...
  "settings.aboutSonderr.exportSettings": "Eksportuj",
  "settings.aboutSonderr.importSettings": "Importuj",
  "settings.aboutSonderr.importSettings.invalidJson": "Nieprawidłowy plik JSON. Wybierz prawidłowy plik ustawień.",
  "settings.aboutSonderr.importSettings.invalidConfig": "Plik nie zawiera prawidłowych ustawień Sonderr.",
  "settings.aboutSonderr.importSettings.tooLarge": "Plik jest za duży. Pliki ustawień muszą mieć mniej niż 1 MB.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "Ten plik został wyeksportowany z nowszej wersji Sonderr. Niektóre ustawienia mogą zostać zignorowane.",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Otwórz ustawienia telemetrii",
  ...
  "settings.language.description": 'Wybierz język interfejsu Sonderr. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Włącz i zaloguj się do dostawcy Sonderr, aby korzystać ze Speech to Text. Speech to Text jest obecnie obsługiwane tylko z Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Model mowy na tekst",
  "settings.models.speechToTextModel.description":
    "Wybierz model transkrypcji Sonderr Gateway dla wprowadzania głosowego.",
  ...
  "settings.experimental.remote.description":
    "Włącz sterowanie Remote sesjami za pośrednictwem Sonderr Cloud. Wpłynie to również na CLI na tej maszynie.",
  ...
  "settings.indexing.sonderrModel.title": "Preset modelu Sonderr",
  "settings.indexing.sonderrModel.description": "Wybierz obsługiwany model osadzania hostowany przez Sonderr.",
  "settings.indexing.sonderrSignIn.title": "Wymagane logowanie do Sonderr",
  "settings.indexing.sonderrSignIn.description": "Zaloguj się do Sonderr, aby używać hostowanych osadzeń.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Wczytuje instrukcje CLAUDE.md oraz umiejętności z katalogu konfiguracyjnego Claude Code do sesji. Włącz tę opcję, jeśli chcesz, aby Sonderr korzystał z Twoich instrukcji i umiejętności Claude Code. Wymaga ponownego uruchomienia.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Brak skonfigurowanych serwerów MCP. Dodaj serwery MCP w sonderr.jsonc lub poproś agenta o ich dodanie.",
  "settings.agentBehaviour.workflows.description":
    "Przepływy pracy to niestandardowe komendy slash zdefiniowane w konfiguracji. Wpisz /command-name na czacie, aby je uruchomić. Komendy konfiguruje się w sonderr.json w sekcji 'command'.",
  "settings.agentBehaviour.workflows.empty":
    "Brak skonfigurowanych niestandardowych komend. Dodaj komendy do sonderr.json, aby je tu zobaczyć.",
  ...
  "settings.sandboxing.enabled.description":
    "Uruchamiaj polecenia shell agenta w sandboxie na poziomie systemu operacyjnego, który ogranicza zapisy do katalogów stanu projektu i Sonderr",
  ...
  "settings.display.fontSize.description": "Dostosuj rozmiar czcionki webview UI Sonderr niezależnie od VS Code.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Migracja starszej wersji",
  "settings.aboutSonderr.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji Sonderr, w tym klucze API dostawców i domyślny model.",
  "settings.aboutSonderr.rooImport.description": "Importuj historię rozmów z instalacji Roo Code.",
  "settings.aboutSonderr.rooImport.button": "Importuj sesje z Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno małe, wydajne jądro we wszystkich produktach Sonderr. Znajome doświadczenie niezależnie od sposobu pracy.",
  ...
  "diffViewer.source.session.tooltip":
    "Pliki zmienione przez Sonderr w trakcie bieżącej sesji, na podstawie snapshotów na turę. Resetowane przy rozpoczęciu nowej sesji.",
