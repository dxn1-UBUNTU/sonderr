...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Встановіть Anaconda Desktop на цьому комп'ютері, а потім поверніться сюди. Sonderr не запускає інсталятор за вас.",
  ...
  "provider.anaconda.state.signedOut": "Відкрийте Anaconda Desktop та увійдіть перед підключенням Sonderr.",
  "provider.anaconda.state.unauthorized":
    "Sonderr не вдалося отримати доступ до Anaconda Desktop. Відкрийте Desktop, увійдіть знову та перезапустіть його за потреби.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr знайшов справний локальний сервер генерації тексту та може імпортувати його поточні налаштування підключення.",
  ...
  "provider.anaconda.toast.refreshed.description": "Активний локальний сервер та моделі актуальні в Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Введіть свій API-ключ {{provider}}, щоб підключити акаунт {{provider}} і використовувати моделі {{provider}} в Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " щоб отримати код авторизації для підключення акаунта та використання моделей {{provider}} у Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " та введіть код нижче, щоб підключити акаунт і використовувати моделі {{provider}} у Sonderr.",
  ...
  "prompt.action.sandbox.enabled": "Пісочницю увімкнено. Команди оболонки агента обмежені каталогами проєкту та Sonderr.",
  "prompt.action.sandbox.disabled":
    "Пісочницю вимкнено. Натисніть, щоб обмежити запис команд оболонки агента каталогами проєкту та Sonderr.",
  ...
  "prompt.action.sandbox.description.enabled": "Запис дозволено лише в каталогах проєкту та Sonderr.",
  ...
  "speechToText.tooltip.start": "Почати голосове введення з Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Увійдіть до Sonderr, щоб використовувати голосове введення.",
  ...
  "sidebar.topBar.label": "Навігація Sonderr",
  ...
  "settings.config.title": "Відкрити файл конфігурації Sonderr ({{scope}})",
  "settings.config.placeholder":
    "Файли конфігурації об'єднуються по порядку; файли, позначені як завантажені, наразі впливають на налаштування.",
  "settings.config.noWorkspace": "Відкрийте папку робочої області, щоб відредагувати локальний файл конфігурації Sonderr.",
  "settings.config.openFailed": "Не вдалося відкрити файл конфігурації Sonderr ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Глобальна конфігурація XDG",
  "settings.config.source.homeSonderr": "Конфігурація .sonderr (Home)",
  "settings.config.source.homeSonderr": "Конфігурація .sonderr (Home)",
  "settings.config.source.homeSonderr": "Конфігурація .sonderr (Home)",
  "settings.config.source.envFile": "Файл середовища SONDERR_CONFIG",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Вбудована конфігурація середовища",
  "settings.config.source.projectSonderr": "Конфігурація .sonderr проєкту",
  "settings.config.source.projectRoot": "Коренева конфігурація проєкту",
  "settings.config.source.projectSonderr": "Застаріла конфігурація .sonderr",
  "settings.config.source.projectSonderr": "Застаріла конфігурація .sonderr",
  ...
  "workStyle.onboarding.welcome": "Ласкаво просимо до Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr призупиняється та показує свій план у процесі роботи.",
  ...
  "session.cloud.import.placeholder": "Ідентифікатор сесії, URL або команда sonderr import",
  ...
  "deviceAuth.title": "Увійти до Sonderr",
  ...
  "profile.action.login": "Увійти через Sonderr",
  ...
  "profile.usage.routing": "Оплата плану активна. Маршрутизація через Sonderr Gateway {{state}}.",
  ...
  "profile.pass.subscribe": "Отримайте Sonderr Pass, щоб додати кредити та заробляти бонуси",
  "profile.pass.bonus": "Бонус",
  "profile.pass.usage": "Використання за цей місяць",
  "profile.pass.paid": "Оплачено",
  "profile.pass.meter": "Щомісячне використання Sonderr Pass",
  ...
  "settings.aboutSonderr.title": "Про Sonderr",

  "session.messages.welcome":
    "Sonderr — це асистент з кодування на базі ШІ. Попросіть його розробити функцію, виправити помилку або пояснити вашу кодову базу.",
  ...
  "settings.aboutSonderr.status.connected": "Підключено",
  "settings.aboutSonderr.status.connecting": "Підключення...",
  "settings.aboutSonderr.status.disconnected": "Відключено",
  "settings.aboutSonderr.status.error": "Помилка",
  "settings.aboutSonderr.cliServer": "CLI-сервер",
  "settings.aboutSonderr.status.label": "Статус:",
  "settings.aboutSonderr.port.label": "Порт:",
  "settings.aboutSonderr.versionInfo": "Інформація про версію",
  "settings.aboutSonderr.version.label": "Версія:",
  "settings.aboutSonderr.community": "Спільнота і підтримка",
  "settings.aboutSonderr.feedback.prefix": "Якщо у вас є питання або відгуки, будь ласка, відкрийте тікет на:",
  "settings.aboutSonderr.feedback.or": "або",
  "settings.aboutSonderr.support.prefix": "З питань виставлення рахунків або акаунту зверніться до служби підтримки:",
  "settings.aboutSonderr.resetSettings.title": "Скидання налаштувань",
  ...
  "settings.aboutSonderr.resetSettings.button": "Скинути всі налаштування",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Перенесення налаштувань",
  ...
  "settings.aboutSonderr.exportSettings": "Експортувати",
  "settings.aboutSonderr.importSettings": "Імпортувати",
  "settings.aboutSonderr.importSettings.invalidJson":
    "Недійсний файл JSON. Будь ласка, виберіть дійсний файл налаштувань.",
  "settings.aboutSonderr.importSettings.invalidConfig": "Файл не містить дійсних налаштувань Sonderr.",
  "settings.aboutSonderr.importSettings.tooLarge": "Файл занадто великий. Файли налаштувань мають бути менше 1 МБ.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "Цей файл було експортовано з новішої версії Sonderr. Деякі налаштування можуть бути проігноровані.",
  "settings.aboutSonderr.importSettings.success":
    "Налаштування імпортовано. Перегляньте зміни вище, потім натисніть Зберегти.",

  "settings.aboutSonderr.telemetry.title": "Телеметрія",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Відкрити налаштування телеметрії",
  ...
  "settings.language.description":
    '"Автоматично" використовує мову відображення VS Code. Виберіть мову для інтерфейсу Sonderr.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Увімкніть провайдер Sonderr та виконайте вхід, щоб використовувати Speech to Text. Наразі Speech to Text підтримується лише з Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Модель мовлення в текст",
  "settings.models.speechToTextModel.description": "Виберіть модель транскрипції Sonderr Gateway для голосового введення.",
  ...
  "settings.experimental.remote.description":
    "Увімкніть керування Remote сеансами через Sonderr Cloud. Це також вплине на CLI на цьому комп'ютері.",
  ...
  "settings.sandboxing.enabled.description":
    "Виконувати команди оболонки агента в пісочниці на рівні ОС, яка обмежує запис до каталогів стану проєкту та Sonderr",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Завантажувати інструкції та навички CLAUDE.md з вашого каталогу конфігурації Claude Code у сесії. Увімкніть це, якщо ви хочете, щоб Sonderr використовував ваші інструкції та навички Claude Code. Потребує перезапуску.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверів не налаштовано. Додайте MCP-сервери до sonderr.jsonc або попросіть агента додати їх.",
  "settings.agentBehaviour.workflows.description":
    "Робочі процеси — це власні команди з косою рискою, визначені у вашій конфігурації. Введіть /назва-команди в чаті, щоб викликати їх. Команди налаштовуються в розділі 'command' файлу sonderr.json.",
  "settings.agentBehaviour.workflows.empty":
    "Власних команд не налаштовано. Додайте команди до sonderr.json, щоб вони з'явилися тут.",
  ...
  "settings.display.fontSize.description": "Налаштуйте розмір шрифту webview UI для Sonderr незалежно від VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Приховувати моделі Sonderr Gateway, постачальники яких можуть використовувати ваші запити для навчання.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Перенесення зі старої версії",
  "settings.aboutSonderr.legacyMigration.description":
    "Перенести налаштування з попередньої версії Sonderr, включаючи API-ключі провайдерів та стандартну модель.",
  "settings.aboutSonderr.rooImport.description": "Імпортувати історію розмов з інсталяції Roo Code.",
  "settings.aboutSonderr.rooImport.button": "Імпортувати сесії з Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Що нового в Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Малий та ефективний ядерний модуль у кожному продукті Sonderr. Знайомий досвід незалежно від того, як ви вважаєте за краще працювати.",
  ...
  "settings.indexing.sonderrModel.title": "Пресет моделі Sonderr",
  "settings.indexing.sonderrModel.description": "Виберіть підтримувану модель Sonderr-hosted embeddings.",
  "settings.indexing.sonderrSignIn.title": "Потрібен вхід у Sonderr",
  "settings.indexing.sonderrSignIn.description": "Увійдіть у Sonderr, щоб використовувати hosted embeddings.",
  ...
  "diffViewer.source.session.tooltip":
    "Файли, змінені Sonderr під час поточної сесії, на основі знімків по ходу. Скидається при старті нової сесії.",
