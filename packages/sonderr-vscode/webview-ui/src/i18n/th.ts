...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "ติดตั้ง Anaconda Desktop บนเครื่องนี้ แล้วกลับมาที่นี่ Sonderr จะไม่เรียกใช้ตัวติดตั้งให้คุณ",
  ...
  "provider.anaconda.state.signedOut": "เปิด Anaconda Desktop และลงชื่อเข้าใช้ก่อนเชื่อมต่อ Sonderr",
  "provider.anaconda.state.unauthorized":
    "Sonderr ไม่สามารถเข้าถึง Anaconda Desktop ได้ เปิด Desktop ลงชื่อเข้าใช้อีกครั้ง และรีสตาร์ทหากจำเป็น",
  ...
  "provider.anaconda.state.ready":
    "Sonderr พบเซิร์ฟเวอร์สร้างข้อความในเครื่องที่พร้อมใช้งาน และสามารถนำเข้าการตั้งค่าการเชื่อมต่อปัจจุบันได้",
  ...
  "provider.anaconda.toast.refreshed.description": "เซิร์ฟเวอร์ในเครื่องและโมเดลที่ใช้งานอยู่เป็นปัจจุบันใน Sonderr แล้ว",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Sonderr",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Sonderr",
  ...
  "provider.connect.oauth.auto.visit.suffix": " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Sonderr",
  ...
  "prompt.action.sandbox.enabled":
    "เปิดใช้งาน sandbox แล้ว คำสั่ง shell ของ agent ถูกจำกัดไว้ที่โฟลเดอร์โปรเจ็กต์และ Sonderr",
  "prompt.action.sandbox.disabled":
    "ปิดใช้งาน sandbox อยู่ คลิกเพื่อจำกัดการเขียนคำสั่ง shell ของ agent ไว้ที่โฟลเดอร์โปรเจ็กต์และ Sonderr",
  ...
  "prompt.action.sandbox.description.enabled": "เขียนได้เฉพาะในโฟลเดอร์โปรเจ็กต์และ Sonderr",
  ...
  "speechToText.tooltip.start": "เริ่มการป้อนข้อมูลด้วยเสียงด้วย Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "ลงชื่อเข้าใช้ Sonderr เพื่อใช้การป้อนข้อมูลด้วยเสียง",
  ...
  "sidebar.topBar.label": "การนำทาง Sonderr",
  ...
  "settings.indexing.sonderrModel.title": "พรีเซ็ตโมเดล Sonderr",
  "settings.indexing.sonderrModel.description": "เลือกโมเดลการฝังที่ Sonderr โฮสต์และรองรับ",
  "settings.indexing.sonderrSignIn.title": "ต้องลงชื่อเข้าใช้ Sonderr",
  "settings.indexing.sonderrSignIn.description": "ลงชื่อเข้าใช้ Sonderr เพื่อใช้การฝังแบบโฮสต์",
  ...
  "settings.models.hidePromptTraining.description": "ซ่อนโมเดล Sonderr Gateway ที่ผู้ให้บริการอาจใช้พรอมต์ของคุณในการฝึก",
  ...
  "settings.config.title": "เปิดไฟล์การตั้งค่า Sonderr ({{scope}})",
  "settings.config.placeholder":
    "ไฟล์การตั้งค่าจะถูกผสานตามลำดับ ไฟล์ที่ถูกทำเครื่องหมายว่าโหลดแล้วจะมีผลกับการตั้งค่าในปัจจุบัน",
  "settings.config.noWorkspace": "เปิดโฟลเดอร์พื้นที่ทำงานเพื่อแก้ไขไฟล์การตั้งค่า Sonderr ภายใน",
  "settings.config.openFailed": "ไม่สามารถเปิดไฟล์การตั้งค่า Sonderr ({{scope}}): {{message}}",
  "settings.config.source.xdg": "การตั้งค่า XDG ทั่วโลก",
  "settings.config.source.homeSonderr": "การตั้งค่า .sonderr ของ Home",
  "settings.config.source.homeSonderr": "การตั้งค่า .sonderr ของ Home",
  "settings.config.source.homeSonderr": "การตั้งค่า .sonderr ของ Home",
  "settings.config.source.envFile": "ไฟล์สภาพแวดล้อม SONDERR_CONFIG",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "การตั้งค่าสภาพแวดล้อมแบบอินไลน์",
  "settings.config.source.projectSonderr": "การตั้งค่า .sonderr ของโปรเจกต์",
  "settings.config.source.projectRoot": "การตั้งค่ารูทของโปรเจกต์",
  "settings.config.source.projectSonderr": "การตั้งค่า .sonderr แบบเก่า",
  "settings.config.source.projectSonderr": "การตั้งค่า .sonderr แบบเก่า",
  ...
  "workStyle.onboarding.welcome": "ยินดีต้อนรับสู่ Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr จะหยุดและแสดงแผนให้คุณเห็นระหว่างการทำงาน",
  ...
  "session.cloud.import.placeholder": "ID เซสชัน, URL หรือคำสั่ง sonderr import",
  ...
  "deviceAuth.title": "เข้าสู่ระบบ Sonderr",
  ...
  "profile.action.login": "เข้าสู่ระบบด้วย Sonderr",
  ...
  "profile.usage.routing": "การเรียกเก็บเงินตามแผนเปิดใช้งานอยู่ การกำหนดเส้นทาง Sonderr Gateway {{state}}",
  ...
  "profile.pass.subscribe": "รับ Sonderr Pass เพื่อเพิ่มเครดิตและรับโบนัส",
  "profile.pass.bonus": "โบนัส",
  "profile.pass.usage": "การใช้งานเดือนนี้",
  "profile.pass.paid": "ชำระแล้ว",
  "profile.pass.meter": "การใช้งาน Sonderr Pass รายเดือน",
  ...
  "settings.aboutSonderr.title": "เกี่ยวกับ Sonderr",

  "session.messages.welcome": "Sonderr เป็นผู้ช่วยเขียนโค้ด AI ขอให้สร้างฟีเจอร์ แก้ไขบัก หรืออธิบายโค้ดเบสของคุณ",
  ...
  "settings.aboutSonderr.status.connected": "เชื่อมต่อแล้ว",
  "settings.aboutSonderr.status.connecting": "กำลังเชื่อมต่อ...",
  "settings.aboutSonderr.status.disconnected": "ตัดการเชื่อมต่อ",
  "settings.aboutSonderr.status.error": "ข้อผิดพลาด",
  "settings.aboutSonderr.cliServer": "เซิร์ฟเวอร์ CLI",
  "settings.aboutSonderr.status.label": "สถานะ:",
  "settings.aboutSonderr.port.label": "พอร์ต:",
  "settings.aboutSonderr.versionInfo": "ข้อมูลเวอร์ชัน",
  "settings.aboutSonderr.version.label": "เวอร์ชัน:",
  "settings.aboutSonderr.community": "ชุมชนและการสนับสนุน",
  "settings.aboutSonderr.feedback.prefix": "หากคุณมีคำถามหรือข้อเสนอแนะ สามารถเปิด issue ได้ที่",
  "settings.aboutSonderr.feedback.or": "หรือ",
  "settings.aboutSonderr.support.prefix": "สำหรับคำถามเกี่ยวกับการเรียกเก็บเงินหรือบัญชี ติดต่อฝ่ายสนับสนุนลูกค้าที่",
  "settings.aboutSonderr.resetSettings.title": "รีเซ็ตการตั้งค่า",
  ...
  "settings.aboutSonderr.resetSettings.button": "รีเซ็ตการตั้งค่าทั้งหมด",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "ถ่ายโอนการตั้งค่า",
  "settings.aboutSonderr.settingsTransfer.description":
    "ส่งออกหรือนำเข้าการตั้งค่าเพื่อถ่ายโอนระหว่างอินสแตนซ์ VS Code",
  "settings.aboutSonderr.exportSettings": "ส่งออก",
  "settings.aboutSonderr.importSettings": "นำเข้า",
  "settings.aboutSonderr.importSettings.invalidJson": "ไฟล์ JSON ไม่ถูกต้อง กรุณาเลือกไฟล์การตั้งค่าที่ถูกต้อง",
  "settings.aboutSonderr.importSettings.invalidConfig": "ไฟล์ไม่มีการตั้งค่า Sonderr ที่ถูกต้อง",
  "settings.aboutSonderr.importSettings.tooLarge": "ไฟล์มีขนาดใหญ่เกินไป ไฟล์การตั้งค่าต้องมีขนาดไม่เกิน 1 MB",
  "settings.aboutSonderr.importSettings.newerVersion":
    "ไฟล์นี้ถูกส่งออกจาก Sonderr เวอร์ชันใหม่กว่า การตั้งค่าบางรายการอาจถูกข้ามไป",
  "settings.aboutSonderr.importSettings.success": "นำเข้าการตั้งค่าแล้ว ตรวจสอบการเปลี่ยนแปลงด้านบน จากนั้นคลิกบันทึก",

  "settings.aboutSonderr.telemetry.title": "Telemetry",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "เปิดการตั้งค่า Telemetry",
  ...
  "settings.language.description": 'เลือกภาษาสำหรับ UI ของ Sonderr "อัตโนมัติ" จะใช้ภาษาการแสดงผลของ VS Code',
  ...
  "settings.models.speechToText.disabledDescription":
    "เปิดใช้งานและลงชื่อเข้าใช้ผู้ให้บริการ Sonderr เพื่อใช้ Speech to Text ปัจจุบัน Speech to Text รองรับเฉพาะกับ Sonderr Gateway เท่านั้น",
  "settings.models.speechToTextModel.title": "โมเดลแปลงเสียงเป็นข้อความ",
  "settings.models.speechToTextModel.description": "เลือกโมเดลการถอดเสียง Sonderr Gateway สำหรับการป้อนข้อมูลด้วยเสียง",
  ...
  "settings.experimental.remote.description":
    "เปิดใช้งานการควบคุม Remote ของเซสชันผ่าน Sonderr Cloud ซึ่งจะส่งผลต่อ CLI บนเครื่องนี้ด้วย",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "โหลดคำแนะนำและทักษะจาก CLAUDE.md ในไดเรกทอรีการกำหนดค่า Claude Code ของคุณลงในเซสชัน เปิดใช้งานตัวเลือกนี้หากคุณต้องการให้ Sonderr ใช้คำแนะนำและทักษะจาก Claude Code ของคุณ จำเป็นต้องรีสตาร์ท",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "ไม่ได้กำหนดค่าเซิร์ฟเวอร์ MCP เพิ่มเซิร์ฟเวอร์ MCP ใน sonderr.jsonc หรือขอให้เอเจนต์เพิ่มให้คุณ",
  "settings.agentBehaviour.workflows.description":
    "เวิร์กโฟลว์คือคำสั่งสแลชแบบกำหนดเองที่กำหนดไว้ในการตั้งค่าของคุณ พิมพ์ /command-name ในแชทเพื่อเรียกใช้ คำสั่งถูกกำหนดค่าใน sonderr.json ภายใต้ส่วน 'command'",
  "settings.agentBehaviour.workflows.empty":
    "ไม่มีคำสั่งแบบกำหนดเองที่กำหนดค่าไว้ เพิ่มคำสั่งใน sonderr.json เพื่อดูที่นี่",
  ...
  "settings.sandboxing.enabled.description":
    "เรียกใช้คำสั่ง shell ของ agent ใน sandbox ระดับระบบปฏิบัติการที่จำกัดการเขียนไปยังโฟลเดอร์สถานะของโปรเจ็กต์และ Sonderr",
  ...
  "settings.display.fontSize.description": "ปรับขนาดฟอนต์ webview UI ของ Sonderr แยกเป็นอิสระจาก VS Code.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "การย้ายข้อมูลจากเวอร์ชันดั้งเดิม",
  "settings.aboutSonderr.legacyMigration.description":
    "ย้ายการตั้งค่าจากการติดตั้ง Sonderr ก่อนหน้านี้ รวมถึงคีย์ API ของผู้ให้บริการและโมเดลเริ่มต้น",
  "settings.aboutSonderr.rooImport.description": "นำเข้าประวัติการสนทนาจากการติดตั้ง Roo Code",
  "settings.aboutSonderr.rooImport.button": "นำเข้าเซสชันจาก Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "มีอะไรใหม่ใน Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "แกนหลักขนาดเล็กและมีประสิทธิภาพเดียวกันในทุกผลิตภัณฑ์ Sonderr ประสบการณ์ที่คุ้นเคยไม่ว่าคุณจะเลือกทำงานอย่างไร",
  ...
  "diffViewer.source.session.tooltip":
    "ไฟล์ที่ Sonderr แก้ไขในช่วงเซสชันปัจจุบัน โดยอิงจากสแน็ปช็อตต่อเทิร์น จะรีเซ็ตเมื่อเริ่มเซสชันใหม่",
