...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "このマシンに Anaconda Desktop をインストールしてから、ここに戻ってください。Sonderr はインストーラーを実行しません。",
  ...
  "provider.anaconda.state.signedOut": "Sonderr を接続する前に、Anaconda Desktop を開いてサインインしてください。",
  "provider.anaconda.state.unauthorized":
    "Sonderr は Anaconda Desktop にアクセスできませんでした。Desktop を開いて再度サインインし、必要に応じて再起動してください。",
  ...
  "provider.anaconda.state.ready":
    "Sonderr は正常なローカルのテキスト生成サーバーを見つけ、現在の接続設定をインポートできます。",
  ...
  "provider.anaconda.toast.refreshed.description": "アクティブなローカルサーバーとモデルが Sonderr で最新になりました。",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Sonderrで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してSonderrで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Sonderrで{{provider}}モデルを使用してください。",
  ...
  "prompt.action.sandbox.enabled":
    "サンドボックスが有効です。エージェントのシェルコマンドは、プロジェクトおよびSonderrディレクトリに制限されています。",
  "prompt.action.sandbox.disabled":
    "サンドボックスが無効です。クリックしてエージェントのシェルコマンドの書き込みをプロジェクトおよびSonderrディレクトリに制限します。",
  ...
  "prompt.action.sandbox.description.enabled": "書き込みはプロジェクトおよびSonderrディレクトリ内に制限されます。",
  ...
  "speechToText.tooltip.start": "Sonderr Gatewayで音声入力を開始",
  ...
  "speechToText.error.loginRequired": "音声入力を使用するにはSonderrにサインインしてください。",
  ...
  "sidebar.topBar.label": "Sonderr ナビゲーション",
  ...
  "settings.indexing.sonderrModel.title": "Sonderrモデルプリセット",
  "settings.indexing.sonderrModel.description": "サポートされているSonderrホスト型埋め込みモデルを選択します。",
  "settings.indexing.sonderrSignIn.title": "Sonderrへのサインインが必要です",
  "settings.indexing.sonderrSignIn.description": "ホスト型埋め込みを使用するにはSonderrにサインインしてください。",
  ...
  "settings.models.hidePromptTraining.description":
    "プロバイダーがプロンプトを学習に使用する可能性のある Sonderr Gateway モデルを非表示にします。",
  ...
  "settings.config.title": "{{scope}}のSonderr構成ファイルを開く",
  "settings.config.placeholder":
    "構成ファイルは順番にマージされます。読み込み済みとしてマークされているファイルが現在設定に影響しています。",
  "settings.config.noWorkspace": "ローカルのSonderr構成ファイルを編集するには、ワークスペースフォルダーを開いてください。",
  "settings.config.openFailed": "{{scope}}のSonderr構成ファイルを開けませんでした: {{message}}",
  "settings.config.source.xdg": "XDGグローバル構成",
  "settings.config.source.homeSonderr": "Homeの.sonderr構成",
  "settings.config.source.homeSonderr": "Homeの.sonderr構成",
  "settings.config.source.homeSonderr": "Homeの.sonderr構成",
  "settings.config.source.envFile": "SONDERR_CONFIG環境ファイル",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "インライン環境構成",
  "settings.config.source.projectSonderr": "プロジェクトの.sonderr構成",
  "settings.config.source.projectRoot": "プロジェクトルート構成",
  "settings.config.source.projectSonderr": "旧.sonderr構成",
  "settings.config.source.projectSonderr": "旧.sonderr構成",
  ...
  "workStyle.onboarding.welcome": "Sonderrへようこそ",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderrは作業中に一時停止し、計画を表示します。",
  ...
  "session.cloud.import.placeholder": "セッションID、URL、またはsonderr importコマンド",
  ...
  "deviceAuth.title": "Sonderrにサインイン",
  ...
  "profile.action.login": "Sonderrでログイン",
  ...
  "profile.usage.routing": "プランの請求は有効です。Sonderr Gatewayのルーティングは{{state}}です。",
  ...
  "profile.pass.subscribe": "Sonderr Passに登録してクレジットを追加し、ボーナスを獲得",
  "profile.pass.bonus": "ボーナス",
  "profile.pass.usage": "今月の使用量",
  "profile.pass.paid": "有料分",
  "profile.pass.meter": "Sonderr Pass の月間使用量",
  ...
  "settings.aboutSonderr.title": "Sonderrについて",

  "session.messages.welcome":
    "SonderrはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutSonderr.status.connected": "接続済み",
  "settings.aboutSonderr.status.connecting": "接続中...",
  "settings.aboutSonderr.status.disconnected": "切断",
  "settings.aboutSonderr.status.error": "エラー",
  "settings.aboutSonderr.cliServer": "CLIサーバー",
  "settings.aboutSonderr.status.label": "ステータス：",
  "settings.aboutSonderr.port.label": "ポート：",
  "settings.aboutSonderr.versionInfo": "バージョン情報",
  "settings.aboutSonderr.version.label": "バージョン：",
  "settings.aboutSonderr.community": "コミュニティとサポート",
  "settings.aboutSonderr.feedback.prefix": "ご質問やフィードバックがありましたら、お気軽にissueを作成してください",
  "settings.aboutSonderr.feedback.or": "または",
  "settings.aboutSonderr.support.prefix":
    "請求やアカウントに関するご質問は、カスタマーサポートまでお問い合わせください",
  "settings.aboutSonderr.resetSettings.title": "設定をリセット",
  ...
  "settings.aboutSonderr.resetSettings.button": "すべての設定をリセット",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "設定の移行",
  "settings.aboutSonderr.settingsTransfer.description":
    "VS Code インスタンス間で設定を転送するには、エクスポートまたはインポートしてください。",
  "settings.aboutSonderr.exportSettings": "エクスポート",
  "settings.aboutSonderr.importSettings": "インポート",
  "settings.aboutSonderr.importSettings.invalidJson":
    "無効な JSON ファイルです。有効な設定ファイルを選択してください。",
  "settings.aboutSonderr.importSettings.invalidConfig": "ファイルに有効な Sonderr の設定が含まれていません。",
  "settings.aboutSonderr.importSettings.tooLarge": "ファイルが大きすぎます。設定ファイルは 1 MB 以下にしてください。",
  "settings.aboutSonderr.importSettings.newerVersion":
    "このファイルはより新しいバージョンの Sonderr からエクスポートされたものです。一部の設定が無視される場合があります。",
  "settings.aboutSonderr.importSettings.success":
    "設定をインポートしました。上記の変更内容を確認してから、保存をクリックしてください。",

  "settings.aboutSonderr.telemetry.title": "テレメトリ",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "テレメトリ設定を開く",
  ...
  "settings.language.description": "Sonderr UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.models.speechToText.disabledDescription":
    "Speech to Text を使用するには、Sonderr プロバイダーを有効にしてサインインしてください。現在、Speech to Text は Sonderr Gateway でのみサポートされています。",
  "settings.models.speechToTextModel.title": "音声認識モデル",
  "settings.models.speechToTextModel.description": "音声入力に使用するSonderr Gateway文字起こしモデルを選択します。",
  ...
  "settings.experimental.remote.description":
    "Sonderr Cloud 経由でのセッションの Remote コントロールを有効にします。これはこのマシンの CLI にも影響します。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code の設定ディレクトリから CLAUDE.md のインストラクションとスキルをセッションに読み込みます。Sonderr に Claude Code のインストラクションとスキルを使用させる場合は、これを有効にしてください。再起動が必要です。",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCPサーバーが設定されていません。sonderr.jsoncでMCPサーバーを追加するか、エージェントに追加を依頼してください。",
  "settings.agentBehaviour.workflows.description":
    "ワークフローは設定で定義されたカスタムスラッシュコマンドです。チャットで /command-name と入力して呼び出します。コマンドは sonderr.json の 'command' セクションで設定します。",
  "settings.agentBehaviour.workflows.empty":
    "カスタムコマンドが設定されていません。sonderr.json にコマンドを追加するとここに表示されます。",
  ...
  "settings.sandboxing.enabled.description":
    "エージェントのシェルコマンドを、プロジェクトおよびSonderrの状態ディレクトリへの書き込みを制限するOSレベルのサンドボックス内で実行",
  ...
  "settings.display.fontSize.description": "VS Code とは独立して Sonderr webview UI のフォントサイズを調整します。",
  ...
  "settings.aboutSonderr.legacyMigration.title": "レガシー移行",
  "settings.aboutSonderr.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたSonderrから設定を移行します。",
  "settings.aboutSonderr.rooImport.description": "インストールしたRoo Codeから会話履歴を移行します。",
  "settings.aboutSonderr.rooImport.button": "Roo Codeからセッションをインポート",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Sonderrの新機能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "すべてのSonderr製品で共有される小さく効率的なコア。どのような作業スタイルでも馴染みのある体験を提供します。",
  ...
  "diffViewer.source.session.tooltip":
    "現在のセッション中に Sonderr が変更したファイル。ターンごとのスナップショットに基づきます。新しいセッションを開始するとリセットされます。",
