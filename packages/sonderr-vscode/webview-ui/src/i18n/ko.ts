...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "이 컴퓨터에 Anaconda Desktop을 설치한 후 여기로 돌아오세요. Sonderr는 설치 프로그램을 대신 실행하지 않습니다.",
  ...
  "provider.anaconda.state.signedOut": "Sonderr를 연결하기 전에 Anaconda Desktop을 열고 로그인하세요.",
  "provider.anaconda.state.unauthorized":
    "Sonderr가 Anaconda Desktop에 접근할 수 없습니다. Desktop을 열고 다시 로그인한 후 필요하면 다시 시작하세요.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr가 정상적인 로컬 텍스트 생성 서버를 찾았으며 현재 연결 설정을 가져올 수 있습니다.",
  ...
  "provider.anaconda.toast.refreshed.description": "활성 로컬 서버와 모델이 Sonderr에서 최신 상태입니다.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Sonderr에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Sonderr에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Sonderr에서 {{provider}} 모델을 사용하세요.",
  ...
  "prompt.action.sandbox.enabled":
    "샌드박스가 활성화되어 있습니다. 에이전트 셸 명령은 프로젝트 및 Sonderr 디렉터리로 제한됩니다.",
  "prompt.action.sandbox.disabled":
    "샌드박스가 비활성화되어 있습니다. 클릭하여 에이전트 셸 명령 쓰기를 프로젝트 및 Sonderr 디렉터리로 제한합니다.",
  ...
  "prompt.action.sandbox.description.enabled": "쓰기는 프로젝트 및 Sonderr 디렉터리로 제한됩니다.",
  ...
  "speechToText.tooltip.start": "Sonderr Gateway로 음성 입력 시작",
  ...
  "speechToText.error.loginRequired": "음성 입력을 사용하려면 Sonderr에 로그인하세요.",
  ...
  "sidebar.topBar.label": "Sonderr 탐색",
  ...
  "settings.models.hidePromptTraining.description":
    "제공업체가 사용자의 프롬프트를 학습에 사용할 수 있는 Sonderr Gateway 모델을 숨깁니다.",
  ...
  "settings.config.title": "{{scope}} Sonderr 구성 파일 열기",
  "settings.config.placeholder":
    "구성 파일은 순서대로 병합됩니다. 로드됨으로 표시된 파일이 현재 설정에 영향을 미칩니다.",
  "settings.config.noWorkspace": "로컬 Sonderr 구성 파일을 편집하려면 작업 영역 폴더를 엽니다.",
  "settings.config.openFailed": "{{scope}} Sonderr 구성 파일을 열지 못했습니다: {{message}}",
  "settings.config.source.xdg": "XDG 글로벌 구성",
  "settings.config.source.homeSonderr": "Home .sonderr 구성",
  "settings.config.source.homeSonderr": "Home .sonderr 구성",
  "settings.config.source.homeSonderr": "Home .sonderr 구성",
  "settings.config.source.envFile": "SONDERR_CONFIG 환경 파일",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "인라인 환경 구성",
  "settings.config.source.projectSonderr": "프로젝트 .sonderr 구성",
  "settings.config.source.projectRoot": "프로젝트 루트 구성",
  "settings.config.source.projectSonderr": "레거시 .sonderr 구성",
  "settings.config.source.projectSonderr": "레거시 .sonderr 구성",
  ...
  "workStyle.onboarding.welcome": "Sonderr에 오신 것을 환영합니다",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr가 작업 중에 잠시 멈추고 계획을 보여줍니다.",
  ...
  "session.cloud.import.placeholder": "세션 ID, URL 또는 sonderr import 명령어",
  ...
  "profile.action.login": "Sonderr로 로그인",
  ...
  "profile.usage.routing": "요금제 결제가 활성화되어 있습니다. Sonderr Gateway 라우팅은 {{state}}입니다.",
  ...
  "profile.pass.subscribe": "Sonderr Pass를 구독하여 크레딧을 추가하고 보너스를 받으세요",
  "profile.pass.bonus": "보너스",
  "profile.pass.usage": "이번 달 사용량",
  "profile.pass.paid": "유료",
  "profile.pass.meter": "Sonderr Pass 월간 사용량",
  ...
  "settings.aboutSonderr.title": "Sonderr 정보",
  ...
  "settings.indexing.sonderrModel.title": "Sonderr 모델 프리셋",
  "settings.indexing.sonderrModel.description": "지원되는 Sonderr 호스팅 임베딩 모델을 선택하세요.",
  "settings.indexing.sonderrSignIn.title": "Sonderr 로그인이 필요합니다",
  "settings.indexing.sonderrSignIn.description": "호스팅 임베딩을 사용하려면 Sonderr에 로그인하세요.",
  ...
  "session.messages.welcome":
    "Sonderr는 AI 코딩 어시스턴트입니다. 기능 구축, 버그 수정 또는 코드베이스 설명을 요청하세요.",
  ...
  "settings.aboutSonderr.status.connected": "연결됨",
  "settings.aboutSonderr.status.connecting": "연결 중...",
  "settings.aboutSonderr.status.disconnected": "연결 끊김",
  "settings.aboutSonderr.status.error": "오류",
  "settings.aboutSonderr.cliServer": "CLI 서버",
  "settings.aboutSonderr.status.label": "상태:",
  "settings.aboutSonderr.port.label": "포트:",
  "settings.aboutSonderr.versionInfo": "버전 정보",
  "settings.aboutSonderr.version.label": "버전:",
  "settings.aboutSonderr.community": "커뮤니티 및 지원",
  "settings.aboutSonderr.feedback.prefix": "질문이나 피드백이 있으시면 다음에서 이슈를 열어주세요",
  "settings.aboutSonderr.feedback.or": "또는",
  "settings.aboutSonderr.support.prefix": "결제 또는 계정 관련 문의는 고객 지원팀에 문의하세요",
  "settings.aboutSonderr.resetSettings.title": "설정 초기화",
  ...
  "settings.aboutSonderr.resetSettings.button": "모든 설정 초기화",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "설정 이전",
  "settings.aboutSonderr.settingsTransfer.description":
    "VS Code 인스턴스 간에 설정을 전송하려면 내보내기 또는 가져오기하세요.",
  "settings.aboutSonderr.exportSettings": "내보내기",
  "settings.aboutSonderr.importSettings": "가져오기",
  "settings.aboutSonderr.importSettings.invalidJson":
    "유효하지 않은 JSON 파일입니다. 올바른 설정 파일을 선택해 주세요.",
  "settings.aboutSonderr.importSettings.invalidConfig": "파일에 유효한 Sonderr 설정이 포함되어 있지 않습니다.",
  "settings.aboutSonderr.importSettings.tooLarge": "파일이 너무 큽니다. 설정 파일은 1 MB 이하여야 합니다.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "이 파일은 더 최신 버전의 Sonderr에서 내보낸 것입니다. 일부 설정이 무시될 수 있습니다.",
  "settings.aboutSonderr.importSettings.success": "설정을 가져왔습니다. 위의 변경 사항을 확인한 후 저장을 클릭하세요.",

  "settings.aboutSonderr.telemetry.title": "원격 측정",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "원격 측정 설정 열기",
  ...
  "settings.language.description": 'Sonderr UI의 언어를 선택하세요. "자동"은 VS Code 표시 언어를 사용합니다.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Speech to Text를 사용하려면 Sonderr 제공자를 활성화하고 로그인하세요. 현재 Speech to Text는 Sonderr Gateway에서만 지원됩니다.",
  "settings.models.speechToTextModel.title": "음성 텍스트 변환 모델",
  "settings.models.speechToTextModel.description": "음성 입력에 사용할 Sonderr Gateway 변환 모델을 선택하세요.",
  ...
  "settings.experimental.remote.description":
    "Sonderr Cloud를 통한 세션의 Remote 제어를 활성화합니다. 이는 이 컴퓨터의 CLI에도 영향을 미칩니다.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code 설정 디렉터리에서 세션으로 CLAUDE.md 지침 및 스킬을 로드합니다. Sonderr가 Claude Code 지침 및 스킬을 사용하게 하려면 활성화하세요. 다시 시작해야 합니다.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP 서버가 구성되지 않았습니다. sonderr.jsonc에서 MCP 서버를 추가하거나 에이전트에게 추가를 요청하세요.",
  "settings.agentBehaviour.workflows.description":
    "워크플로우는 구성에서 정의된 사용자 정의 슬래시 명령입니다. 채팅에서 /command-name을 입력하여 실행합니다. 명령은 sonderr.json의 'command' 섹션에서 구성됩니다.",
  "settings.agentBehaviour.workflows.empty":
    "구성된 사용자 정의 명령이 없습니다. sonderr.json에 명령을 추가하면 여기에 표시됩니다.",
  ...
  "settings.sandboxing.enabled.description":
    "에이전트 셸 명령을 프로젝트 및 Sonderr 상태 디렉터리에 대한 쓰기를 제한하는 OS 수준의 샌드박스 내에서 실행",
  ...
  "settings.display.fontSize.description": "VS Code와 독립적으로 Sonderr webview UI 글꼴 크기를 조정합니다.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "레거시 마이그레이션",
  "settings.aboutSonderr.legacyMigration.description":
    "공급자 API 키 및 기본 모델을 포함하여 이전 Sonderr 설치에서 설정을 마이그레이션합니다.",
  "settings.aboutSonderr.rooImport.description": "Roo Code 설치에서 대화 기록을 가져옵니다.",
  "settings.aboutSonderr.rooImport.button": "Roo Code에서 세션 가져오기",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Sonderr의 새로운 기능",
  ...
  "migration.whatsNew.features.foundation.detail":
    "모든 Sonderr 제품에 걸쳐 하나의 작고 효율적인 코어. 어떤 방식으로 작업하든 익숙한 경험을 제공합니다.",
  ...
  "diffViewer.source.session.tooltip":
    "현재 세션 동안 Sonderr가 변경한 파일로, 턴별 스냅샷을 기반으로 합니다. 새 세션을 시작하면 초기화됩니다.",
