...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Anaconda Desktop'ı bu makineye kurun, ardından buraya dönün. Sonderr kurulumu sizin için çalıştırmaz.",
  ...
  "provider.anaconda.state.signedOut": "Sonderr'yu bağlamadan önce Anaconda Desktop'ı açın ve oturum açın.",
  "provider.anaconda.state.unauthorized":
    "Sonderr Anaconda Desktop'a erişemedi. Desktop'ı açın, tekrar oturum açın ve gerekirse yeniden başlatın.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr sağlıklı bir yerel metin üretme sunucusu buldu ve mevcut bağlantı ayarlarını içe aktarabilir.",
  ...
  "provider.anaconda.toast.refreshed.description": "Etkin yerel sunucu ve modeller Sonderr'da güncel.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Sonderr'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix": "Hesabınızı bağlamak ve Sonderr'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Sonderr'da {{provider}} modellerini kullanın.",
  ...
  "prompt.action.sandbox.enabled": "Sandbox etkin. Agent shell komutları proje ve Sonderr dizinleriyle sınırlıdır.",
  "prompt.action.sandbox.disabled":
    "Sandbox devre dışı. Agent shell komut yazma işlemlerini proje ve Sonderr dizinleriyle sınırlamak için tıklayın.",
  ...
  "prompt.action.sandbox.description.enabled": "Yazma işlemleri proje ve Sonderr dizinleriyle sınırlıdır.",
  ...
  "speechToText.tooltip.start": "Sonderr Gateway ile sesli girişi başlatın",
  ...
  "speechToText.error.loginRequired": "Sesli girişi kullanmak için Sonderr'ya giriş yapın.",
  ...
  "sidebar.topBar.label": "Sonderr Gezinme",
  ...
  "settings.config.title": "{{scope}} Sonderr yapılandırma dosyasını aç",
  "settings.config.placeholder":
    "Yapılandırma dosyaları sırayla birleştirilir; yüklendi olarak işaretlenen dosyalar şu anda ayarları etkiler.",
  "settings.config.noWorkspace": "Yerel Sonderr yapılandırma dosyasını düzenlemek için bir çalışma alanı klasörü açın.",
  "settings.config.openFailed": "{{scope}} Sonderr yapılandırma dosyası açılamadı: {{message}}",
  "settings.config.source.xdg": "XDG küresel yapılandırma",
  "settings.config.source.homeSonderr": "Home .sonderr yapılandırması",
  "settings.config.source.homeSonderr": "Home .sonderr yapılandırması",
  "settings.config.source.homeSonderr": "Home .sonderr yapılandırması",
  "settings.config.source.envFile": "SONDERR_CONFIG ortam dosyası",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Satır içi ortam yapılandırması",
  "settings.config.source.projectSonderr": "Proje .sonderr yapılandırması",
  "settings.config.source.projectRoot": "Proje kök yapılandırması",
  "settings.config.source.projectSonderr": "Eski .sonderr yapılandırması",
  "settings.config.source.projectSonderr": "Eski .sonderr yapılandırması",
  ...
  "workStyle.onboarding.welcome": "Sonderr'ya hoş geldiniz",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr çalışırken duraklar ve planını size gösterir.",
  ...
  "session.cloud.import.placeholder": "Oturum kimliği, URL veya sonderr import komutu",
  ...
  "deviceAuth.title": "Sonderr'a giriş yap",
  ...
  "profile.action.login": "Sonderr ile giriş yap",
  ...
  "profile.usage.routing": "Plan faturalandırması etkin. Sonderr Gateway yönlendirmesi {{state}}.",
  ...
  "profile.pass.subscribe": "Kredi eklemek ve bonus kazanmak için Sonderr Pass edinin",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "Bu ayki kullanım",
  "profile.pass.paid": "Ücretli",
  "profile.pass.meter": "Aylık Sonderr Pass kullanımı",
  ...
  "settings.aboutSonderr.title": "Sonderr Hakkında",

  "session.messages.welcome":
    "Sonderr bir yapay zeka kodlama asistanıdır. Özellik geliştirmesini, hata düzeltmesini veya kod tabanınızı açıklamasını isteyin.",
  ...
  "settings.aboutSonderr.status.connected": "Bağlı",
  "settings.aboutSonderr.status.connecting": "Bağlanıyor...",
  "settings.aboutSonderr.status.disconnected": "Bağlantı Kesildi",
  "settings.aboutSonderr.status.error": "Hata",
  "settings.aboutSonderr.cliServer": "CLI Sunucusu",
  "settings.aboutSonderr.status.label": "Durum:",
  "settings.aboutSonderr.port.label": "Port:",
  "settings.aboutSonderr.versionInfo": "Sürüm Bilgisi",
  "settings.aboutSonderr.version.label": "Sürüm:",
  "settings.aboutSonderr.community": "Topluluk ve Destek",
  "settings.aboutSonderr.feedback.prefix":
    "Herhangi bir sorunuz veya geri bildiriminiz varsa, lütfen şu adreste bir sorun açın:",
  "settings.aboutSonderr.feedback.or": "veya",
  "settings.aboutSonderr.support.prefix": "Faturalama veya hesap soruları için Müşteri Desteği ile iletişime geçin:",
  "settings.aboutSonderr.resetSettings.title": "Ayarları Sıfırla",
  ...
  "settings.aboutSonderr.resetSettings.button": "Tüm Ayarları Sıfırla",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Ayar Aktarımı",
  ...
  "settings.aboutSonderr.exportSettings": "Dışa Aktar",
  "settings.aboutSonderr.importSettings": "İçe Aktar",
  "settings.aboutSonderr.importSettings.invalidJson": "Geçersiz JSON dosyası. Lütfen geçerli bir ayar dosyası seçin.",
  "settings.aboutSonderr.importSettings.invalidConfig": "Dosya geçerli Sonderr ayarları içermiyor.",
  "settings.aboutSonderr.importSettings.tooLarge": "Dosya çok büyük. Ayar dosyaları 1 MB altında olmalıdır.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "Bu dosya Sonderr'nun daha yeni bir sürümünden dışa aktarılmış. Bazı ayarlar göz ardı edilebilir.",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Telemetri Ayarlarını Aç",
  ...
  "settings.language.description":
    '"Otomatik" VS Code görüntüleme dilinizi kullanır. Sonderr arayüzü için dil seçin.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Speech to Text kullanmak için Sonderr sağlayıcısını etkinleştirin ve giriş yapın. Speech to Text şu anda yalnızca Sonderr Gateway ile desteklenmektedir.",
  "settings.models.speechToTextModel.title": "Sesten metne modeli",
  "settings.models.speechToTextModel.description": "Sesli giriş için Sonderr Gateway transkripsiyon modelini seçin.",
  ...
  "settings.experimental.remote.description":
    "Sonderr Cloud üzerinden oturumların Remote kontrolünü etkinleştirin. Bu, bu makinedeki CLI'leri de etkileyecektir.",
  ...
  "settings.sandboxing.enabled.description":
    "Agent shell komutlarını, proje ve Sonderr durum dizinlerine yazmaları kısıtlanan işletim sistemi düzeyinde bir sandbox içinde çalıştırın",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code yapılandırma dizininizdeki CLAUDE.md talimatlarını ve becerilerini oturumlara yükleyin. Sonderr'nun Claude Code talimatlarınızı ve becerilerinizi kullanmasını istiyorsanız bunu etkinleştirin. Yeniden başlatma gerektirir.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Yapılandırılmış MCP sunucusu yok. sonderr.jsonc dosyasına MCP sunucuları ekleyin veya ajanın eklemesini isteyin.",
  "settings.agentBehaviour.workflows.description":
    "İş akışları, yapılandırmanızda tanımlanan özel eğik çizgi komutlarıdır. Çağırmak için sohbette /command-name yazın. Komutlar sonderr.json dosyasındaki 'command' bölümünde yapılandırılır.",
  "settings.agentBehaviour.workflows.empty":
    "Yapılandırılmış özel komut yok. Burada görmek için sonderr.json dosyasına komutlar ekleyin.",
  ...
  "settings.display.fontSize.description": "Sonderr webview UI yazı tipi boyutunu VS Code'dan bağımsız olarak ayarlayın.",
  ...
  "settings.models.hidePromptTraining.description":
    "Sağlayıcıları istemlerinizi eğitim için kullanabilecek Sonderr Gateway modellerini gizleyin.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Eski Sürüm Taşıma",
  "settings.aboutSonderr.legacyMigration.description":
    "Sağlayıcı API anahtarları ve varsayılan model dahil olmak üzere Sonderr'un önceki yüklemesinden ayarları taşıyın.",
  "settings.aboutSonderr.rooImport.description": "Bir Roo Code yüklemesinden konuşma geçmişini içe aktarın.",
  "settings.aboutSonderr.rooImport.button": "Roo Code'dan Oturumları İçe Aktar",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Sonderr'daki Yenilikler",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Her Sonderr ürününde küçük ve verimli bir çekirdek. Nasıl çalışmayı tercih ederseniz edin, tanıdık bir deneyim.",
  ...
  "settings.indexing.sonderrModel.title": "Sonderr model önayarı",
  "settings.indexing.sonderrModel.description": "Desteklenen bir Sonderr-hosted embeddings modeli seçin.",
  "settings.indexing.sonderrSignIn.title": "Sonderr oturumu açmak gerekiyor",
  "settings.indexing.sonderrSignIn.description": "Hosted embeddings kullanmak için Sonderr'da oturum açın.",
  ...
  "diffViewer.source.session.tooltip":
    "Geçerli oturum sırasında Sonderr tarafından değiştirilen dosyalar, tur başı anlık görüntülere dayanır. Yeni bir oturum başlatıldığında sıfırlanır.",
