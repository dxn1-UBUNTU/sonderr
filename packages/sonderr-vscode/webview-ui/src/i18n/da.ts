...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installer Anaconda Desktop på denne maskine, og vend derefter tilbage hertil. Sonderr kører ikke installationsprogrammet for dig.",
  ...
  "provider.anaconda.state.signedOut": "Åbn Anaconda Desktop og log ind, før du forbinder Sonderr.",
  "provider.anaconda.state.unauthorized":
    "Sonderr kunne ikke få adgang til Anaconda Desktop. Åbn Desktop, log ind igen, og genstart den om nødvendigt.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr fandt en sund lokal tekstgenereringsserver og kan importere dens aktuelle forbindelsesindstillinger.",
  ...
  "provider.anaconda.toast.refreshed.description": "Den aktive lokale server og modeller er opdaterede i Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Sonderr.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox er aktiveret. Shell-kommandoer for agenten er begrænset til projekt- og Sonderr-mapperne.",
  "prompt.action.sandbox.disabled":
    "Sandbox er deaktiveret. Klik for at begrænse skrivning af shell-kommandoer for agenten til projekt- og Sonderr-mapperne.",
  ...
  "prompt.action.sandbox.description.enabled": "Skrivning er begrænset til projekt- og Sonderr-mapperne.",
  ...
  "speechToText.tooltip.start": "Start stemmeinput med Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Log ind på Sonderr for at bruge stemmeinput.",
  ...
  "settings.indexing.sonderrModel.title": "Sonderr-modelpreset",
  "settings.indexing.sonderrModel.description": "Vælg en understøttet Sonderr-hostet embedding-model.",
  "settings.indexing.sonderrSignIn.title": "Sonderr-login kræves",
  "settings.indexing.sonderrSignIn.description": "Log ind på Sonderr for at bruge hostede embeddings.",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul Sonderr Gateway-modeller, hvis udbydere muligvis bruger dine prompts til træning.",
  ...
  "settings.config.title": "Åbn {{scope}} Sonderr konfigurationsfil",
  "settings.config.placeholder":
    "Konfigurationsfiler flettes i rækkefølge; filer markeret som indlæst påvirker i øjeblikket indstillingerne.",
  "settings.config.noWorkspace": "Åbn en arbejdsområdemappe for at redigere den lokale Sonderr konfigurationsfil.",
  "settings.config.openFailed": "Kunne ikke åbne {{scope}} Sonderr konfigurationsfil: {{message}}",
  ...
  "settings.config.source.projectSonderr": "Forældet .sonderr konfiguration",
  "settings.config.source.projectSonderr": "Forældet .sonderr konfiguration",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr holder pause og viser dig sin plan undervejs.",
  ...
  "session.cloud.import.placeholder": "Sessions-ID, URL eller sonderr import-kommando",
  ...
  "deviceAuth.title": "Log ind på Sonderr",
  ...
  "profile.action.login": "Log ind med Sonderr",
  ...
  "profile.usage.routing": "Abonnementsfakturering er aktiv. Sonderr Gateway-routing er {{state}}.",
  ...
  "profile.pass.subscribe": "Få Sonderr Pass for at tilføje kredit og optjene bonusser",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "Denne måneds forbrug",
  "profile.pass.paid": "Betalt",
  "profile.pass.meter": "Månedligt Sonderr Pass-forbrug",
  ...
  "session.messages.welcome":
    "Sonderr er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutSonderr.status.connected": "Forbundet",
  "settings.aboutSonderr.status.connecting": "Forbinder...",
  "settings.aboutSonderr.status.disconnected": "Afbrudt",
  "settings.aboutSonderr.status.error": "Fejl",
  "settings.aboutSonderr.cliServer": "CLI-server",
  "settings.aboutSonderr.status.label": "Status:",
  "settings.aboutSonderr.port.label": "Port:",
  "settings.aboutSonderr.versionInfo": "Versionsinformation",
  "settings.aboutSonderr.version.label": "Version:",
  "settings.aboutSonderr.community": "Fællesskab og support",
  ...
  "settings.aboutSonderr.support.prefix": "For fakturerings- eller kontospørgsmål, kontakt kundesupport på",
  "settings.aboutSonderr.resetSettings.title": "Nulstil indstillinger",
  ...
  "settings.aboutSonderr.resetSettings.button": "Nulstil alle indstillinger",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Overførsel af indstillinger",
  ...
  "settings.aboutSonderr.exportSettings": "Eksportér",
  "settings.aboutSonderr.importSettings": "Importér",
  "settings.aboutSonderr.importSettings.invalidJson": "Ugyldig JSON-fil. Vælg venligst en gyldig indstillingsfil.",
  "settings.aboutSonderr.importSettings.invalidConfig": "Filen indeholder ikke gyldige Sonderr-indstillinger.",
  "settings.aboutSonderr.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "Denne fil blev eksporteret fra en nyere version af Sonderr. Nogle indstillinger kan blive ignoreret.",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Åbn telemetriindstillinger",
  ...
  "settings.language.description": 'Vælg sproget til Sonderr-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Aktivér og log ind på Sonderr-udbyderen for at bruge Speech to Text. Speech to Text understøttes i øjeblikket kun med Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Model til tale til tekst",
  "settings.models.speechToTextModel.description": "Vælg Sonderr Gateway-transskriptionsmodellen til stemmeinput.",
  ...
  "settings.experimental.remote.description":
    "Aktivér Remote-styring af sessioner via Sonderr Cloud. Dette vil også påvirke CLI'er på denne maskine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Indlæs CLAUDE.md-instruktioner og -færdigheder fra din Claude Code-konfigurationsmappe i sessioner. Aktivér dette, hvis du vil have Sonderr til at bruge dine Claude Code-instruktioner og -færdigheder. Kræver genstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigureret. Tilføj MCP-servere i sonderr.jsonc, eller bed agenten om at tilføje dem.",
  "settings.agentBehaviour.workflows.description":
    "Workflows er brugerdefinerede slash-kommandoer defineret i din konfiguration. Skriv /command-name i chatten for at aktivere dem. Kommandoer konfigureres i sonderr.json under sektionen 'command'.",
  "settings.agentBehaviour.workflows.empty":
    "Ingen brugerdefinerede kommandoer konfigureret. Tilføj kommandoer til sonderr.json for at se dem her.",
  ...
  "settings.sandboxing.enabled.description":
    "Kør shell-kommandoer for agenten i en sandbox på operativsystemniveau, der begrænser skrivning til projekt- og Sonderr-tilstandsmapperne",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Sonderr webview UI uafhængigt af VS Code.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Legacy-migrering",
  "settings.aboutSonderr.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af Sonderr, herunder udbyder API-nøgler og standardmodel.",
  "settings.aboutSonderr.rooImport.description": "Importer samtalehistorik fra en installation af Roo Code.",
  "settings.aboutSonderr.rooImport.button": "Importer sessioner fra Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én lille, effektiv kerne på tværs af alle Sonderr-produkter. En velkendt oplevelse uanset hvordan du vælger at arbejde.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer ændret af Sonderr i den aktuelle session, baseret på snapshots pr. tur. Nulstilles, når du starter en ny session.",
