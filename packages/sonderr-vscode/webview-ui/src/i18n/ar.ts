...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "ثبّت Anaconda Desktop على هذا الجهاز، ثم عُد إلى هنا. لا يقوم Sonderr بتشغيل المثبّت نيابةً عنك.",
  ...
  "provider.anaconda.state.signedOut": "افتح Anaconda Desktop وسجّل الدخول قبل توصيل Sonderr.",
  "provider.anaconda.state.unauthorized":
    "تعذّر على Sonderr الوصول إلى Anaconda Desktop. افتح Desktop، وسجّل الدخول مرة أخرى، وأعد تشغيله إذا لزم الأمر.",
  ...
  "provider.anaconda.state.ready":
    "عثر Sonderr على خادم محلي سليم لتوليد النصوص ويمكنه استيراد إعدادات الاتصال الحالية الخاصة به.",
  ...
  "provider.anaconda.toast.refreshed.description": "الخادم المحلي النشط والنماذج محدّثة في Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Sonderr.",
  ...
  "prompt.action.sandbox.enabled": "sandbox مُفعّل. أوامر shell الخاصة بالوكيل مقتصرة على مجلدات المشروع و Sonderr.",
  "prompt.action.sandbox.disabled":
    "sandbox مُعطّل. انقر لتقييد كتابة أوامر shell الخاصة بالوكيل على مجلدات المشروع و Sonderr.",
  ...
  "prompt.action.sandbox.description.enabled": "تقتصر عمليات الكتابة على مجلدات المشروع و Sonderr.",
  ...
  "speechToText.tooltip.start": "بدء الإدخال الصوتي باستخدام Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "قم بتسجيل الدخول إلى Sonderr لاستخدام الإدخال الصوتي.",
  ...
  "sidebar.topBar.label": "التنقل في Sonderr",
  ...
  "settings.models.hidePromptTraining.description":
    "إخفاء نماذج Sonderr Gateway التي قد يستخدم مزودوها مطالباتك لأغراض التدريب.",
  ...
  "settings.config.title": "فتح ملف تكوين Sonderr {{scope}}",
  "settings.config.placeholder": "يتم دمج ملفات التكوين بالترتيب؛ الملفات المحددة كمحملة تؤثر حاليًا على الإعدادات.",
  "settings.config.noWorkspace": "افتح مجلد مساحة عمل لتحرير ملف تكوين Sonderr المحلي.",
  "settings.config.openFailed": "فشل فتح ملف تكوين Sonderr {{scope}}: {{message}}",
  "settings.config.source.xdg": "تكوين XDG العالمي",
  "settings.config.source.homeSonderr": "تكوين .sonderr في Home",
  "settings.config.source.homeSonderr": "تكوين .sonderr في Home",
  "settings.config.source.homeSonderr": "تكوين .sonderr في Home",
  "settings.config.source.envFile": "ملف بيئة SONDERR_CONFIG",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "تكوين البيئة المضمن",
  "settings.config.source.projectSonderr": "تكوين .sonderr للمشروع",
  "settings.config.source.projectRoot": "تكوين جذر المشروع",
  "settings.config.source.projectSonderr": "تكوين .sonderr القديم",
  "settings.config.source.projectSonderr": "تكوين .sonderr القديم",
  ...
  "workStyle.onboarding.welcome": "مرحبًا بك في Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "يتوقف Sonderr مؤقتًا ويعرض لك خطته أثناء العمل.",
  ...
  "session.cloud.import.placeholder": "معرّف الجلسة أو الرابط أو أمر sonderr import",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى Sonderr",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام Sonderr",
  ...
  "profile.usage.routing": "فوترة الخطة مفعّلة. توجيه Sonderr Gateway {{state}}.",
  ...
  "profile.pass.subscribe": "احصل على Sonderr Pass لإضافة رصيد وكسب مكافآت",
  "profile.pass.bonus": "مكافأة",
  "profile.pass.usage": "استخدام هذا الشهر",
  "profile.pass.paid": "مدفوع",
  "profile.pass.meter": "استخدام Sonderr Pass الشهري",
  ...
  "settings.indexing.sonderrModel.title": "إعداد مسبق لنموذج Sonderr",
  "settings.indexing.sonderrModel.description": "اختر نموذج تضمين مدعومًا ومستضافًا بواسطة Sonderr.",
  "settings.indexing.sonderrSignIn.title": "تسجيل الدخول إلى Sonderr مطلوب",
  "settings.indexing.sonderrSignIn.description": "سجّل الدخول إلى Sonderr لاستخدام التضمينات المستضافة.",
  ...
  "settings.aboutSonderr.title": "حول Sonderr",

  "session.messages.welcome":
    "Sonderr هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutSonderr.status.connecting": "جارٍ الاتصال...",
  "settings.aboutSonderr.status.disconnected": "غير متصل",
  "settings.aboutSonderr.status.error": "خطأ",
  "settings.aboutSonderr.cliServer": "خادم CLI",
  "settings.aboutSonderr.status.label": "الحالة:",
  "settings.aboutSonderr.port.label": "المنفذ:",
  "settings.aboutSonderr.versionInfo": "معلومات الإصدار",
  "settings.aboutSonderr.version.label": "الإصدار:",
  "settings.aboutSonderr.community": "المجتمع والدعم",
  "settings.aboutSonderr.feedback.prefix": "إذا كان لديك أي أسئلة أو ملاحظات، لا تتردد في فتح مشكلة على",
  "settings.aboutSonderr.feedback.or": "أو",
  "settings.aboutSonderr.support.prefix": "لأسئلة الفوترة أو الحساب، تواصل مع دعم العملاء على",
  "settings.aboutSonderr.resetSettings.title": "إعادة تعيين الإعدادات",
  ...
  "settings.aboutSonderr.resetSettings.button": "إعادة تعيين جميع الإعدادات",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "نقل الإعدادات",
  "settings.aboutSonderr.settingsTransfer.description": "تصدير أو استيراد إعداداتك لنقلها بين نُسخ VS Code.",
  "settings.aboutSonderr.exportSettings": "تصدير",
  "settings.aboutSonderr.importSettings": "استيراد",
  "settings.aboutSonderr.importSettings.invalidJson": "ملف JSON غير صالح. يرجى اختيار ملف إعدادات صالح.",
  "settings.aboutSonderr.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات Sonderr صالحة.",
  "settings.aboutSonderr.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من Sonderr. قد يتم تجاهل بعض الإعدادات.",
  "settings.aboutSonderr.importSettings.success": "تم استيراد الإعدادات. راجع التغييرات أعلاه، ثم انقر على حفظ.",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "فتح إعدادات Telemetry",
  ...
  "settings.language.description": 'اختر اللغة لواجهة Sonderr. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.models.speechToText.disabledDescription":
    "قم بتمكين وتسجيل الدخول إلى مزود Sonderr لاستخدام Speech to Text. ميزة Speech to Text مدعومة حاليًا فقط مع Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "نموذج تحويل الصوت إلى نص",
  "settings.models.speechToTextModel.description": "اختر نموذج نسخ Sonderr Gateway للإدخال الصوتي.",
  ...
  "settings.experimental.remote.description":
    "قم بتمكين التحكم Remote في الجلسات عبر Sonderr Cloud. سيؤثر هذا أيضًا على واجهات سطر الأوامر (CLIs) على هذا الجهاز.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "تحميل تعليمات ومهارات CLAUDE.md من مجلد إعدادات Claude Code إلى الجلسات. قم بتمكين هذا الخيار إذا كنت ترغب في أن يستخدم Sonderr مهارات وتعليمات Claude Code الخاصة بك. يتطلب إعادة التشغيل.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "لم يتم تهيئة خوادم MCP. أضف خوادم MCP في sonderr.jsonc، أو اطلب من الوكيل إضافتها لك.",
  "settings.agentBehaviour.workflows.description":
    "سير العمل هي أوامر شرطة مائلة مخصصة محددة في التهيئة الخاصة بك. اكتب /command-name في الدردشة لتشغيلها. يتم تهيئة الأوامر في sonderr.json ضمن قسم 'command'.",
  "settings.agentBehaviour.workflows.empty": "لم يتم تهيئة أوامر مخصصة. أضف أوامر إلى sonderr.json لرؤيتها هنا.",
  ...
  "settings.sandboxing.enabled.description":
    "تشغيل أوامر shell الخاصة بالوكيل داخل sandbox على مستوى نظام التشغيل يقيّد الكتابة على مجلدات حالة المشروع و Sonderr",
  ...
  "settings.display.fontSize.description": "اضبط حجم خط webview UI الخاص بـ Sonderr بشكل مستقل عن VS Code.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "ترحيل الإصدار القديم",
  "settings.aboutSonderr.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ Sonderr، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",
  "settings.aboutSonderr.rooImport.description": "استيراد سجل المحادثات من تثبيت Roo Code.",
  "settings.aboutSonderr.rooImport.button": "استيراد الجلسات من Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "نواة صغيرة وفعالة واحدة عبر كل منتجات Sonderr. تجربة مألوفة بغض النظر عن طريقة عملك.",
  ...
  "diffViewer.source.session.tooltip":
    "الملفات التي غيّرها Sonderr خلال الجلسة الحالية، بناءً على لقطات لكل دور. يُعاد ضبطها عند بدء جلسة جديدة.",
