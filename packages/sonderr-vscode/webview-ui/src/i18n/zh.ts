...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "请在此设备上安装 Anaconda Desktop，然后返回此处。Sonderr 不会为你运行安装程序。",
  ...
  "provider.anaconda.state.signedOut": "请打开 Anaconda Desktop 并登录，然后再连接 Sonderr。",
  "provider.anaconda.state.unauthorized":
    "Sonderr 无法访问 Anaconda Desktop。请打开 Desktop，重新登录，并在需要时重新启动它。",
  ...
  "provider.anaconda.state.ready": "Sonderr 找到了一个健康的本地文本生成服务器，可以导入其当前的连接设置。",
  ...
  "provider.anaconda.toast.refreshed.description": "当前本地服务器和模型在 Sonderr 中已是最新。",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Sonderr 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Sonderr 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Sonderr 中使用 {{provider}} 模型。",
  ...
  "prompt.action.sandbox.enabled": "沙盒已启用。代理 shell 命令被限制在项目和 Sonderr 目录内。",
  "prompt.action.sandbox.disabled": "沙盒已禁用。点击以将代理 shell 命令的写入限制在项目和 Sonderr 目录内。",
  ...
  "prompt.action.sandbox.description.enabled": "写入仅限项目和 Sonderr 目录。",
  "prompt.action.sandbox.description.disabled": "点击以限制文件系统写入和网络访问。",
  "prompt.action.sandbox.description.disabledNetworkAllowed":
    "点击以限制文件系统写入。根据你的沙盒设置，网络访问仍然允许。",

  "speechToText.tooltip.start": "使用 Sonderr Gateway 开始语音输入",
  ...
  "speechToText.error.loginRequired": "登录 Sonderr 以使用语音输入。",
  ...
  "sidebar.topBar.label": "Sonderr 导航",
  ...
  "settings.indexing.sonderrModel.title": "Sonderr 模型预设",
  "settings.indexing.sonderrModel.description": "选择受支持的 Sonderr 托管嵌入模型。",
  "settings.indexing.sonderrSignIn.title": "需要登录 Sonderr",
  "settings.indexing.sonderrSignIn.description": "登录 Sonderr 以使用托管嵌入。",
  ...
  "settings.models.hidePromptTraining.description": "隐藏提供商可能会使用您的提示词进行训练的 Sonderr Gateway 模型。",
  ...
  "settings.config.title": "打开 {{scope}} Sonderr 配置文件",
  "settings.config.placeholder": "配置文件按顺序合并；标记为已加载的文件目前会影响设置。",
  "settings.config.noWorkspace": "打开工作区文件夹以编辑本地 Sonderr 配置文件。",
  "settings.config.openFailed": "无法打开 {{scope}} Sonderr 配置文件：{{message}}",
  "settings.config.source.xdg": "XDG 全局配置",
  "settings.config.source.homeSonderr": "主目录 .sonderr 配置",
  "settings.config.source.homeSonderr": "主目录 .sonderr 配置",
  "settings.config.source.homeSonderr": "主目录 .sonderr 配置",
  "settings.config.source.envFile": "SONDERR_CONFIG 环境变量文件",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "内联环境配置",
  "settings.config.source.projectSonderr": "项目 .sonderr 配置",
  "settings.config.source.projectRoot": "项目根目录配置",
  "settings.config.source.projectSonderr": "旧版 .sonderr 配置",
  "settings.config.source.projectSonderr": "旧版 .sonderr 配置",
  ...
  "workStyle.onboarding.welcome": "欢迎使用 Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr 会在工作过程中暂停并向你展示其计划。",
  ...
  "session.cloud.import.placeholder": "会话 ID、URL 或 sonderr import 命令",
  ...
  "profile.action.login": "使用 Sonderr 登录",
  ...
  "profile.usage.routing": "套餐账单处于有效状态。Sonderr Gateway 路由状态为 {{state}}。",
  ...
  "profile.pass.subscribe": "订阅 Sonderr Pass 以添加额度并赚取奖励",
  ...
  "settings.aboutSonderr.title": "关于 Sonderr",

  "session.messages.welcome": "Sonderr 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutSonderr.status.connected": "已连接",
  "settings.aboutSonderr.status.connecting": "连接中...",
  "settings.aboutSonderr.status.disconnected": "已断开",
  "settings.aboutSonderr.status.error": "错误",
  "settings.aboutSonderr.cliServer": "CLI 服务器",
  "settings.aboutSonderr.status.label": "状态：",
  "settings.aboutSonderr.port.label": "端口：",
  "settings.aboutSonderr.versionInfo": "版本信息",
  "settings.aboutSonderr.version.label": "版本：",
  "settings.aboutSonderr.community": "社区与支持",
  "settings.aboutSonderr.feedback.prefix": "如果您有任何问题或反馈，欢迎在以下平台提交 issue",
  "settings.aboutSonderr.feedback.or": "或",
  "settings.aboutSonderr.support.prefix": "如有账单或账户问题，请联系客户支持",
  "settings.aboutSonderr.resetSettings.title": "重置设置",
  "settings.aboutSonderr.resetSettings.description":
    "此操作仅将 VS Code 扩展专属设置重置为默认值。与 CLI 共享的设置（如模式和自动审批规则）存储在 CLI 配置中，不会被重置。",
  "settings.aboutSonderr.resetSettings.button": "重置所有设置",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "设置迁移",
  "settings.aboutSonderr.settingsTransfer.description": "导出或导入设置，以便在 VS Code 实例之间传输。",
  "settings.aboutSonderr.exportSettings": "导出",
  "settings.aboutSonderr.importSettings": "导入",
  "settings.aboutSonderr.importSettings.invalidJson": "无效的 JSON 文件。请选择有效的设置文件。",
  "settings.aboutSonderr.importSettings.invalidConfig": "文件不包含有效的 Sonderr 设置。",
  "settings.aboutSonderr.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutSonderr.importSettings.newerVersion": "此文件由较新版本的 Sonderr 导出。部分设置可能会被忽略。",
  "settings.aboutSonderr.importSettings.success": "设置已导入。请查看上方的更改，然后点击保存。",

  "settings.aboutSonderr.telemetry.title": "遥测",
  "settings.aboutSonderr.telemetry.description":
    '遥测由 VS Code 的内置遥测设置控制。若要将其禁用，请转到「设置」>「遥测」>「遥测级别」并将其设置为 "off"。重启 VS Code 以应用更改。',
  "settings.aboutSonderr.telemetry.openSettings": "打开遥测设置",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 Sonderr 界面的语言。',
  ...
  "settings.models.speechToText.disabledDescription":
    "启用并登录 Sonderr 提供商以使用 Speech to Text。Speech to Text 目前仅支持通过 Sonderr Gateway 使用。",
  "settings.models.speechToTextModel.title": "语音转文本模型",
  "settings.models.speechToTextModel.description": "选择用于语音输入的 Sonderr Gateway 转录模型。",
  ...
  "settings.experimental.remote.description": "通过 Sonderr Cloud 启用会话的 Remote 控制。这也会影响此计算机上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 Sonderr 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未配置 MCP 服务器。在 sonderr.jsonc 中添加 MCP 服务器，或让代理为您添加。",
  "settings.agentBehaviour.workflows.description":
    "工作流是在配置中定义的自定义斜杠命令。在聊天中输入 /command-name 来调用它们。命令在 sonderr.json 的 'command' 部分中配置。",
  "settings.agentBehaviour.workflows.empty": "未配置自定义命令。将命令添加到 sonderr.json 即可在此处看到。",
  ...
  "settings.sandboxing.enabled.description":
    "在操作系统级沙盒中运行代理 shell 命令，将写入限制在项目和 Sonderr 状态目录内",
  ...
  "settings.display.fontSize.description": "独立于 VS Code 调整 Sonderr webview UI 的字体大小。",
  ...
  "settings.aboutSonderr.legacyMigration.title": "旧版迁移",
  "settings.aboutSonderr.legacyMigration.description":
    "从旧版 Sonderr 安装迁移设置，包括提供商 API 密钥和默认模型。",
  "settings.aboutSonderr.rooImport.description": "从 Roo Code 安装导入对话历史记录。",
  "settings.aboutSonderr.rooImport.button": "从 Roo Code 导入会话",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Sonderr 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
  ...
  "diffViewer.source.session.tooltip": "Sonderr 在当前会话中更改的文件，基于每轮快照。开始新会话时重置。",
