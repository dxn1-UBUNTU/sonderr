export const cloudProviderDict = {
  ...
  "provider.connect.bedrock.description":
    "Enter the AWS credentials Sonderr should use to access Amazon Bedrock. These credentials are stored securely in Sonderr's credential store.",
  ...
  "provider.connect.vertex.description":
    "Paste the complete Google Cloud service-account JSON. Sonderr stores it securely in its credential store.",
