...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instala Anaconda Desktop en este equipo y luego vuelve aquí. Sonderr no ejecuta el instalador por ti.",
  ...
  "provider.anaconda.state.signedOut": "Abre Anaconda Desktop e inicia sesión antes de conectar Sonderr.",
  "provider.anaconda.state.unauthorized":
    "Sonderr no pudo acceder a Anaconda Desktop. Abre Desktop, inicia sesión de nuevo y reinícialo si es necesario.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr encontró un servidor local de generación de texto en buen estado y puede importar su configuración de conexión actual.",
  ...
  "provider.anaconda.toast.refreshed.description": "El servidor local activo y los modelos están actualizados en Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Sonderr.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox activado. Los comandos de shell del agente están limitados a los directorios del proyecto y de Sonderr.",
  "prompt.action.sandbox.disabled":
    "Sandbox desactivado. Haz clic para limitar las escrituras de los comandos de shell del agente a los directorios del proyecto y de Sonderr.",
  ...
  "prompt.action.sandbox.description.enabled": "Las escrituras se limitan a los directorios del proyecto y de Sonderr.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz con Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Inicia sesión en Sonderr para usar la entrada de voz.",
  ...
  "sidebar.topBar.label": "Navegación de Sonderr",
  ...
  "settings.indexing.sonderrModel.title": "Preajuste de modelo de Sonderr",
  "settings.indexing.sonderrModel.description": "Elige un modelo de embeddings alojado por Sonderr compatible.",
  "settings.indexing.sonderrSignIn.title": "Se requiere iniciar sesión en Sonderr",
  "settings.indexing.sonderrSignIn.description": "Inicia sesión en Sonderr para usar embeddings alojados.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculta los modelos de Sonderr Gateway cuyos proveedores pueden usar tus prompts para entrenamiento.",
  ...
  "settings.config.title": "Abrir archivo de configuración Sonderr {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Abre una carpeta de espacio de trabajo para editar el archivo de configuración Sonderr local.",
  "settings.config.openFailed": "Error al abrir el archivo de configuración Sonderr {{scope}}: {{message}}",
  "settings.config.source.xdg": "Configuración global XDG",
  "settings.config.source.homeSonderr": "Configuración .sonderr de Home",
  "settings.config.source.homeSonderr": "Configuración .sonderr de Home",
  "settings.config.source.homeSonderr": "Configuración .sonderr de Home",
  "settings.config.source.envFile": "Archivo de entorno SONDERR_CONFIG",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Configuración de entorno en línea",
  "settings.config.source.projectSonderr": "Configuración .sonderr del proyecto",
  "settings.config.source.projectRoot": "Configuración raíz del proyecto",
  "settings.config.source.projectSonderr": "Configuración heredada .sonderr",
  "settings.config.source.projectSonderr": "Configuración heredada .sonderr",
  ...
  "workStyle.onboarding.welcome": "Te damos la bienvenida a Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr se detiene y te muestra su plan mientras trabaja.",
  ...
  "session.cloud.import.placeholder": "ID de sesión, URL o comando sonderr import",
  ...
  "deviceAuth.title": "Iniciar sesión en Sonderr",
  ...
  "profile.action.login": "Iniciar sesión con Sonderr",
  ...
  "profile.usage.routing": "La facturación del plan está activa. El enrutamiento de Sonderr Gateway está {{state}}.",
  ...
  "profile.pass.subscribe": "Obtén Sonderr Pass para añadir créditos y ganar bonificaciones",
  "profile.pass.bonus": "Bonificación",
  "profile.pass.usage": "Uso de este mes",
  "profile.pass.paid": "Pagado",
  "profile.pass.meter": "Uso mensual de Sonderr Pass",
  ...
  "settings.aboutSonderr.title": "Acerca de Sonderr",

  "session.messages.welcome":
    "Sonderr es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutSonderr.status.connected": "Conectado",
  "settings.aboutSonderr.status.connecting": "Conectando...",
  "settings.aboutSonderr.status.disconnected": "Desconectado",
  "settings.aboutSonderr.status.error": "Error",
  "settings.aboutSonderr.cliServer": "Servidor CLI",
  "settings.aboutSonderr.status.label": "Estado:",
  "settings.aboutSonderr.port.label": "Puerto:",
  "settings.aboutSonderr.versionInfo": "Información de versión",
  "settings.aboutSonderr.version.label": "Versión:",
  "settings.aboutSonderr.community": "Comunidad y soporte",
  "settings.aboutSonderr.feedback.prefix": "Si tienes preguntas o comentarios, abre un issue en",
  "settings.aboutSonderr.feedback.or": "o",
  "settings.aboutSonderr.support.prefix": "Para preguntas de facturación o cuenta, contacta al Soporte al Cliente en",
  "settings.aboutSonderr.resetSettings.title": "Restablecer configuración",
  ...
  "settings.aboutSonderr.resetSettings.button": "Restablecer toda la configuración",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Transferencia de ajustes",
  ...
  "settings.aboutSonderr.exportSettings": "Exportar",
  "settings.aboutSonderr.importSettings": "Importar",
  "settings.aboutSonderr.importSettings.invalidJson":
    "Archivo JSON no válido. Seleccione un archivo de ajustes válido.",
  "settings.aboutSonderr.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de Sonderr.",
  ...
  "settings.aboutSonderr.importSettings.newerVersion":
    "Este archivo fue exportado desde una versión más reciente de Sonderr. Algunos ajustes podrían ignorarse.",
  ...
  "settings.aboutSonderr.telemetry.title": "Telemetría",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Abrir configuración de telemetría",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de Sonderr. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Habilita e inicia sesión en el proveedor Sonderr para usar Speech to Text. Actualmente, Speech to Text solo es compatible con Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de voz a texto",
  "settings.models.speechToTextModel.description":
    "Elige el modelo de transcripción de Sonderr Gateway para la entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite el control Remote de las sesiones a través de Sonderr Cloud. Esto también afectará a las CLI de este equipo.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carga las instrucciones y habilidades de CLAUDE.md desde tu directorio de configuración de Claude Code en las sesiones. Activa esta opción si quieres que Sonderr utilice tus instrucciones y habilidades de Claude Code. Requiere reiniciar.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No hay servidores MCP configurados. Añada servidores MCP en sonderr.jsonc o pida al agente que los añada.",
  "settings.agentBehaviour.workflows.description":
    "Los flujos de trabajo son comandos de barra personalizados definidos en su configuración. Escriba /command-name en el chat para invocarlos. Los comandos se configuran en sonderr.json en la sección 'command'.",
  "settings.agentBehaviour.workflows.empty":
    "No hay comandos personalizados configurados. Añada comandos a sonderr.json para verlos aquí.",
  ...
  "settings.sandboxing.enabled.description":
    "Ejecutar los comandos de shell del agente dentro de un sandbox a nivel de sistema operativo que restringe las escrituras a los directorios de estado del proyecto y de Sonderr",
  ...
  "settings.display.fontSize.description":
    "Ajusta el tamaño de fuente de la webview UI de Sonderr de forma independiente a VS Code.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Migración heredada",
  "settings.aboutSonderr.legacyMigration.description":
    "Migra la configuración de una instalación anterior de Sonderr, incluyendo las claves API de proveedores y el modelo predeterminado.",
  "settings.aboutSonderr.rooImport.description":
    "Importa el historial de conversaciones de una instalación de Roo Code.",
  "settings.aboutSonderr.rooImport.button": "Importar sesiones desde Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos Sonderr. Una experiencia familiar sin importar cómo elijas trabajar.",
  ...
  "diffViewer.source.session.tooltip":
    "Archivos modificados por Sonderr durante la sesión actual, basado en snapshots por turno. Se reinicia al empezar una nueva sesión.",
