...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Install Anaconda Desktop on this machine, then return here. Sonderr does not run the installer for you.",
  ...
  "provider.anaconda.state.signedOut": "Open Anaconda Desktop and sign in before connecting Sonderr.",
  "provider.anaconda.state.unauthorized":
    "Sonderr could not access Anaconda Desktop. Open Desktop, sign in again, and restart it if needed.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr found a healthy local text-generation server and can import its current connection settings.",
  ...
  "provider.anaconda.toast.refreshed.description": "The active local server and models are up to date in Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Sonderr.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox is enabled. Agent shell commands are confined to the project and Sonderr directories.",
  "prompt.action.sandbox.disabled":
    "Sandbox is disabled. Click to confine agent shell command writes to the project and Sonderr directories.",
  ...
  "prompt.action.sandbox.description.enabled": "Writes are limited to the project and Sonderr directories.",
  ...
  "speechToText.tooltip.start": "Start voice input with Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Sign in to Sonderr to use speech input.",
  ...
  "settings.config.title": "Open {{scope}} Sonderr config file",
  "settings.config.placeholder": "Config files are merged in order; files marked loaded currently affect settings.",
  "settings.config.noWorkspace": "Open a workspace folder to edit the local Sonderr config file.",
  "settings.config.openFailed": "Failed to open {{scope}} Sonderr config file: {{message}}",
  "settings.config.source.xdg": "XDG global config",
  "settings.config.source.homeSonderr": "Home .sonderr config",
  "settings.config.source.homeSonderr": "Home .sonderr config",
  "settings.config.source.homeSonderr": "Home .sonderr config",
  "settings.config.source.envFile": "SONDERR_CONFIG environment file",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Inline environment config",
  "settings.config.source.projectSonderr": "Project .sonderr config",
  "settings.config.source.projectRoot": "Project root config",
  "settings.config.source.projectSonderr": "Legacy .sonderr config",
  "settings.config.source.projectSonderr": "Legacy .sonderr config",
  ...
  "workStyle.onboarding.welcome": "Welcome to Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr pauses and shows you its plan as it works.",
  ...
  "session.cloud.import.placeholder": "Session ID, URL, or sonderr import command",
  ...
  "deviceAuth.title": "Sign in to Sonderr",
  ...
  "profile.action.login": "Login with Sonderr",
  ...
  "profile.usage.routing": "Plan billing is active. Sonderr Gateway routing is {{state}}.",
  ...
  "profile.pass.subscribe": "Get Sonderr Pass to add credits and earn bonuses",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "This month's usage",
  "profile.pass.paid": "Paid",
  "profile.pass.meter": "Sonderr Pass monthly usage",
  ...
  "settings.indexing.sonderrModel.title": "Sonderr model preset",
  "settings.indexing.sonderrModel.description": "Choose a supported Sonderr-hosted embedding model.",
  "settings.indexing.sonderrSignIn.title": "Sonderr sign-in required",
  "settings.indexing.sonderrSignIn.description": "Sign in to Sonderr to use hosted embeddings.",
  ...
  "settings.aboutSonderr.title": "About Sonderr",
  ...
  "settings.aboutSonderr.status.connected": "Connected",
  "settings.aboutSonderr.status.connecting": "Connecting...",
  "settings.aboutSonderr.status.disconnected": "Disconnected",
  ...
  "settings.aboutSonderr.versionInfo": "Version Information",
  "settings.aboutSonderr.version.label": "Version:",
  "settings.aboutSonderr.community": "Community & Support",
  "settings.aboutSonderr.feedback.prefix": "If you have any questions or feedback, feel free to open an issue on",
  "settings.aboutSonderr.feedback.or": "or",
  "settings.aboutSonderr.support.prefix": "For billing or account questions, contact Customer Support at",
  "settings.aboutSonderr.resetSettings.title": "Reset Settings",
  ...
  "settings.aboutSonderr.resetSettings.button": "Reset All Settings",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Settings Transfer",
  ...
  "settings.aboutSonderr.exportSettings": "Export",
  "settings.aboutSonderr.importSettings": "Import",
  "settings.aboutSonderr.importSettings.invalidJson": "Invalid JSON file. Please select a valid settings file.",
  "settings.aboutSonderr.importSettings.invalidConfig": "File does not contain valid Sonderr settings.",
  "settings.aboutSonderr.importSettings.tooLarge": "File is too large. Settings files must be under 1 MB.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "This file was exported from a newer version of Sonderr. Some settings may be ignored.",
  "settings.aboutSonderr.importSettings.success": "Settings imported. Review the changes above, then click Save.",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Open Telemetry Settings",
  ...
  "settings.language.description":
    'Choose the language for the Sonderr UI. "Auto" uses your VS Code display language.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Enable and sign in to the Sonderr provider to use Speech to Text. Speech to Text is currently only supported through Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Speech to Text Model",
  "settings.models.speechToTextModel.description": "Choose the Sonderr Gateway transcription model for voice input.",
  ...
  "settings.sandboxing.enabled.description":
    "Run agent shell commands inside an OS-level sandbox that restricts writes to the project and Sonderr state directories",
  ...
  "settings.experimental.remote.description":
    "Enable remote control of sessions via Sonderr Cloud. This will also affect CLIs on this machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Load CLAUDE.md instructions and skills from your Claude Code configuration directory into sessions. Enable this if you want Sonderr to use your Claude Code instructions and skills. Requires restart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No MCP servers configured. Add MCP servers in sonderr.jsonc, or ask the agent to add them for you.",
  "settings.agentBehaviour.workflows.description":
    "Workflows are custom slash commands defined in your config. Type /command-name in the chat to invoke them. Commands are configured in sonderr.json under the 'command' section.",
  "settings.agentBehaviour.workflows.empty":
    "No custom commands configured. Add commands to your sonderr.json to see them here.",
  ...
  "settings.display.fontSize.description": "Adjust the Sonderr webview UI font size independently from VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Hide Sonderr Gateway models whose providers may use your prompts for training.",
  ...
  "settings.aboutSonderr.legacyMigration.description":
    "Migrate settings from a previous installation of Sonderr, including provider API keys and default model.",
  "settings.aboutSonderr.rooImport.description": "Import conversation history from a Roo Code installation.",
  "settings.aboutSonderr.rooImport.button": "Import Sessions from Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "One small, efficient core across every Sonderr product. A familiar experience however you choose to work.",
  ...
  "diffViewer.source.session.tooltip":
    "Files changed by Sonderr during the current session, based on per-turn snapshots. Resets when you start a new session.",
