...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instale o Anaconda Desktop nesta máquina e depois volte aqui. O Sonderr não executa o instalador para você.",
  ...
  "provider.anaconda.state.signedOut": "Abra o Anaconda Desktop e faça login antes de conectar o Sonderr.",
  "provider.anaconda.state.unauthorized":
    "O Sonderr não conseguiu acessar o Anaconda Desktop. Abra o Desktop, faça login novamente e reinicie-o se necessário.",
  ...
  "provider.anaconda.state.ready":
    "O Sonderr encontrou um servidor local saudável de geração de texto e pode importar suas configurações de conexão atuais.",
  ...
  "provider.anaconda.toast.refreshed.description": "O servidor local ativo e os modelos estão atualizados no Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Sonderr.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox ativado. Os comandos shell do agente estão limitados aos diretórios do projeto e do Sonderr.",
  "prompt.action.sandbox.disabled":
    "Sandbox desativado. Clique para limitar as escritas dos comandos shell do agente aos diretórios do projeto e do Sonderr.",
  ...
  "prompt.action.sandbox.description.enabled":
    "As operações de escrita são limitadas aos diretórios do projeto e do Sonderr.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz com o Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Faça login no Sonderr para usar a entrada de voz.",
  ...
  "sidebar.topBar.label": "Navegação do Sonderr",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculte os modelos do Sonderr Gateway cujos provedores podem usar seus prompts para treinamento.",
  ...
  "settings.config.title": "Abrir arquivo de configuração {{scope}} do Sonderr",
  ...
  "settings.config.noWorkspace":
    "Abra uma pasta de espaço de trabalho para editar o arquivo de configuração local do Sonderr.",
  "settings.config.openFailed": "Falha ao abrir o arquivo de configuração {{scope}} do Sonderr: {{message}}",
  "settings.config.source.xdg": "Configuração global do XDG",
  "settings.config.source.homeSonderr": "Configuração .sonderr da Home",
  "settings.config.source.homeSonderr": "Configuração .sonderr da Home",
  "settings.config.source.homeSonderr": "Configuração .sonderr da Home",
  "settings.config.source.envFile": "Arquivo de ambiente SONDERR_CONFIG",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Configuração de ambiente embutida",
  "settings.config.source.projectSonderr": "Configuração .sonderr do projeto",
  "settings.config.source.projectRoot": "Configuração raiz do projeto",
  "settings.config.source.projectSonderr": "Configuração .sonderr legada",
  "settings.config.source.projectSonderr": "Configuração .sonderr legada",
  ...
  "workStyle.onboarding.welcome": "Boas-vindas ao Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "O Sonderr pausa e mostra o plano enquanto trabalha.",
  ...
  "session.cloud.import.placeholder": "ID da sessão, URL ou comando sonderr import",
  ...
  "deviceAuth.title": "Entrar no Sonderr",
  ...
  "profile.action.login": "Entrar com Sonderr",
  ...
  "profile.usage.routing": "A cobrança do plano está ativa. O roteamento do Sonderr Gateway está {{state}}.",
  ...
  "profile.pass.subscribe": "Obtenha o Sonderr Pass para adicionar créditos e ganhar bônus",
  "profile.pass.bonus": "Bônus",
  "profile.pass.usage": "Uso deste mês",
  "profile.pass.paid": "Pago",
  "profile.pass.meter": "Uso mensal do Sonderr Pass",
  ...
  "settings.indexing.sonderrModel.title": "Predefinição de modelo do Sonderr",
  "settings.indexing.sonderrModel.description": "Escolha um modelo de embedding hospedado pelo Sonderr compatível.",
  "settings.indexing.sonderrSignIn.title": "Login no Sonderr necessário",
  "settings.indexing.sonderrSignIn.description": "Entre no Sonderr para usar embeddings hospedados.",
  ...
  "settings.aboutSonderr.title": "Sobre o Sonderr",

  "session.messages.welcome":
    "Sonderr é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutSonderr.status.error": "Erro",
  ...
  "settings.aboutSonderr.versionInfo": "Informações da Versão",
  "settings.aboutSonderr.version.label": "Versão:",
  "settings.aboutSonderr.community": "Comunidade e Suporte",
  "settings.aboutSonderr.feedback.prefix": "Se você tiver perguntas ou feedback, abra uma issue no",
  ...
  "settings.aboutSonderr.resetSettings.title": "Redefinir Configurações",
  ...
  "settings.aboutSonderr.resetSettings.button": "Redefinir Todas as Configurações",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Transferência de configurações",
  ...
  "settings.aboutSonderr.importSettings.invalidConfig": "O arquivo não contém configurações válidas do Sonderr.",
  ...
  "settings.aboutSonderr.importSettings.newerVersion":
    "Este arquivo foi exportado de uma versão mais recente do Sonderr. Algumas configurações podem ser ignoradas.",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Abrir Configurações de Telemetria",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do Sonderr. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Ative e faça login no provedor Sonderr para usar o Speech to Text. Atualmente, o Speech to Text é compatível apenas com o Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de fala para texto",
  "settings.models.speechToTextModel.description":
    "Escolha o modelo de transcrição do Sonderr Gateway para entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite o controle Remote de sessões via Sonderr Cloud. Isso também afetará as CLIs nesta máquina.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carrega as instruções e skills do CLAUDE.md a partir do seu diretório de configuração do Claude Code para as sessões. Ative esta opção se deseja que o Sonderr utilize suas instruções e skills do Claude Code. Requer reinicialização.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nenhum servidor MCP configurado. Adicione servidores MCP em sonderr.jsonc ou peça ao agente para adicioná-los.",
  "settings.agentBehaviour.workflows.description":
    "Fluxos de trabalho são comandos de barra personalizados definidos na sua configuração. Digite /command-name no chat para invocá-los. Os comandos são configurados no sonderr.json na seção 'command'.",
  "settings.agentBehaviour.workflows.empty":
    "Nenhum comando personalizado configurado. Adicione comandos ao sonderr.json para vê-los aqui.",
  ...
  "settings.sandboxing.enabled.description":
    "Executar os comandos shell do agente dentro de um sandbox a nível de sistema operacional que restringe escritas aos diretórios de estado do projeto e do Sonderr",
  ...
  "settings.display.fontSize.description":
    "Ajuste o tamanho da fonte da webview UI do Sonderr independentemente do VS Code.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Migração Legada",
  "settings.aboutSonderr.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do Sonderr, incluindo chaves de API de provedor e modelo padrão.",
  "settings.aboutSonderr.rooImport.description": "Importe o histórico de conversas de uma instalação do Roo Code.",
  "settings.aboutSonderr.rooImport.button": "Importar sessões do Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Um núcleo pequeno e eficiente em todos os produtos Sonderr. Uma experiência familiar independentemente de como você escolha trabalhar.",
  ...
  "diffViewer.source.session.tooltip":
    "Arquivos modificados pelo Sonderr durante a sessão atual, com base em snapshots por turno. Reinicia ao começar uma nova sessão.",
