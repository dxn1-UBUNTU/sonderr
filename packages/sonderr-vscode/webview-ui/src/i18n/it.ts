...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installa Anaconda Desktop su questo computer, poi torna qui. Sonderr non esegue il programma di installazione per te.",
  ...
  "provider.anaconda.state.signedOut": "Apri Anaconda Desktop e accedi prima di connettere Sonderr.",
  "provider.anaconda.state.unauthorized":
    "Sonderr non è riuscito ad accedere ad Anaconda Desktop. Apri Desktop, accedi di nuovo e riavvialo se necessario.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr ha trovato un server locale di generazione del testo integro e può importare le sue attuali impostazioni di connessione.",
  ...
  "provider.anaconda.toast.refreshed.description": "Il server locale attivo e i modelli sono aggiornati in Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Inserisci la tua API key {{provider}} per connettere l'account e usare i modelli {{provider}} in Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere l'account e usare i modelli {{provider}} in Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere l'account e usare i modelli {{provider}} in Sonderr.",
  ...
  "settings.config.title": "Apri file config Sonderr {{scope}}",
  "settings.config.placeholder":
    "I file config vengono uniti in ordine; i file marcati come caricati influenzano attualmente le impostazioni.",
  "settings.config.noWorkspace": "Apri una cartella workspace per modificare il file config Sonderr locale.",
  "settings.config.openFailed": "Apertura file config Sonderr {{scope}} non riuscita: {{message}}",
  "settings.config.source.xdg": "Config globale XDG",
  "settings.config.source.homeSonderr": "Config home .sonderr",
  "settings.config.source.homeSonderr": "Config home .sonderr",
  "settings.config.source.homeSonderr": "Config home .sonderr",
  "settings.config.source.envFile": "File ambiente SONDERR_CONFIG",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Config ambiente inline",
  "settings.config.source.projectSonderr": "Config progetto .sonderr",
  "settings.config.source.projectRoot": "Config root progetto",
  "settings.config.source.projectSonderr": "Config legacy progetto .sonderr",
  "settings.config.source.projectSonderr": "Config legacy progetto .sonderr",
  ...
  "workStyle.onboarding.welcome": "Ti diamo il benvenuto in Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr si mette in pausa e ti mostra il suo piano mentre lavora.",
  ...
  "session.cloud.import.placeholder": "ID sessione, URL o comando sonderr import",
  ...
  "deviceAuth.title": "Accedi a Sonderr",
  ...
  "profile.action.login": "Accedi con Sonderr",
  ...
  "profile.usage.routing": "La fatturazione del piano è attiva. L'instradamento tramite Sonderr Gateway è {{state}}.",
  ...
  "profile.pass.subscribe": "Ottieni Sonderr Pass per aggiungere crediti e guadagnare bonus",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "Utilizzo di questo mese",
  "profile.pass.paid": "Pagato",
  "profile.pass.meter": "Utilizzo mensile di Sonderr Pass",
  ...
  "settings.aboutSonderr.title": "Informazioni su Sonderr",
  "session.messages.welcome":
    "Sonderr è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "sidebar.topBar.label": "Navigazione Sonderr",
  ...
  "settings.aboutSonderr.status.connected": "Connesso",
  "settings.aboutSonderr.status.connecting": "Connessione...",
  "settings.aboutSonderr.status.disconnected": "Disconnesso",
  "settings.aboutSonderr.status.error": "Errore",
  "settings.aboutSonderr.cliServer": "Server CLI",
  "settings.aboutSonderr.status.label": "Stato:",
  "settings.aboutSonderr.port.label": "Porta:",
  "settings.aboutSonderr.versionInfo": "Informazioni versione",
  "settings.aboutSonderr.version.label": "Versione:",
  "settings.aboutSonderr.community": "Community e supporto",
  "settings.aboutSonderr.feedback.prefix": "Per domande o feedback, apri pure una issue su",
  "settings.aboutSonderr.feedback.or": "oppure",
  "settings.aboutSonderr.support.prefix": "Per domande su fatturazione o account, contatta il supporto clienti a",
  "settings.aboutSonderr.resetSettings.title": "Ripristina impostazioni",
  ...
  "settings.aboutSonderr.resetSettings.button": "Ripristina tutte le impostazioni",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Trasferimento impostazioni",
  "settings.aboutSonderr.settingsTransfer.description":
    "Esporta o importa le impostazioni per trasferirle tra istanze VS Code.",
  "settings.aboutSonderr.exportSettings": "Esporta",
  "settings.aboutSonderr.importSettings": "Importa",
  "settings.aboutSonderr.importSettings.invalidJson": "File JSON non valido. Seleziona un file impostazioni valido.",
  "settings.aboutSonderr.importSettings.invalidConfig": "Il file non contiene impostazioni Sonderr valide.",
  "settings.aboutSonderr.importSettings.tooLarge": "File troppo grande. I file impostazioni devono essere sotto 1 MB.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "Questo file è stato esportato da una versione più recente di Sonderr. Alcune impostazioni potrebbero essere ignorate.",
  "settings.aboutSonderr.importSettings.success":
    "Impostazioni importate. Controlla le modifiche sopra, poi fai clic su Salva.",
  "settings.aboutSonderr.telemetry.title": "Telemetria",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Apri impostazioni telemetria",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia Sonderr. "Auto" usa la lingua di VS Code.',
  ...
  "settings.experimental.remote.description":
    "Abilita controllo remoto delle sessioni tramite Sonderr Cloud. Influenzerà anche le CLI su questa macchina.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox abilitata. I comandi shell dell'agente sono limitati alle directory del progetto e di Sonderr.",
  "prompt.action.sandbox.disabled":
    "Sandbox disabilitata. Fai clic per limitare le scritture dei comandi shell dell'agente alle directory del progetto e di Sonderr.",
  ...
  "prompt.action.sandbox.description.enabled": "Le scritture sono limitate alle directory del progetto e di Sonderr.",
  ...
  "settings.sandboxing.enabled.description":
    "Esegui i comandi shell dell'agente all'interno di un sandbox a livello di sistema operativo che limita le scritture alle directory di stato del progetto e di Sonderr",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carica istruzioni CLAUDE.md e skill dalla directory di configurazione Claude Code nelle sessioni. Abilitalo se vuoi che Sonderr usi istruzioni e skill di Claude Code. Richiede riavvio.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nessun server MCP configurato. Aggiungi server MCP in sonderr.jsonc, o chiedi all'agente di aggiungerli per te.",
  "settings.agentBehaviour.workflows.description":
    "I workflow sono comandi slash personalizzati definiti nella configurazione. Scrivi /nome-comando nella chat per invocarli. I comandi sono configurati in sonderr.json nella sezione 'command'.",
  "settings.agentBehaviour.workflows.empty":
    "Nessun comando personalizzato configurato. Aggiungi comandi a sonderr.json per vederli qui.",
  ...
  "settings.display.fontSize.description":
    "Regola la dimensione del font della webview Sonderr indipendentemente da VS Code.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Migrazione legacy",
  "settings.aboutSonderr.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di Sonderr, incluse API key dei provider e modello predefinito.",
  "settings.aboutSonderr.rooImport.description":
    "Importa la cronologia delle conversazioni da una installazione di Roo Code.",
  "settings.aboutSonderr.rooImport.button": "Importa sessioni da Roo Code",
  "migration.whatsNew.title": "Novità in Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un core piccolo ed efficiente per ogni prodotto Sonderr. Un'esperienza familiare comunque tu scelga di lavorare.",
  ...
  "diffViewer.source.session.tooltip":
    "File modificati da Sonderr durante la sessione corrente, basati su snapshot per turno. Si resetta quando inizi una nuova sessione.",
  ...
  "settings.models.speechToText.disabledDescription":
    "Abilita e accedi al provider Sonderr per usare Da voce a testo. Da voce a testo è attualmente supportato solo tramite Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Modello Da voce a testo",
  "settings.models.speechToTextModel.description": "Scegli il modello di trascrizione Sonderr Gateway per l'input vocale.",
  ...
  "settings.models.hidePromptTraining.description":
    "Nascondi i modelli Sonderr Gateway i cui provider potrebbero usare i tuoi prompt per l'addestramento.",
  ...
  "settings.indexing.sonderrModel.title": "Preset modello Sonderr",
  "settings.indexing.sonderrModel.description": "Scegli un modello embedding ospitato da Sonderr.",
  "settings.indexing.sonderrSignIn.title": "Accesso Sonderr richiesto",
  "settings.indexing.sonderrSignIn.description": "Accedi a Sonderr per usare gli embedding ospitati.",
  ...
  "speechToText.tooltip.start": "Avvia input vocale con Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Accedi a Sonderr per usare l'input vocale.",
