...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Установите Anaconda Desktop на этом компьютере, затем вернитесь сюда. Sonderr не запускает установщик за вас.",
  ...
  "provider.anaconda.state.signedOut": "Откройте Anaconda Desktop и войдите в систему перед подключением Sonderr.",
  "provider.anaconda.state.unauthorized":
    "Sonderr не удалось получить доступ к Anaconda Desktop. Откройте Desktop, войдите снова и при необходимости перезапустите его.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr обнаружил исправный локальный сервер генерации текста и может импортировать его текущие настройки подключения.",
  ...
  "provider.anaconda.toast.refreshed.description": "Активный локальный сервер и модели актуальны в Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Sonderr.",
  ...
  "prompt.action.sandbox.enabled": "Песочница включена. Команды оболочки агента ограничены каталогами проекта и Sonderr.",
  "prompt.action.sandbox.disabled":
    "Песочница отключена. Нажмите, чтобы ограничить запись команд оболочки агента каталогами проекта и Sonderr.",
  ...
  "prompt.action.sandbox.description.enabled": "Запись разрешена только в каталогах проекта и Sonderr.",
  ...
  "speechToText.tooltip.start": "Начать голосовой ввод с Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Войдите в Sonderr, чтобы использовать голосовой ввод.",
  ...
  "sidebar.topBar.label": "Навигация Sonderr",
  ...
  "settings.indexing.sonderrModel.title": "Предустановка модели Sonderr",
  "settings.indexing.sonderrModel.description": "Выберите поддерживаемую модель эмбеддингов, размещенную в Sonderr.",
  "settings.indexing.sonderrSignIn.title": "Требуется вход в Sonderr",
  "settings.indexing.sonderrSignIn.description": "Войдите в Sonderr, чтобы использовать размещенные эмбеддинги.",
  ...
  "settings.models.hidePromptTraining.description":
    "Скрывать модели Sonderr Gateway, поставщики которых могут использовать ваши запросы для обучения.",
  ...
  "settings.config.title": "Открыть файл конфигурации Sonderr ({{scope}})",
  ...
  "settings.config.noWorkspace":
    "Откройте папку рабочей области для редактирования локального файла конфигурации Sonderr.",
  "settings.config.openFailed": "Не удалось открыть файл конфигурации Sonderr ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Глобальная конфигурация XDG",
  "settings.config.source.homeSonderr": "Конфигурация .sonderr (Home)",
  "settings.config.source.homeSonderr": "Конфигурация .sonderr (Home)",
  "settings.config.source.homeSonderr": "Конфигурация .sonderr (Home)",
  "settings.config.source.envFile": "Файл среды SONDERR_CONFIG",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Встроенная конфигурация среды",
  "settings.config.source.projectSonderr": "Конфигурация .sonderr проекта",
  "settings.config.source.projectRoot": "Корневая конфигурация проекта",
  "settings.config.source.projectSonderr": "Устаревшая конфигурация .sonderr",
  "settings.config.source.projectSonderr": "Устаревшая конфигурация .sonderr",
  ...
  "workStyle.onboarding.welcome": "Добро пожаловать в Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sonderr приостанавливается и показывает свой план по ходу работы.",
  ...
  "session.cloud.import.placeholder": "ID сессии, URL или команда sonderr import",
  ...
  "deviceAuth.title": "Войти в Sonderr",
  ...
  "profile.action.login": "Войти через Sonderr",
  ...
  "profile.usage.routing": "Оплата тарифа активна. Маршрутизация через Sonderr Gateway {{state}}.",
  ...
  "profile.pass.subscribe": "Оформите Sonderr Pass, чтобы добавить кредиты и получать бонусы",
  "profile.pass.bonus": "Бонус",
  "profile.pass.usage": "Использование за этот месяц",
  "profile.pass.paid": "Оплачено",
  "profile.pass.meter": "Ежемесячное использование Sonderr Pass",
  ...
  "settings.aboutSonderr.title": "О Sonderr",

  "session.messages.welcome":
    "Sonderr — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutSonderr.status.connected": "Подключено",
  "settings.aboutSonderr.status.connecting": "Подключение...",
  "settings.aboutSonderr.status.disconnected": "Отключено",
  "settings.aboutSonderr.status.error": "Ошибка",
  "settings.aboutSonderr.cliServer": "CLI-сервер",
  "settings.aboutSonderr.status.label": "Статус:",
  "settings.aboutSonderr.port.label": "Порт:",
  "settings.aboutSonderr.versionInfo": "Информация о версии",
  "settings.aboutSonderr.version.label": "Версия:",
  "settings.aboutSonderr.community": "Сообщество и поддержка",
  "settings.aboutSonderr.feedback.prefix": "Если у вас есть вопросы или отзывы, создайте issue на",
  "settings.aboutSonderr.feedback.or": "или",
  "settings.aboutSonderr.support.prefix": "По вопросам оплаты или аккаунта обращайтесь в службу поддержки по адресу",
  "settings.aboutSonderr.resetSettings.title": "Сброс настроек",
  ...
  "settings.aboutSonderr.resetSettings.button": "Сбросить все настройки",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Перенос настроек",
  ...
  "settings.aboutSonderr.exportSettings": "Экспорт",
  "settings.aboutSonderr.importSettings": "Импорт",
  "settings.aboutSonderr.importSettings.invalidJson": "Недопустимый файл JSON. Выберите корректный файл настроек.",
  "settings.aboutSonderr.importSettings.invalidConfig": "Файл не содержит допустимых настроек Sonderr.",
  "settings.aboutSonderr.importSettings.tooLarge": "Файл слишком большой. Файлы настроек должны быть менее 1 MB.",
  "settings.aboutSonderr.importSettings.newerVersion":
    "Этот файл был экспортирован из более новой версии Sonderr. Некоторые настройки могут быть проигнорированы.",
  "settings.aboutSonderr.importSettings.success":
    "Настройки импортированы. Просмотрите изменения выше и нажмите «Сохранить».",

  "settings.aboutSonderr.telemetry.title": "Телеметрия",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Открыть настройки телеметрии",
  ...
  "settings.language.description": "Выберите язык интерфейса Sonderr. «Авто» использует язык отображения VS Code.",
  ...
  "settings.models.speechToText.disabledDescription":
    "Включите провайдер Sonderr и выполните вход, чтобы использовать Speech to Text. В настоящее время Speech to Text поддерживается только с Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Модель речи в текст",
  "settings.models.speechToTextModel.description": "Выберите модель транскрипции Sonderr Gateway для голосового ввода.",
  ...
  "settings.experimental.remote.description":
    "Включите управление Remote сеансами через Sonderr Cloud. Это также повлияет на CLI на этом компьютере.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Загружать инструкции CLAUDE.md и навыки из каталога конфигурации Claude Code в сессии. Включите эту опцию, если хотите, чтобы Sonderr использовал ваши инструкции и навыки Claude Code. Требуется перезапуск.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверы не настроены. Добавьте MCP-серверы в sonderr.jsonc или попросите агента добавить их.",
  "settings.agentBehaviour.workflows.description":
    "Рабочие процессы — это пользовательские слэш-команды, определённые в вашей конфигурации. Введите /command-name в чате, чтобы вызвать их. Команды настраиваются в sonderr.json в разделе 'command'.",
  "settings.agentBehaviour.workflows.empty":
    "Пользовательские команды не настроены. Добавьте команды в sonderr.json, чтобы увидеть их здесь.",
  ...
  "settings.sandboxing.enabled.description":
    "Выполнять команды оболочки агента в песочнице на уровне ОС, которая ограничивает запись в каталоги состояния проекта и Sonderr",
  ...
  "settings.display.fontSize.description": "Настройте размер шрифта webview UI для Sonderr независимо от VS Code.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Миграция с устаревшей версии",
  "settings.aboutSonderr.legacyMigration.description":
    "Перенос настроек из предыдущей установки Sonderr, включая API-ключи провайдеров и модель по умолчанию.",
  "settings.aboutSonderr.rooImport.description": "Импорт истории переписки из установки Roo Code.",
  "settings.aboutSonderr.rooImport.button": "Импортировать сеансы из Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Одно компактное и эффективное ядро для всех продуктов Sonderr. Знакомый опыт независимо от выбранного способа работы.",
  ...
  "diffViewer.source.session.tooltip":
    "Файлы, изменённые Sonderr в текущей сессии, на основе снимков по ходу. Сбрасывается при начале новой сессии.",
