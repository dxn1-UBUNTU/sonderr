...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installez Anaconda Desktop sur cette machine, puis revenez ici. Sonderr n’exécute pas l’installateur à votre place.",
  ...
  "provider.anaconda.state.signedOut": "Ouvrez Anaconda Desktop et connectez-vous avant de connecter Sonderr.",
  "provider.anaconda.state.unauthorized":
    "Sonderr n’a pas pu accéder à Anaconda Desktop. Ouvrez Desktop, reconnectez-vous et redémarrez-le si nécessaire.",
  ...
  "provider.anaconda.state.ready":
    "Sonderr a trouvé un serveur local sain de génération de texte et peut importer ses paramètres de connexion actuels.",
  ...
  "provider.anaconda.toast.refreshed.description": "Le serveur local actif et les modèles sont à jour dans Sonderr.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Sonderr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Sonderr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Sonderr.",
  ...
  "prompt.action.sandbox.enabled":
    "Le sandbox est activé. Les commandes shell de l'agent sont limitées aux répertoires du projet et de Sonderr.",
  "prompt.action.sandbox.disabled":
    "Le sandbox est désactivé. Cliquez pour limiter les écritures des commandes shell de l'agent aux répertoires du projet et de Sonderr.",
  ...
  "prompt.action.sandbox.description.enabled": "Les écritures sont limitées aux répertoires du projet et de Sonderr.",
  ...
  "speechToText.tooltip.start": "Démarrer la saisie vocale avec Sonderr Gateway",
  ...
  "speechToText.error.loginRequired": "Connectez-vous à Sonderr pour utiliser la saisie vocale.",
  ...
  "sidebar.topBar.label": "Navigation Sonderr",
  ...
  "settings.indexing.sonderrModel.title": "Préréglage de modèle Sonderr",
  "settings.indexing.sonderrModel.description": "Choisissez un modèle d'embedding hébergé par Sonderr pris en charge.",
  "settings.indexing.sonderrSignIn.title": "Connexion à Sonderr requise",
  "settings.indexing.sonderrSignIn.description": "Connectez-vous à Sonderr pour utiliser les embeddings hébergés.",
  ...
  "settings.models.hidePromptTraining.description":
    "Masquez les modèles Sonderr Gateway dont les fournisseurs peuvent utiliser vos prompts à des fins d'entraînement.",
  ...
  "settings.config.title": "Ouvrir le fichier de configuration Sonderr {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Ouvrez un dossier d'espace de travail pour modifier le fichier de configuration Sonderr local.",
  "settings.config.openFailed": "Échec de l'ouverture du fichier de configuration Sonderr {{scope}} : {{message}}",
  "settings.config.source.xdg": "Configuration globale XDG",
  "settings.config.source.homeSonderr": "Configuration .sonderr de Home",
  "settings.config.source.homeSonderr": "Configuration .sonderr de Home",
  "settings.config.source.homeSonderr": "Configuration .sonderr de Home",
  "settings.config.source.envFile": "Fichier d'environnement SONDERR_CONFIG",
  "settings.config.source.envDir": "SONDERR_CONFIG_DIR",
  "settings.config.source.envContent": "Configuration d'environnement en ligne",
  "settings.config.source.projectSonderr": "Configuration .sonderr du projet",
  "settings.config.source.projectRoot": "Configuration racine du projet",
  "settings.config.source.projectSonderr": "Configuration obsolète .sonderr",
  "settings.config.source.projectSonderr": "Configuration obsolète .sonderr",
  ...
  "workStyle.onboarding.welcome": "Bienvenue dans Sonderr",
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Sonderr s'interrompt et vous présente son plan au fil de son travail.",
  ...
  "session.cloud.import.placeholder": "ID de session, URL ou commande sonderr import",
  ...
  "deviceAuth.title": "Se connecter à Sonderr",
  ...
  "profile.action.login": "Se connecter avec Sonderr",
  ...
  "profile.usage.routing": "La facturation du forfait est active. Le routage via Sonderr Gateway est {{state}}.",
  ...
  "profile.pass.subscribe": "Obtenez Sonderr Pass pour ajouter des crédits et gagner des bonus",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "Consommation de ce mois-ci",
  "profile.pass.paid": "Payé",
  "profile.pass.meter": "Consommation mensuelle du Sonderr Pass",
  ...
  "settings.aboutSonderr.title": "À propos de Sonderr",

  "session.messages.welcome":
    "Sonderr est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutSonderr.status.connected": "Connecté",
  "settings.aboutSonderr.status.connecting": "Connexion en cours...",
  "settings.aboutSonderr.status.disconnected": "Déconnecté",
  "settings.aboutSonderr.status.error": "Erreur",
  "settings.aboutSonderr.cliServer": "Serveur CLI",
  "settings.aboutSonderr.status.label": "Statut :",
  "settings.aboutSonderr.port.label": "Port :",
  "settings.aboutSonderr.versionInfo": "Informations de version",
  "settings.aboutSonderr.version.label": "Version :",
  "settings.aboutSonderr.community": "Communauté et support",
  "settings.aboutSonderr.feedback.prefix":
    "Si vous avez des questions ou des commentaires, n'hésitez pas à ouvrir un ticket sur",
  "settings.aboutSonderr.feedback.or": "ou",
  "settings.aboutSonderr.support.prefix":
    "Pour les questions de facturation ou de compte, contactez le support client à",
  "settings.aboutSonderr.resetSettings.title": "Réinitialiser les paramètres",
  ...
  "settings.aboutSonderr.resetSettings.button": "Réinitialiser tous les paramètres",
  "settings.aboutSonderr.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutSonderr.settingsTransfer.title": "Transfert des paramètres",
  ...
  "settings.aboutSonderr.exportSettings": "Exporter",
  "settings.aboutSonderr.importSettings": "Importer",
  ...
  "settings.aboutSonderr.importSettings.invalidConfig": "Le fichier ne contient pas de paramètres Sonderr valides.",
  ...
  "settings.aboutSonderr.importSettings.newerVersion":
    "Ce fichier a été exporté depuis une version plus récente de Sonderr. Certains paramètres pourraient être ignorés.",
  ...
  "settings.aboutSonderr.telemetry.title": "Télémétrie",
  ...
  "settings.aboutSonderr.telemetry.openSettings": "Ouvrir les paramètres de télémétrie",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Sonderr. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.models.speechToText.disabledDescription":
    "Activez et connectez-vous au fournisseur Sonderr pour utiliser Speech to Text. Speech to Text n'est actuellement pris en charge qu'avec Sonderr Gateway.",
  "settings.models.speechToTextModel.title": "Modèle de transcription vocale",
  "settings.models.speechToTextModel.description":
    "Choisissez le modèle de transcription Sonderr Gateway pour la saisie vocale.",
  ...
  "settings.experimental.remote.description":
    "Activez le contrôle Remote des sessions via Sonderr Cloud. Cela affectera également les CLI sur cette machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Charge les instructions et les compétences de CLAUDE.md depuis votre répertoire de configuration Claude Code dans les sessions. Activez cette option si vous souhaitez que Sonderr utilise vos instructions et compétences Claude Code. Nécessite un redémarrage.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Aucun serveur MCP configuré. Ajoutez des serveurs MCP dans sonderr.jsonc ou demandez à l'agent de les ajouter.",
  "settings.agentBehaviour.workflows.description":
    "Les workflows sont des commandes slash personnalisées définies dans votre configuration. Tapez /command-name dans le chat pour les invoquer. Les commandes sont configurées dans sonderr.json dans la section 'command'.",
  "settings.agentBehaviour.workflows.empty":
    "Aucune commande personnalisée configurée. Ajoutez des commandes à sonderr.json pour les voir ici.",
  ...
  "settings.sandboxing.enabled.description":
    "Exécuter les commandes shell de l'agent dans un sandbox au niveau du système d'exploitation qui restreint les écritures aux répertoires d'état du projet et de Sonderr",
  ...
  "settings.display.fontSize.description":
    "Ajustez la taille de la police de la webview UI de Sonderr indépendamment de VS Code.",
  ...
  "settings.aboutSonderr.legacyMigration.title": "Migration de l'ancienne version",
  "settings.aboutSonderr.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Sonderr, y compris les clés d'API des fournisseurs et le modèle par défaut.",
  "settings.aboutSonderr.rooImport.description":
    "Importer l'historique des conversations depuis une installation de Roo Code.",
  "settings.aboutSonderr.rooImport.button": "Importer les sessions depuis Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Sonderr",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un noyau petit et efficace partagé par tous les produits Sonderr. Une expérience familière quelle que soit votre façon de travailler.",
  ...
  "diffViewer.source.session.tooltip":
    "Fichiers modifiés par Sonderr pendant la session actuelle, basé sur des snapshots par tour. Réinitialisé lors du démarrage d'une nouvelle session.",
