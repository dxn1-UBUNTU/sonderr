...
import type { SonderrNotification, ProfileData } from "./profile"
...
export interface SelectSonderrModelMessage {
  type: "selectSonderrModel"
  modelID?: string
  agent?: string
}
...
export interface SonderrEmbeddingModelsLoadedMessage {
  type: "sonderrEmbeddingModelsLoaded"
  catalog: SonderrEmbeddingModelCatalog
}
...
export type ExtensionMessage =
  ...
  | SonderrEmbeddingModelsLoadedMessage
