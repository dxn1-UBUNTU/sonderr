...
export interface RequestSonderrEmbeddingModelsMessage {
  type: "requestSonderrEmbeddingModels"
}
...
export interface UpdateConfigMessage {
  type: "updateConfig"
  /** Global config patch written to ~/.config/sonderr/sonderr.json. */
  config: Partial<Config>
  globalUnset?: string[][]
  /** Project config patch written to the workspace's .sonderr/sonderr.jsonc or existing project config. */
...
export type WebviewMessage =
  ...
  | RequestSonderrEmbeddingModelsMessage
  | UpdateConfigMessage
