...
import { IconButton } from "@sonderr/sonderr-ui/icon-button"
import { Icon } from "@sonderr/sonderr-ui/icon"
import { TooltipKeybind } from "@sonderr/sonderr-ui/tooltip"
import { ContextMenu } from "@sonderr/sonderr-ui/context-menu"
                        ...
                        trigger={
                          <button class="am-selector-trigger" type="button" aria-label="Select project">
                            <span class="am-selector-left">
                              ...
                              <span class="am-selector-value">sonderr</span>
                            </span>
...
const projectB: AgentProjectSnapshot = {
  id: "prj-bbbb2222bbbb",
  root: "/repos/sonderr-gateway",
  label: "sonderr-gateway",
  pinned: false,
  active: false,
  expanded: true,
  initialized: true,
...
const wt = (id: string, branch: string, label?: string, opts: Partial<WorktreeState> = {}): WorktreeState => ({
  id,
  branch,
  path: `/repos/x/.sonderr/worktrees/${id}`,
  parentBranch: "main",
  ...
  comments: [
    {
      ...
      file: "packages/sonderr-vscode/src/agent-manager/gh.ts",
      line: 42,
    ...
    },
    {
      ...
      file: "packages/sonderr-vscode/src/agent-manager/pr/PRActions.ts",
      line: 8,
    ...
    },
    {
      ...
      file: "packages/sonderr-vscode/src/agent-manager/pr/am-pr-utils.ts",
      line: 71,
    ...
    },
    {
      ...
      file: "packages/sonderr-vscode/webview-ui/agent-manager/pr/PRComments.tsx",
      line: 118,
