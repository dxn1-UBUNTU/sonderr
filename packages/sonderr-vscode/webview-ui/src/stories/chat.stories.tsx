...
export const UserMessageReviewComments: Story = {
  ...
  render: () => {
    const comments: ReviewComment[] = [
      {
        id: "review-1",
        file: "src/components/chat/SonderrBackendChatManager.kt",
        side: "additions",
        line: 114,
      ...
      {
        id: "review-2",
        file: "resources/messages/SonderrBundle_bs.properties",
        side: "deletions",
        line: 235,
        comment:
  ...
  [toolAssistantID]: [
    ...
    },
    {
      ...
      state: {
        ...
        output: "/Users/marius/Documents/git/sonderr/.sonderr/worktrees/zest-kettledrum",
        title: "pwd",
        metadata: {},
  ...
  [headerAssistantID]: [
    {
      ...
      state: {
        status: "completed",
        input: { filePath: "packages/cli/src/cli/index.ts" },
    ...
    },
    {
      ...
      state: {
        status: "completed",
        input: { pattern: "packages/cli/src/**/*.ts" },
        output:
          "packages/cli/src/cli/index.ts\npackages/cli/src/command/run.ts\npackages/cli/src/config/config.ts",
    ...
    },
    {
      ...
      state: {
        status: "completed",
        input: { filePath: "packages/cli/src/cli/interface.ts" },
    ...
    },
    {
      ...
      state: {
        status: "running",
        input: { command: "bun test packages/cli/test/cli.test.ts", description: "Run CLI tests" },
        title: "Run CLI tests",
      },
    },
  ],
...
const usageData = {
  ...
  models: [
    { providerID: "sonderr", modelID: "qwen/qwen3.7-plus-20260602", steps: 3, cost: 0.067214, tokens: usageTokens },
    {
      providerID: "minimax",
      modelID: "minimax-m3",
      steps: 1,
...
const usageProvider = {
  ...
  connected: () => ["sonderr", "minimax"],
  defaults: () => ({}),
  defaultSelection: () => ({ providerID: "sonderr", modelID: "qwen/qwen3.7-plus" }),
  models: () => [],
  findModel: () => undefined,
  authMethods: () => ({}),
  authStates: () => ({}),
...
// ---------------------------------------------------------------------------
// Welcome screen with AccountSwitcher + SonderrNotifications
// ---------------------------------------------------------------------------

const MOCK_NOTIFICATION = {
  id: "notif-1",
  title: "Try BYOK for Sonderr Gateway",
  message: "Bring your own API key for even more flexibility with Sonderr Gateway models.",
...
const mockServer = {
  ...
  profileData: () => ({
    profile: {
      email: "dev@sonderr.dev",
      name: "Dev User",
      organizations: [{ id: "org-1", name: "Sonderr Org", role: "member" }],
    },
    balance: { balance: 5.0 },
    currentOrgId: "org-1",
  }),
