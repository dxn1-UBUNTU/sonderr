...
import type { AssistantMessage, ToolPart } from "@sonderr/sdk/v2"
...
const shellPart: ToolPart = {
  ...
  state: {
    ...
    input: {
      ...
      command: `grep -n "migration\\|openMigration" packages/sonderr-vscode/webview-ui/src/types/messages.ts`,
    },
