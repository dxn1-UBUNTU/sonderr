...
import { writeToolOpen } from "../../../../sonderr-ui/src/components/tool-open-state"
...
const hits = [
  'packages/sonderr-ui/src/components/message-part.tsx:1847: <div data-component="tool-output">',
  'packages/sonderr-ui/src/components/basic-tool.css:250: [data-component="tool-output"]',
  "packages/sonderr-vscode/webview-ui/src/components/chat/VscodeToolOverrides.tsx:141: background process output",
].join("\n")
...
const proc = [
  ...
  "status: running",
  "cwd: /project",
  "command: bun run --cwd packages/sonderr-vscode storybook",
  "last_output:",
...
const gapPatch = [
  "===================================================================",
  "--- packages/sonderr-ui/src/components/message-part.css",
  "+++ packages/sonderr-ui/src/components/message-part.css",
  "@@ -560,5 +560,5 @@",
  ' html[data-theme="sonderr-vscode"] [data-component="reasoning-part"] {',
...
const writePatch = [
  "===================================================================",
  "--- packages/sonderr-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
  "+++ packages/sonderr-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
  "@@ -1,3 +1,4 @@",
  " /** @jsxImportSource solid-js */",
...
const tailPatch = [
  "===================================================================",
  "--- packages/sonderr-vscode/webview-ui/src/components/chat/MessageList.tsx",
  "+++ packages/sonderr-vscode/webview-ui/src/components/chat/MessageList.tsx",
  "@@ -1,1 +1,1 @@",
  "-const old = true",
  "+const next = true",
...
const permissions: PermissionRequest[] = [
  {
    ...
    always: ["bun *"],
    args: {
      command: "bun test packages/sonderr-vscode/tests/unit",
  ...
  },
  {
    ...
    sessionID: SID,
    toolName: "edit",
    patterns: ["packages/sonderr-ui/src/components/message-part.css"],
    always: ["packages/sonderr-ui/src/components/*"],
    args: {
      filediff: {
        file: "packages/sonderr-ui/src/components/message-part.css",
        patch: gapPatch,
        additions: 1,
        deletions: 1,
      },
...
const blocks: SDKPart[] = [
  ...
  bash(
    ...
    "matrix-call-bash",
    "Run visual check",
    "bun run --cwd packages/sonderr-vscode build-storybook",
    ...
    { outputPath: "/tmp/sonderr-tool-output.log" },
  ),
  done(
    "read",
    "read",
    { filePath: "packages/sonderr-ui/src/components/message-part.tsx", offset: 1788, limit: 80 },
    "Read tool renderers",
  ),
  done(
    "glob",
    "glob",
    { pattern: "webview-ui/src/**/*.tsx", path: "packages/sonderr-vscode" },
    "Find webview files",
    [
      "packages/sonderr-vscode/webview-ui/src/components/chat/AssistantMessage.tsx",
      "packages/sonderr-vscode/webview-ui/src/components/chat/QuestionDock.tsx",
    ].join("\n"),
  ),
  done(
    "grep",
    "grep",
    { pattern: "tool-collapsible", include: "*.css", path: "packages/sonderr-ui/src/components" },
    "Find gaps",
    hits,
  ),
  done(
  ...
  tool("matrix-edit", "matrix-call-edit", "edit", {
    status: "completed",
    input: {
      filePath: "packages/sonderr-ui/src/components/message-part.css",
      oldString: "gap: 4px;",
      newString: "gap: 8px;",
    },
    output: "",
    ...
    metadata: {
      ...
      diagnostics: {
        "/project/packages/sonderr-ui/src/components/message-part.css": [
          {
            severity: 2,
    ...
    "write",
    {
      filePath: "packages/sonderr-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
  ...
  tool("matrix-write", "matrix-call-write", "write", {
    ...
    metadata: {
      filediff: {
        file: "packages/sonderr-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
        patch: writePatch,
        additions: 1,
        deletions: 0,
      },
  ...
  tool("matrix-patch", "matrix-call-patch", "apply_patch", {
    ...
    input: {
      patchText:
        "*** Begin Patch\n*** Update File: packages/sonderr-ui/src/components/message-part.css\n@@\n-gap: 4px;\n+gap: 8px;\n*** End Patch",
    },
    output: "",
    ...
    metadata: {
      files: [
        {
          filePath: "/project/packages/sonderr-ui/src/components/message-part.css",
          relativePath: "packages/sonderr-ui/src/components/message-part.css",
          type: "update",
          patch: gapPatch,
          diff: gapPatch,
          additions: 1,
        ...
        {
          filePath: "/project/packages/sonderr-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
          relativePath: "packages/sonderr-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
          type: "update",
          patch: writePatch,
          diff: writePatch,
          additions: 1,
        ...
        {
          filePath: "/project/packages/sonderr-vscode/webview-ui/src/components/chat/MessageList.tsx",
          relativePath: "packages/sonderr-vscode/webview-ui/src/components/chat/MessageList.tsx",
          type: "update",
          patch: tailPatch,
          diff: tailPatch,
          additions: 1,
  ...
  tool("matrix-task-explore", "matrix-call-task-explore", "task", {
    ...
    metadata: {
      parentSessionId: SID,
      sessionId: CHILD,
      model: { providerID: "sonderr", modelID: "anthropic/claude-sonnet-4-6" },
      truncated: false,
    },
  ...
  tool(
    ...
    "repo-clone",
    "repo_clone",
    { repository: "Sonderr-Org/sonderr" },
    "Clone repository",
    "Repository ready: Sonderr-Org/sonderr\nStatus: cached\nLocal path: /cache/sonderr",
    { repository: "Sonderr-Org/sonderr", status: "cached", localPath: "/cache/sonderr" },
  ),
  done(
    "repo-overview",
    "repo_overview",
    ...
    "semantic-search",
    "semantic_search",
    { query: "tool renderer selection", path: "packages/sonderr-ui" },
    "Semantic code search",
    "Found 1 result in packages/sonderr-ui/src/components/message-part.tsx",
    {
      results: [
        {
          filePath: "packages/sonderr-ui/src/components/message-part.tsx",
          score: 0.92,
          startLine: 1210,
          endLine: 1220,
    ...
    "Legacy code search",
    "https://github.com/Sonderr-Org/sonderr/blob/main/packages/sonderr-ui/src/components/message-part.tsx",
  ),
  tool(
    "matrix-tool-hint",
    "matrix-call-tool-hint",
    "edit",
    failed({ filePath: "packages/sonderr-ui/src/components/message-part.css" }, "oldString and newString are identical"),
  ),
  tool(
    "matrix-tool-error",
...
function children(id: string): ToolPart[] {
  return Array.from({ length: 45 }, (_, index) => {
    ...
    const input = grep
      ...
      : { filePath: `packages/cli/test/provider/provider-${index + 1}.test.ts` }
    return {
...
for (const key of [
  ...
  "sonderr_local_recall:matrix-call-local-recall",
          ...
          <div class="tool-call-lab-search-previews">
            ...
            <section class="tool-call-lab-panel tool-call-lab-panel-wide">
              ...
              <div class="tool-call-lab-stack">
                ...
                <div class="tool-call-lab-example">
                  ...
                  <StartupErrorBanner
                    errorMessage="Failed to start the Sonderr CLI"
                    errorDetails="spawn /path/to/sonderr ENOENT"
                  />
                </div>
              </div>
            </section>
            <section class="tool-call-lab-panel tool-call-lab-panel-wide">
              <div class="tool-call-lab-panel-header">
                ...
                <span class="tool-call-lab-panel-note">
                  Generic provider errors and Sonderr authentication or promotion actions.
                </span>
              </div>
              <div class="tool-call-lab-stack">
                <div class="tool-call-lab-example">
