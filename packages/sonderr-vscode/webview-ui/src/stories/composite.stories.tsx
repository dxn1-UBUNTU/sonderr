...
/**
 * Composite visual regression stories for the sonderr-vscode webview.
 *
 * These test the *composed* UI — how sonderr-ui components look together
...
import type { AssistantMessage as SDKAssistantMessage, ReasoningPart, TextPart, ToolPart } from "@sonderr/sdk/v2"
...
import { Part } from "@sonderr/sonderr-ui/message-part"
...
const externalDirPermission: PermissionRequest = {
  ...
  patterns: ["/Users/developer/projects/sonderr-bench/dashboard/app/routes/*"],
  always: ["/Users/developer/projects/sonderr-bench/dashboard/app/routes/*"],
  args: { filepath: "/Users/developer/projects/sonderr-bench/dashboard/app/routes/index.tsx" },
