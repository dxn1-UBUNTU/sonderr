...
// ---------------------------------------------------------------------------
// SonderrLogo — replicates the pattern from MessageList.tsx
// ---------------------------------------------------------------------------
...
const SonderrLogo = (): JSX.Element => {
  ...
  const icon = isLight ? "sonderr-light.svg" : "sonderr-dark.svg"
  return (
    <div class="migration-wizard__logo">
      <img src={`${iconsBaseUri}/${icon}`} alt="Sonderr" />
    </div>
  )
}
      ...
      <div class="migration-wizard__container">
        ...
        <div class={screen() === "whats-new" ? "migration-wizard__screen--active" : "migration-wizard__screen--hidden"}>
          ...
          <div class="migration-wizard__blog-link">
            <a href="https://blog.kilo.ai/p/new-sonderr-for-vs-code-is-live">
