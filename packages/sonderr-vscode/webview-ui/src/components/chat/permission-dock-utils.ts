...
// differ from what executes. The webview can't import from @sonderr/cli, so this mirrors
// displayCommand in packages/cli/src/sonderr/skills/display.ts; keep them in sync.
const CONTROL = /[\u0000-\u001f\u007f-\u009f\u200e\u200f\u2028\u2029\u202a-\u202e\u2066-\u2069]/g
