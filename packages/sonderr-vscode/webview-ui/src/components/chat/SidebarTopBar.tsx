/**
 * Renders New Task, History, Agent Manager, SonderrClaw, Marketplace, Profile, and
...
export const SidebarTopBar: Component<SidebarTopBarProps> = (props) => {
  ...
  const actions: Action[] = [
    ...
    { key: "sonderrClaw", codicon: "comment-discussion", button: "sonderrclaw", run: () => open("openSonderrClaw") },
