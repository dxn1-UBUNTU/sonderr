...
import {
  ...
  resolveToolApproval,
} from "@sonderr/sonderr-ui/message-part"
import type { MessageFeedbackControls } from "@sonderr/sonderr-ui/message-part"
import type {
 ...
 *
 * Visibility is gated by the same `sonderr-code.new.showTokenThroughput`
