 ...
 * using the CSS Custom Highlight API (same technique as sonderr-ui's code find
...
const MATCH_NAME = "sonderr-transcript-search-match"
const ACTIVE_NAME = "sonderr-transcript-search-match-active"
