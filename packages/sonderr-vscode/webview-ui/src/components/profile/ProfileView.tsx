...
const ProfileView: Component<ProfileViewProps> = (props) => {
  ...
  const handleGetPass = () => {
    vscode.postMessage({ type: "openExternal", url: "https://kilo.ai/pricing/sonderr-pass" })
  }
  ...
  return (
    <div style={{ display: "flex", "flex-direction": "column", height: "100%", "min-height": 0, overflow: "hidden" }}>
      ...
      >
        <h2 style={{ "font-size": "var(--sonderr-font-size-16)", "font-weight": "600", margin: 0 }}>
                  ...
                  <Card style={{ display: "flex", "flex-direction": "column", gap: "12px" }}>
                    <div style={{ display: "flex", "align-items": "center", "justify-content": "space-between" }}>
                      <div>
                        ...
                        <p
                          style={{
                            "font-size": "var(--sonderr-font-size-18)",
                            "font-weight": "600",
                            color: "var(--vscode-foreground)",
                            margin: 0,
                          }}
