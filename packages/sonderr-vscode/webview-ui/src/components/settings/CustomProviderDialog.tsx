    ...
    >
      ...
      >
        <div style={{ display: "flex", gap: "16px", "align-items": "center" }}>
          ...
          <div
            style={{ "font-size": "var(--sonderr-font-size-16)", "font-weight": "500", color: "var(--vscode-foreground)" }}
          >
        ...
        <form onSubmit={save} style={{ display: "flex", "flex-direction": "column", gap: "20px" }}>
          <div style={{ display: "flex", "flex-direction": "column", gap: "10px" }}>
            <div style={{ "font-size": "var(--sonderr-font-size-14)", color: "var(--text-base)" }}>
          ...
          <div style={{ display: "flex", "flex-direction": "column", gap: "12px" }}>
            ...
            <Show when={fetchError()}>
              {(err) => (
                <span
                  style={{ "font-size": "var(--sonderr-font-size-12)", color: "var(--vscode-errorForeground, #f14c4c)" }}
                >
                  {err()}
                </span>
              )}
          ...
          <div style={{ display: "flex", "flex-direction": "column", gap: "12px" }}>
            <label
              style={{ "font-size": "var(--sonderr-font-size-12)", "font-weight": "500", color: "var(--text-weak-base)" }}
            >
