...
import AboutSonderrTab from "./AboutSonderrTab"
...
const Settings: Component<SettingsProps> = (props) => {
  ...
  return (
    <div style={{ display: "flex", "flex-direction": "column", height: "100%", "min-height": 0 }}>
      ...
      >
        <h2 style={{ "font-size": "var(--sonderr-font-size-16)", "font-weight": "600", margin: 0, flex: 1 }}>
      ...
      >
        <Tabs.List>
          ...
          <Tabs.Trigger value="aboutSonderr" aria-label={language.t("settings.aboutSonderr.title")}>
            <Icon name="help" />
            <span class="label">{language.t("settings.aboutSonderr.title")}</span>
          </Tabs.Trigger>
        </Tabs.List>
        ...
        <Tabs.Content value="aboutSonderr">
          <h3>{language.t("settings.aboutSonderr.title")}</h3>
          <AboutSonderrTab
