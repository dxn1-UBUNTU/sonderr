...
import type { SonderrNotification, ExtensionMessage } from "../types/messages"

interface NotificationsContextValue {
  notifications: Accessor<SonderrNotification[]>
  filteredNotifications: Accessor<SonderrNotification[]>
