...
import { ClipboardProvider } from "@sonderr/sonderr-ui/context/clipboard"
...
export function getVSCodeAPI(): VSCodeAPI {
  if (!vscodeApi) {
    ...
    if (typeof acquireVsCodeApi === "function") {
      ...
      console.warn("[Sonderr New] Running outside VS Code, using mock API")
      vscodeApi = {
        postMessage: (msg) => console.log("[Sonderr New] Mock postMessage:", msg),
        getState: () => undefined,
        setState: () => {},
      }
    }
