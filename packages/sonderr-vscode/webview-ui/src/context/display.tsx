...
import { ToolApprovalVisibilityProvider } from "@sonderr/sonderr-ui/message-part"
...
export const DisplayProvider: ParentComponent = (props) => {
  ...
  return (
    ...
    >
      {/* Bridges the toggle into sonderr-ui's generic gate so every tool render hides the line consistently. */}
