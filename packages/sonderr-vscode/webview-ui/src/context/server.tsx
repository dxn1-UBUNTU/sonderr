...
export const ServerProvider: ParentComponent = (props) => {
  ...
  onMount(() => {
    const unsubscribe = vscode.onMessage((message: ExtensionMessage) => {
      switch (message.type) {
        case "ready":
          console.log("[Sonderr New] Server ready:", message.serverInfo)
        ...
        case "connectionState":
          console.log("[Sonderr New] Connection state changed:", message.state)
        ...
        case "error":
          console.error("[Sonderr New] Server error:", message.message)
          setErrorMessage(message.message)
          setErrorDetails(message.message)
          break

        case "profileData":
          console.log("[Sonderr New] Profile data:", message.data ? "received" : "null")
          setProfileData(message.data)
          break

        case "deviceAuthStarted":
          console.log("[Sonderr New] Device auth started")
          setDeviceAuth({
            status: "pending",
            code: message.code,
        ...
        case "deviceAuthComplete":
          console.log("[Sonderr New] Device auth complete")
        ...
        case "deviceAuthFailed":
          console.log("[Sonderr New] Device auth failed:", message.error)
          setDeviceAuth({ status: "error", error: message.error })
          break

        case "deviceAuthCancelled":
          console.log("[Sonderr New] Device auth cancelled")
    ...
    console.log("[Sonderr New] Webview ready")
   ...
   * outside the Profile page — e.g. the Sonderr Gateway card in the Providers
