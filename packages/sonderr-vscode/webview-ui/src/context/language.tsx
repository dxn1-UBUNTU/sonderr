/**
 * Language context
 * Provides i18n translations for sonderr-ui components.
 * Merges UI translations from @sonderr/ui and Sonderr overrides from @sonderr/sonderr-i18n.
 *
...
import { I18nProvider, pluralCategory, pluralKey } from "@sonderr/sonderr-ui/context"
import type { UiI18nKey, UiI18nParams, UiI18nPluralKey } from "@sonderr/sonderr-ui/context"
import { dict as uiEn } from "@sonderr/sonderr-ui/i18n/en"
import { dict as uiZh } from "@sonderr/sonderr-ui/i18n/zh"
import { dict as uiZht } from "@sonderr/sonderr-ui/i18n/zht"
import { dict as uiKo } from "@sonderr/sonderr-ui/i18n/ko"
import { dict as uiDe } from "@sonderr/sonderr-ui/i18n/de"
import { dict as uiEs } from "@sonderr/sonderr-ui/i18n/es"
import { dict as uiFr } from "@sonderr/sonderr-ui/i18n/fr"
import { dict as uiDa } from "@sonderr/sonderr-ui/i18n/da"
import { dict as uiJa } from "@sonderr/sonderr-ui/i18n/ja"
import { dict as uiPl } from "@sonderr/sonderr-ui/i18n/pl"
import { dict as uiRu } from "@sonderr/sonderr-ui/i18n/ru"
import { dict as uiAr } from "@sonderr/sonderr-ui/i18n/ar"
import { dict as uiNo } from "@sonderr/sonderr-ui/i18n/no"
import { dict as uiBr } from "@sonderr/sonderr-ui/i18n/br"
import { dict as uiTh } from "@sonderr/sonderr-ui/i18n/th"
import { dict as uiBs } from "@sonderr/sonderr-ui/i18n/bs"
import { dict as uiTr } from "@sonderr/sonderr-ui/i18n/tr"
import { dict as uiNl } from "@sonderr/sonderr-ui/i18n/nl"
import { dict as uiUk } from "@sonderr/sonderr-ui/i18n/uk"
import { dict as uiIt } from "@sonderr/sonderr-ui/i18n/it"
...
import { dict as sonderrEn } from "@sonderr/sonderr-i18n/en"
import { dict as sonderrZh } from "@sonderr/sonderr-i18n/zh"
import { dict as sonderrZht } from "@sonderr/sonderr-i18n/zht"
import { dict as sonderrKo } from "@sonderr/sonderr-i18n/ko"
import { dict as sonderrDe } from "@sonderr/sonderr-i18n/de"
import { dict as sonderrEs } from "@sonderr/sonderr-i18n/es"
import { dict as sonderrFr } from "@sonderr/sonderr-i18n/fr"
import { dict as sonderrDa } from "@sonderr/sonderr-i18n/da"
import { dict as sonderrJa } from "@sonderr/sonderr-i18n/ja"
import { dict as sonderrPl } from "@sonderr/sonderr-i18n/pl"
import { dict as sonderrRu } from "@sonderr/sonderr-i18n/ru"
import { dict as sonderrAr } from "@sonderr/sonderr-i18n/ar"
import { dict as sonderrNo } from "@sonderr/sonderr-i18n/no"
import { dict as sonderrBr } from "@sonderr/sonderr-i18n/br"
import { dict as sonderrTh } from "@sonderr/sonderr-i18n/th"
import { dict as sonderrBs } from "@sonderr/sonderr-i18n/bs"
import { dict as sonderrTr } from "@sonderr/sonderr-i18n/tr"
import { dict as sonderrNl } from "@sonderr/sonderr-i18n/nl"
import { dict as sonderrUk } from "@sonderr/sonderr-i18n/uk"
import { dict as sonderrIt } from "@sonderr/sonderr-i18n/it"
...
// Merge 4 dict layers: app + ui + sonderr + agent manager (sonderr and agent manager override last)
const base = { ...appEn, ...uiEn, ...sonderrEn }
const dicts: Record<Locale, Record<string, string>> = {
  en: { ...base, ...amEn },
  zh: { ...base, ...appZh, ...uiZh, ...sonderrZh, ...amEn, ...amZh },
  zht: { ...base, ...appZht, ...uiZht, ...sonderrZht, ...amEn, ...amZht },
  ko: { ...base, ...appKo, ...uiKo, ...sonderrKo, ...amEn, ...amKo },
  de: { ...base, ...appDe, ...uiDe, ...sonderrDe, ...amEn, ...amDe },
  es: { ...base, ...appEs, ...uiEs, ...sonderrEs, ...amEn, ...amEs },
  fr: { ...base, ...appFr, ...uiFr, ...sonderrFr, ...amEn, ...amFr },
  da: { ...base, ...appDa, ...uiDa, ...sonderrDa, ...amEn, ...amDa },
  ja: { ...base, ...appJa, ...uiJa, ...sonderrJa, ...amEn, ...amJa },
  pl: { ...base, ...appPl, ...uiPl, ...sonderrPl, ...amEn, ...amPl },
  ru: { ...base, ...appRu, ...uiRu, ...sonderrRu, ...amEn, ...amRu },
  ar: { ...base, ...appAr, ...uiAr, ...sonderrAr, ...amEn, ...amAr },
  no: { ...base, ...appNo, ...uiNo, ...sonderrNo, ...amEn, ...amNo },
  br: { ...base, ...appBr, ...uiBr, ...sonderrBr, ...amEn, ...amBr },
  th: { ...base, ...appTh, ...uiTh, ...sonderrTh, ...amEn, ...amTh },
  bs: { ...base, ...appBs, ...uiBs, ...sonderrBs, ...amEn, ...amBs },
  tr: { ...base, ...appTr, ...uiTr, ...sonderrTr, ...amEn, ...amTr },
  nl: { ...base, ...appNl, ...uiNl, ...sonderrNl, ...amEn, ...amNl },
  uk: { ...base, ...appUk, ...uiUk, ...sonderrUk, ...amEn, ...amUk },
  it: { ...base, ...appIt, ...uiIt, ...sonderrIt, ...amEn, ...amIt },
  // Persian (Sonderr fork addition). Only app + agent-manager layers are localized;
  // the upstream ui/sonderr layers fall back to English via `base`.
