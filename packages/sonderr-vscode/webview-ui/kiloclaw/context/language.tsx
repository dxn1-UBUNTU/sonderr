// SonderrClaw lightweight language context
//
// Self-contained i18n for the SonderrClaw panel. Does not depend on
...
export function SonderrClawLanguageProvider(props: { locale: () => string | undefined; children: JSX.Element }) {
...
export function useSonderrClawLanguage(): LanguageCtx {
  const ctx = useContext(LanguageContext)
  if (!ctx) throw new Error("useSonderrClawLanguage must be used within SonderrClawLanguageProvider")
  return ctx
}
