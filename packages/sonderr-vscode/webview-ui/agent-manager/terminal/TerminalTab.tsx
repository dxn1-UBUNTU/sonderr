 ...
 * carrying cursor metadata — see `packages/cli/src/pty/index.ts:46`).
 *
...
export const TerminalTab: Component<Props> = (props) => {
  ...
  const log = (...args: unknown[]) => console.warn(`[Sonderr New][XTerm][${props.terminalId}]`, ...args)
  ...
  onMount(() => {
    ...
    const fontSub = vscode.onMessage((message) => {
      ...
      // fontSizeChanged/ready control the Sonderr chat UI font — do not apply
