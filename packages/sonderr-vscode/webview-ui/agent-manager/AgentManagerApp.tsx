...
import { Popover } from "@sonderr/sonderr-ui/popover"
...
import { SonderrEmbeddingModelsProvider } from "../src/context/sonderr-embedding-models"
...
const AgentManagerContent: Component = () => {
  ...
  const applyActiveState = (state: AgentManagerStateMessage) => {
    ...
    // When not a git repo, also mark sessions as loaded since the Sonderr
