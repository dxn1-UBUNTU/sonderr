...
const { MarkedProvider } = await import("@sonderr/sonderr-ui/context/marked")
  ...
  comments: [
    {
      id: "PRRC_open",
      threadId: "PRRT_open",
      author: "sonderr-code-bot",
      body: "comment body survives Pierre rendering",
      file: "packages/sonderr-ui/src/components/file.tsx",
      line: 14,
      resolved: false,
      outdated: false,
      diffHunk: HUNK,
    ...
    },
    {
      ...
      file: "packages/sonderr-ui/src/components/other.tsx",
      line: 3,
      resolved: true,
      outdated: false,
    },
