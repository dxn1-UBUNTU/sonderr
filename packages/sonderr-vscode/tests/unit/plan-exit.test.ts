...
describe("planDisplayPath", () => {
  it("returns a relative path unchanged", () => {
    expect(planDisplayPath(".sonderr/plans/my-plan.md", "/repo")).toBe(".sonderr/plans/my-plan.md")
  })

  it("returns absolute path inside repo as repo-relative", () => {
    expect(planDisplayPath("/repo/.sonderr/plans/my-plan.md", "/repo")).toBe(".sonderr/plans/my-plan.md")
  })
  ...
  it("handles Windows absolute paths inside root", () => {
    expect(planDisplayPath("C:\\repo\\.sonderr\\plans\\plan.md", "C:\\repo")).toBe(".sonderr\\plans\\plan.md")
  })
...
describe("plan_exit renderer uses openFile not openDiff (source)", () => {
  ...
  it("does not depend on sonderr-provided plan status metadata", () => {
