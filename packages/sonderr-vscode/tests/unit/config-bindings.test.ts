...
import { ConfigBindings, type ConfigProject } from "../../src/sonderr-provider/config-bindings"
...
describe("ConfigBindings", () => {
  ...
  it("expires retained-panel bindings when the selected project changes", () => {
    const provider = new SonderrProvider({} as never, {} as never, undefined, { projectDirectory: "/repo/a" })
