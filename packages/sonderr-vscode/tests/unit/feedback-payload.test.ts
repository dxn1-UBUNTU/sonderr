...
describe("buildFeedbackProperties — non-Sonderr providers", () => {
...
describe("buildFeedbackProperties — Sonderr Gateway", () => {
  it("includes sessionID, messageID, parentMessageID", () => {
    const props = buildFeedbackProperties({ ...baseInput, providerID: "sonderr", next: "up" })
    expect(props).toEqual({
      providerID: "sonderr",
      modelID: "claude-sonnet-4-5",
      rating: "up",
