...
describe("getChatAutocompleteModel", () => {
  it("uses the matching FIM model for Next Edit settings", () => {
    expect(getChatAutocompleteModel("sonderr", "inception/mercury-next-edit").id).toBe("sonderr/inception/mercury-edit-2")
  ...
  it("keeps FIM settings unchanged", () => {
    expect(getChatAutocompleteModel("sonderr", "mistralai/codestral-2508").id).toBe("sonderr/mistralai/codestral-2508")
  })
})
