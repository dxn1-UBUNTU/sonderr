 ...
 *   - Webview (sidebar + agent manager): merged from app, ui, sonderr-i18n, agent-manager dicts
...
// Layer 2: upstream UI (@sonderr/ui re-exported via @sonderr/sonderr-ui)
...
// Layer 3: sonderr-i18n overrides
import { dict as sonderrEn } from "../../../sonderr-i18n/src/en"
import { dict as sonderrZh } from "../../../sonderr-i18n/src/zh"
import { dict as sonderrZht } from "../../../sonderr-i18n/src/zht"
import { dict as sonderrKo } from "../../../sonderr-i18n/src/ko"
import { dict as sonderrDe } from "../../../sonderr-i18n/src/de"
import { dict as sonderrEs } from "../../../sonderr-i18n/src/es"
import { dict as sonderrFr } from "../../../sonderr-i18n/src/fr"
import { dict as sonderrDa } from "../../../sonderr-i18n/src/da"
import { dict as sonderrJa } from "../../../sonderr-i18n/src/ja"
import { dict as sonderrPl } from "../../../sonderr-i18n/src/pl"
import { dict as sonderrRu } from "../../../sonderr-i18n/src/ru"
import { dict as sonderrAr } from "../../../sonderr-i18n/src/ar"
import { dict as sonderrNo } from "../../../sonderr-i18n/src/no"
import { dict as sonderrBr } from "../../../sonderr-i18n/src/br"
import { dict as sonderrTh } from "../../../sonderr-i18n/src/th"
import { dict as sonderrBs } from "../../../sonderr-i18n/src/bs"
import { dict as sonderrTr } from "../../../sonderr-i18n/src/tr"
import { dict as sonderrNl } from "../../../sonderr-i18n/src/nl"
import { dict as sonderrUk } from "../../../sonderr-i18n/src/uk"
import { dict as sonderrIt } from "../../../sonderr-i18n/src/it"
...
const sonderrLocales: Record<string, Record<string, string>> = {
  en: sonderrEn,
  zh: sonderrZh,
  zht: sonderrZht,
  ko: sonderrKo,
...
const webviewKeys = new Set(Object.keys({ ...appEn, ...uiEn, ...sonderrEn, ...amEn }))
...
describe("i18n locale completeness — every English key exists in all locales", () => {
  ...
  it("sonderr-i18n: every English key has a translation in all locales", () => {
    const missing = findMissingLocaleKeys(sonderrEn, sonderrLocales)
    if (missing.length > 0) {
      expect(
        missing,
        `Found ${missing.length} missing sonderr-i18n translation(s):\n${formatLocaleReport(missing)}`,
      ).toEqual([])
    }
    expect(missing).toEqual([])
  })
