...
export const SONDERR_AUTO = { providerID: SONDERR_PROVIDER_ID, modelID: "sonderr-auto/free" } as const
...
export function createSonderrFallbackProvider() {
  return {
    id: SONDERR_PROVIDER_ID,
    name: "Sonderr Gateway",
    source: "custom" as const,
    env: ["SONDERR_API_KEY"],
    metadata: {
      noteKey: "settings.providers.note.sonderr",
      icon: SONDERR_PROVIDER_ID,
      priority: 0,
    },
    models: {},
  }
