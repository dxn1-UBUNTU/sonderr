...
import { sameDirectory } from "../sonderr-provider-utils"
...
export interface ToolDeps {
  ...
  sessionMetadata: (client: SonderrClient, dir: string) => Promise<Record<string, unknown>>
...
async function prompt(client: SonderrClient, sid: string, dir: string, task: ToolTask) {
...
async function local(deps: ToolDeps, client: SonderrClient, task: ToolTask, directory?: string, source?: ToolSource) {
