...
import { SONDERR_DIR } from "../constants"
 ...
 * - If the entry is a symlink, the resolved target must live inside the .sonderr directory
 */
...
export class RunScriptService {
  ...
  constructor(root: string) {
    this.dir = path.join(root, SONDERR_DIR)
  }
