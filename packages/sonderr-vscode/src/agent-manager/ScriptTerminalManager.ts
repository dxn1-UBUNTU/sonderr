...
interface ScriptTerminalDeps {
  ...
  getClientAsync(directory: string): Promise<SonderrClient>
...
export class ScriptTerminalManager {
  ...
  private async reconcile(entry: Entry, client: SonderrClient): Promise<void> {
  ...
  private async url(client: SonderrClient, kind: ScriptTerminalKind, ptyID: string, cwd: string): Promise<string> {
    try {
