...
export interface ProjectMessageDeps {
  ...
  /** Open the Sonderr Settings editor, optionally on a tab and project. */
...
function disabled(deps: ProjectMessageDeps): boolean {
  ...
  deps.error("Multi-project Agent Manager is disabled. Enable it in Sonderr Settings > Experimental to add projects.")
  return true
}
