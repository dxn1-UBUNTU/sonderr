...
// ---------------------------------------------------------------------------
// Session provider (abstracts SonderrProvider interactions)
// ---------------------------------------------------------------------------
...
export interface Host {
   ...
   * The host handles HTML generation, icon paths, CSP, and SonderrProvider setup.
   *
  ...
  /** Open Sonderr Settings, optionally focused on a tab and project. */
