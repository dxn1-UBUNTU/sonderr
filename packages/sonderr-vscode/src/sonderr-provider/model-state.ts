 ...
 *
 * Reads/writes ~/.local/state/sonderr/model.json (same file the CLI TUI uses)
...
async function resolve(client: SonderrClient | null): Promise<string | undefined> {
...
async function read(client: SonderrClient | null): Promise<Record<string, unknown>> {
...
function write(client: SonderrClient | null, key: string, value: unknown): Promise<void> {
...
export async function reset(client: SonderrClient | null, post: PostMessage): Promise<void> {
