...
export class DiffVirtualProvider implements vscode.Disposable {
  ...
  constructor(private readonly extensionUri: vscode.Uri) {
    this.outputChannel = vscode.window.createOutputChannel("Sonderr Diff Virtual")
  }
  ...
  public open(diff: DiffVirtualFile): void {
    ...
    const panel = vscode.window.createWebviewPanel("sonderr-code.new.DiffVirtualPanel", title, vscode.ViewColumn.One, {
      enableScripts: true,
