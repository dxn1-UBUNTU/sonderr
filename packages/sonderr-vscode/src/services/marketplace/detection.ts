...
export class InstallationDetector {
   ...
   *
   * Agents are detected from .sonderr/agents/*.md files.
   * MCP servers and modes are detected from sonderr.json config files.
  ...
  /** Scan .sonderr/agents/*.md files to detect installed marketplace agents. */
  ...
  /** Read mcp and agent entries from a sonderr.json config file. */
