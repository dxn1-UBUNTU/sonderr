...
async function loadLanguageForFileExt(fileExtension: string): Promise<Language> {
  ...
  // In production (compiled): __dirname = /path/to/sonderr/src/dist or dist/
  // In development: __dirname = /path/to/sonderr/src/services/autocomplete/continuedev/core/util
  const candidatePaths: string[] = [
