...
const SUPPORTED_PROVIDER_DISPLAY_NAME = "Sonderr Gateway"
const SETTINGS_COMMAND = `command:sonderr-code.new.settingsButtonClicked?${encodeURIComponent(JSON.stringify(["autocomplete"]))}`
...
export class AutocompleteStatusBar {
  ...
  private init() {
    this.statusBar.text = t("sonderr:autocomplete.statusBar.enabled")
    this.statusBar.tooltip = this.createMarkdownTooltip(t("sonderr:autocomplete.statusBar.tooltip.basic"))
    this.statusBar.show()
  }
  ...
  private renderDefault() {
    ...
    const snoozedSuffix = this.props.snoozed ? ` (${t("sonderr:autocomplete.statusBar.snoozed")})` : ""
    this.statusBar.text = `${t("sonderr:autocomplete.statusBar.enabled")} (${this.props.completionCount})${snoozedSuffix}`

    this.statusBar.tooltip = this.createMarkdownTooltip(
      [
        t("sonderr:autocomplete.statusBar.tooltip.completionSummary", {
        ...
        this.props.model && this.props.provider
          ? t("sonderr:autocomplete.statusBar.tooltip.providerInfo", {
  ...
  private renderNoUsableProviderError() {
    this.statusBar.text = t("sonderr:autocomplete.statusBar.warning")
    this.statusBar.tooltip = this.createMarkdownTooltip(
      t("sonderr:autocomplete.statusBar.tooltip.noUsableProvider", {
