...
const INLINE_COMPLETION_ACCEPTED_COMMAND = "sonderr-code.new.autocomplete.nextEdit.accepted"
const DEFAULT_DEBOUNCE_MS = 250

export interface NextEditProviderDeps {
  /** Routes Mercury calls through the local Sonderr gateway (handles auth + BYOK). */
  connectionService: SonderrConnectionService
  /** Optional source of recently-viewed snippets (sonderr's VisibleCodeTracker can adapt to this). */
