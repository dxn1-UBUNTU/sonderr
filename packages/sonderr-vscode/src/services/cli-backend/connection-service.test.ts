...
import { SonderrConnectionService } from "./connection-service"
...
describe("SonderrConnectionService sandbox preference", () => {
  test("uses workspace state instead of extension-global state", () => {
    const service = new SonderrConnectionService({
...
describe("SonderrConnectionService clients", () => {
  test("returns a connected client without a workspace folder", async () => {
    const service = new SonderrConnectionService({} as any)
    const client = {}
...
describe("SonderrConnectionService explicit aborts", () => {
  const close = {
    id: "event-close",
...
describe("SonderrConnectionService viewed sessions", () => {
...
describe("SonderrConnectionService drainPendingPrompts", () => {
...
describe("SonderrConnectionService server exit handling", () => {
