/**
 * legacy-migration - Types for legacy Sonderr extension (v5.x) data structures.
 *
 * These types represent the shapes stored in VS Code SecretStorage and on disk
 * by the legacy extension (sonderr.sonderr-code v5.x, a Roo Code fork).
...
// ---------------------------------------------------------------------------
// Settings (stored in VS Code globalState under "sonderr-code.*" keys)
// ---------------------------------------------------------------------------
