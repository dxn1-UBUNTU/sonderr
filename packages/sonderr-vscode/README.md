<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=sonderr.Sonderr-Code"><img src="https://raster.shields.io/badge/VS_Code_Marketplace-007ACC?style=flat&logo=visualstudiocode&logoColor=white" alt="VS Code Marketplace" height="20"></a>
  <a href="https://x.com/sonderr"><img src="https://raster.shields.io/badge/sonderr-000000?style=flat&logo=x&logoColor=white" alt="X (Twitter)" height="20"></a>
  ...
  <a href="https://www.reddit.com/r/sonderr/"><img src="https://raster.shields.io/badge/Join%20r%2Fsonderr-D84315?style=flat&logo=reddit&logoColor=white" alt="Reddit" height="20"></a>
</p>

<p align="center">
  <a href="https://kilo.ai"><img width="250" alt="sonderr-code-logo" src="https://github.com/user-attachments/assets/bdb0c174-b9fd-40ad-a47b-f3aab9b54e8d" /></a>
</p>

<p align="center">
  <strong>Sonderr is the all-in-one agentic engineering platform.</strong><br>
  Build, ship, and iterate faster with the most popular open source coding agent.
</p>

<p align="center">
  <img width="100%" alt="Sonderr running inside VS Code" src="https://kilo.ai/_next/image?url=%2Fscreenshots%2Fvs-code%2Fvs-code-home-page-screenshot.png&w=3840&q=75">
</p>
...
<p align="center">
  ...
  <a href="https://kilo.ai/pricing/sonderr-pass">Sonderr Pass</a>
</p>
...
> 🚀 **Coming from Roo Code?** Switch to Sonderr and check out our [migration guide](https://kilo.ai/articles/roo-to-sonderr-migration-guide)!

## Key Features

- **Code Generation:** Sonderr can generate code using natural language.
- **Inline Autocomplete:** Get intelligent code completions as you type, powered by AI.
- **Task Automation:** Sonderr can automate repetitive coding tasks to save time..
- **Automated Refactoring:** Sonderr can refactor and improve existing code efficiently.
- **MCP Server Marketplace**: Sonderr can easily find, and use MCP servers to extend the agent capabilities.
- **Multi Mode**: Plan with Architect, Code with Coder, and Debug with Debugger, and make your own custom modes.

## Get Started

1. Install the Sonderr extension from the [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=sonderr.Sonderr-Code).
...
3. Start coding with AI that adapts to your workflow. Watch our quick-start guide to see Sonderr in action:
...
```bash
# Run from packages/sonderr-vscode/
...
Thanks to all the contributors who help make Sonderr better!
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <a href="https://github.com/Sonderr-Org/sonderr/graphs/contributors">
        <b>more ...</b>
      </a>
    </td>
  </tr>
