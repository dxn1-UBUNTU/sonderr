// Copy of @sonderr/ui/theme/context.tsx with two changes:
// 1. Imports DEFAULT_THEMES from our local default-themes (which includes Sonderr themes)
// 2. Default theme changed from "oc-1" to "sonderr"
import { onMount, onCleanup, createEffect } from "solid-js"
import { createStore } from "solid-js/store"
import type { DesktopTheme } from "@sonderr/ui/theme/types"
import { resolveThemeVariant, themeToCss } from "@sonderr/ui/theme/resolve"
import { DEFAULT_THEMES } from "./default-themes"
import { createSimpleContext } from "@sonderr/ui/context/helper"

export type ColorScheme = "light" | "dark" | "system"

const DEFAULT_THEME_ID = "sonderr"

const STORAGE_KEYS = {
  THEME_ID: "sonderr-theme-id",
  COLOR_SCHEME: "sonderr-color-scheme",
  THEME_CSS_LIGHT: "sonderr-theme-css-light",
  THEME_CSS_DARK: "sonderr-theme-css-dark",
} as const
