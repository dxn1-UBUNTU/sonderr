...
import { createDefaultOptions as defaults, styleVariables } from "@sonderr/ui/pierre"
...
// Sonderr semantic surfaces at the computed row level so host diff colors stay final.
const css = `
