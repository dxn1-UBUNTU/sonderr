import { sampledChecksum } from "@sonderr/core/util/encode"
import {
  FileDiff,
...
import { acquireVirtualizer, virtualMetrics } from "@sonderr/ui/pierre/virtualizer"
...
export function Diff<T>(props: DiffProps<T>) {
  ...
  // Patch Pierre shadow styles for Sonderr-specific layout and contrast tweaks.
