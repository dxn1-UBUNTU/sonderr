...
const STYLE_ID = "storybook-sonderr-theme"
...
export function applySonderrTheme(themeId: string, colorScheme: "light" | "dark") {
...
export function ThemeDecorator(props: ThemeDecoratorProps): JSX.Element {
  createEffect(() => {
    applySonderrTheme(props.theme, props.colorScheme)
  })
  return <props.Story />
}
