...
import { HoverCard } from "@sonderr/ui/hover-card"
import { Avatar } from "@sonderr/ui/avatar"
    ...
    >
      <div style={{ "max-width": "240px" }}>
        <div style={{ display: "flex", gap: "12px", "align-items": "center", "margin-bottom": "8px" }}>
          ...
          <div>
            <div style={{ "font-weight": "600" }}>Sonderr</div>
            <div style={{ color: "var(--text-weak)", "font-size": "12px" }}>@sonderr</div>
          </div>
        </div>
