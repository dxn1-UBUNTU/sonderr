...
internal class SessionCopyButton(
    ...
    fun copy() {
        ...
        balloon = JBPopupFactory.getInstance()
            .createHtmlTextBalloonBuilder(SonderrBundle.message("session.copy.copied"), null, null, null)
            .createBalloon()
            .also { item ->
