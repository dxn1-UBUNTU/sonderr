...
class SonderrVirtualFile(
    val path: SonderrPath,
) : VirtualFile(),
    ...
    override fun getFileSystem(): SonderrVirtualFileSystem = SonderrVirtualFileSystem.getInstance()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is SonderrVirtualFile) return false
        return path == other.path
    }

    override fun hashCode(): Int = path.hashCode()

    private fun kind(): SonderrVirtualFileKind? = service<SonderrVirtualFileKindRegistry>().get(path.kind)
}
