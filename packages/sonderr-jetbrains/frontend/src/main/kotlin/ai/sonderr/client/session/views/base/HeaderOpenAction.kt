...
import ai.sonderr.client.session.ui.selection.hoverPlaceholder
 ...
 * cards. [button] is a hover toolbar button that [ai.sonderr.client.session.ui.selection.SessionHoverCopyOverlay]
