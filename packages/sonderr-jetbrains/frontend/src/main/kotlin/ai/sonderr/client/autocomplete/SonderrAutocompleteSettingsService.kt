package ai.sonderr.client.autocomplete
...
@State(
    name = "SonderrAutocompleteSettings",
    storages = [Storage("sonderrAutocompleteSettings.xml")],
)
class SonderrAutocompleteSettingsService : PersistentStateComponent<SonderrAutocompleteSettingsService.State> {
    ...
    companion object {
        fun getInstance(): SonderrAutocompleteSettingsService = service()
    }
}
