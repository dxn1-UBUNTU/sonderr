...
import ai.sonderr.client.session.ui.ChangesCardView
...
internal class PermissionDiffView private constructor(
    ...
    override fun diffTitle() = SonderrBundle.message("session.permission.diff")
...
private fun permissionHeader(): ChangesCardView.Header {
    ...
    return ChangesCardView.Header(SonderrBundle.message("session.permission.diff"), badge, badge)
}
