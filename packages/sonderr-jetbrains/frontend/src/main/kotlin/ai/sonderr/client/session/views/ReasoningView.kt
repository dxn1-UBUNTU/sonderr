...
import ai.sonderr.client.session.openSessionLink
...
private fun reasoningParts(selection: SessionSelection? = null): ReasoningParts {
    val title = JBLabel(SonderrBundle.message("session.part.reasoning")).apply { foreground = SessionUiStyle.Text.Secondary.foreground() }
