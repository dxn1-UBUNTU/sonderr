...
import ai.sonderr.client.settings.base.SettingsStackedRow
import ai.sonderr.client.settings.base.SettingsToggle
import ai.sonderr.client.settings.base.SettingsRows
import ai.sonderr.client.settings.models.ModelSettingPicker
import ai.sonderr.client.ui.FilledBadgeIcon
import ai.sonderr.client.ui.HoverIcon
...
internal class AgentEditDialog(
    ...
    private val model = ModelSettingPicker().apply {
        picker.emptyText = SonderrBundle.message("settings.agentBehavior.agents.edit.default")
    ...
    private val mode = ComboBox(arrayOf(SonderrCliParser.MODE_PRIMARY, SonderrCliParser.MODE_SUBAGENT, SonderrCliParser.MODE_ALL)).apply {
    ...
    init {
        title = SonderrBundle.message("settings.agentBehavior.agents.edit.title", agent.displayName ?: agent.name)
        init()
        initValidation()
    }
    ...
    override fun createCenterPanel(): JComponent {
        ...
        SettingsRows().apply {
            row(SettingsStackedRow(
                SonderrBundle.message("settings.agentBehavior.agents.edit.name"),
                value = identity(),
                action = exportButton().takeIf { !agent.native },
            ))
            row(SettingsRow(
                SonderrBundle.message("settings.agentBehavior.agents.edit.mode"),
                SonderrBundle.message("settings.agentBehavior.agents.edit.mode.description"),
                mode,
            ))
            panel.next(this)
        }
        SettingsRows().apply {
            row(SettingsStackedRow(
                SonderrBundle.message("settings.agentBehavior.agents.edit.description"),
                if (canEditDescription(agent)) {
                    SonderrBundle.message("settings.agentBehavior.agents.edit.description.description")
                } else {
                    SonderrBundle.message("settings.agentBehavior.agents.edit.description.native.description")
                },
                scroll(description),
            ))
            row(SettingsStackedRow(
                if (agent.native) {
                    SonderrBundle.message("settings.agentBehavior.agents.edit.prompt.native")
                } else {
                    SonderrBundle.message("settings.agentBehavior.agents.edit.prompt")
                },
                if (agent.native) {
                    SonderrBundle.message("settings.agentBehavior.agents.edit.prompt.native.description")
                } else {
                    SonderrBundle.message("settings.agentBehavior.agents.edit.prompt.description")
                },
                scroll(prompt),
            ))
            panel.next(this)
        }
        panel.section(SonderrBundle.message("settings.agentBehavior.agents.edit.model")).apply {
            row(SettingsRow(
                SonderrBundle.message("settings.agentBehavior.agents.edit.model.override"),
                SonderrBundle.message("settings.agentBehavior.agents.edit.model.override.description"),
                model,
            ))
            row(SettingsRow(
                SonderrBundle.message("settings.agentBehavior.agents.edit.variant"),
                SonderrBundle.message("settings.agentBehavior.agents.edit.variant.description"),
                variant,
            ))
            row(SettingsRow(
                SonderrBundle.message("settings.agentBehavior.agents.edit.temperature"),
                SonderrBundle.message("settings.agentBehavior.agents.edit.temperature.description"),
                temperature,
            ))
            row(SettingsRow(
                SonderrBundle.message("settings.agentBehavior.agents.edit.topP"),
                SonderrBundle.message("settings.agentBehavior.agents.edit.topP.description"),
                top,
            ))
            row(SettingsRow(
                SonderrBundle.message("settings.agentBehavior.agents.edit.steps"),
                SonderrBundle.message("settings.agentBehavior.agents.edit.steps.description"),
                steps,
            ))
        }
        if (canEditVisibility(agent)) panel.section(SonderrBundle.message("settings.agentBehavior.agents.edit.visibility")).apply {
            row(SettingsRow(
                SonderrBundle.message("settings.agentBehavior.agents.edit.hidden"),
                SonderrBundle.message("settings.agentBehavior.agents.edit.hidden.description"),
                SettingsToggle(hidden) { hidden = it },
            ))
            row(SettingsRow(
                SonderrBundle.message("settings.agentBehavior.agents.edit.disabled"),
                SonderrBundle.message("settings.agentBehavior.agents.edit.disabled.description"),
    ...
    override fun getDimensionServiceKey(): String = "Sonderr.AgentEditDialog"
    ...
    private fun validateMode(): ValidationInfo? {
        ...
        if (value == SonderrCliParser.MODE_PRIMARY || value == SonderrCliParser.MODE_SUBAGENT || value == SonderrCliParser.MODE_ALL) return null
        return ValidationInfo(SonderrBundle.message("settings.agentBehavior.agents.edit.mode.invalid"), mode)
    }
    ...
    private fun validateNumber(field: NumericField, key: String, min: Double? = null, max: Double? = null): ValidationInfo? {
        ...
        if (parsed == null || !parsed.isFinite()) return ValidationInfo(SonderrBundle.message(key), field)
        if (min != null && parsed < min) return ValidationInfo(SonderrBundle.message(key), field)
        if (max != null && parsed > max) return ValidationInfo(SonderrBundle.message(key), field)
        return null
    }
    ...
    private fun validateSteps(): ValidationInfo? {
        ...
        return ValidationInfo(SonderrBundle.message("settings.agentBehavior.agents.edit.steps.invalid"), steps)
    }

    private class NumericField(value: String, decimal: Boolean) : JBTextField(value) {
        init {
            columns = NUMERIC_COLUMNS
            emptyText.text = SonderrBundle.message("settings.agentBehavior.agents.edit.default")
    ...
    private fun identity(): JComponent {
        val badges = listOfNotNull(
            badge(
                SonderrBundle.message("settings.agentBehavior.badge.subagent"),
                UiStyle.Badge.Primary,
            ).takeIf { SonderrCliParser.isSubagent(agent.mode) },
            badge(
                SonderrBundle.message("settings.agentBehavior.badge.custom"),
                UiStyle.Badge.Primary,
            ).takeIf { canDelete(agent) },
            badge(SonderrBundle.message("settings.agentBehavior.badge.hidden")).takeIf { agent.hidden },
            badge(SonderrBundle.message("settings.agentBehavior.badge.disabled")).takeIf { agent.disable },
            badge(
                SonderrBundle.message("settings.agentBehavior.badge.deprecated"),
                UiStyle.Badge.Alert,
    ...
    private fun exportButton() = HoverIcon().apply {
        ...
        val text = SonderrBundle.message("settings.agentBehavior.agents.edit.export")
        toolTipText = text
    ...
    private fun export() {
        ...
        val descriptor = FileSaverDescriptor(
            SonderrBundle.message("settings.agentBehavior.agents.edit.export.title"),
            SonderrBundle.message("settings.agentBehavior.agents.edit.export.description"),
            "agent.json",
        )
        ...
        ApplicationManager.getApplication().executeOnPooledThread {
            runCatching {
                ...
                notify(NotificationType.INFORMATION, SonderrBundle.message("settings.agentBehavior.agents.edit.export.success", wrapper.file.name))
            }.onFailure { err ->
                notify(NotificationType.ERROR, SonderrBundle.message("settings.agentBehavior.agents.edit.export.failed"), err.message)
            }
        }
    }
    ...
    private fun notify(type: NotificationType, title: String, content: String? = null) {
        ApplicationManager.getApplication().invokeLater {
            val notification = NotificationGroupManager.getInstance()
                .getNotificationGroup("Sonderr")
                ?.createNotification(title, content.orEmpty(), type)
                ?: Notification("Sonderr", title, content.orEmpty(), type)
    ...
    private class PromptField(value: String) : EditorTextField(
        ...
        init {
            ...
            setPlaceholder(SonderrBundle.message("settings.agentBehavior.agents.edit.prompt.placeholder"))
