package ai.sonderr.client.session.ui.mode
...
internal class ModePickerRenderer(
    ...
    private val badge = JBLabel(FilledBadgeIcon(SonderrBundle.message("mode.picker.deprecated"), UiStyle.Badge.Alert)).apply {
