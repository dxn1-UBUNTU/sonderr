...
object UiStyle {
    ...
    object Badge {
        ...
        object Primary : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Sonderr.History.activityBadgeBackground",
                JBUI.CurrentTheme.Link.Foreground.ENABLED,
            )

            override fun fg(): Color = JBColor.namedColor(
                "Sonderr.History.activityBadgeForeground",
                Color.WHITE,
            )
        }
        ...
        object Highlight : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Sonderr.ModelPicker.freeBadgeBackground",
                JBColor(0x95D6AC, 0x7FCA99),
            )

            override fun fg(): Color = JBColor.namedColor(
                "Sonderr.ModelPicker.freeBadgeForeground",
                JBColor.WHITE,
            )
        }
        ...
        object Alert : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Sonderr.History.runningBadgeBackground",
                JBColor(0xF5C542, 0x7A5A00),
            )

            override fun fg(): Color = JBColor.namedColor(
                "Sonderr.History.runningBadgeForeground",
        ...
        object ActivityRunning : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Sonderr.Activity.runningBackground",
                JBColor(Color(0x55, 0xA7, 0x6A), Color(0x57, 0x96, 0x5C)),
            )

            override fun fg(): Color = JBColor.namedColor(
                "Sonderr.Activity.runningForeground",
                Color.WHITE,
            )
        }
        ...
        object ActivityAttention : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Sonderr.Activity.attentionBackground",
                JBColor(Color(0xE6, 0x6D, 0x17), Color(0xC7, 0x7D, 0x55)),
            )

            override fun fg(): Color = JBColor.namedColor(
                "Sonderr.Activity.attentionForeground",
                Color.WHITE,
            )
        }
        ...
        object ActivityError : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Sonderr.Activity.errorBackground",
                JBColor(Color(0xE5, 0x57, 0x65), Color(0xDB, 0x5C, 0x5C)),
            )

            override fun fg(): Color = JBColor.namedColor(
                "Sonderr.Activity.errorForeground",
                Color.WHITE,
            )
        }
        ...
        object PullRequestOpen : Style {
            private val accent = JBColor.namedColor(
                "Sonderr.PullRequest.openBadgeForeground",
        ...
        object PullRequestDraft : Style {
            private val accent = JBColor.namedColor(
                "Sonderr.PullRequest.draftBadgeForeground",
        ...
        object PullRequestMerged : Style {
            private val accent = JBColor.namedColor(
                "Sonderr.PullRequest.mergedBadgeForeground",
        ...
        object PullRequestClosed : Style {
            private val accent = JBColor.namedColor(
                "Sonderr.PullRequest.closedBadgeForeground",
    ...
    object Colors {
        ...
        fun running(): Color = JBColor.namedColor(
            "Sonderr.Activity.runningSpinnerForeground",
        ...
        fun floatingPanel(): Color = JBColor.namedColor(
            "Sonderr.FloatingPanel.background",
