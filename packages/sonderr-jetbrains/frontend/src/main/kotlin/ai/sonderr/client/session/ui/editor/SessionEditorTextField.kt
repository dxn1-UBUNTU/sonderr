package ai.sonderr.client.session.ui.editor
...
internal open class SessionEditorTextField(
    ...
    private val undo = action(SonderrBundle.message("session.editor.undo"), true)
    private val redo = action(SonderrBundle.message("session.editor.redo"), false)
