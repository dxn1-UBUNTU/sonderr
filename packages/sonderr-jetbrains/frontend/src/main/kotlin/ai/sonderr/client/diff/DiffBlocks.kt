...
internal fun diffRequest(
    ...
    dto: DiffFileDto,
    branch: String? = null,
    labels: Pair<String, String> = SonderrBundle.message("diff.editor.side.base") to SonderrBundle.message("diff.editor.side.current"),
): DiffRequest {
    ...
    val fallback = patch ?: SonderrBundle.message("diff.editor.patch.unavailable")
...
internal fun diffTitle(file: String, branch: String?): String {
    ...
    return SonderrBundle.message("diff.editor.file.title", file, name)
}
