...
import ai.sonderr.client.session.views.failureText
...
class SessionMessageListPanel(
    ...
    private val openAttachment: (String, FileAttachment) -> Unit = { _, item -> ai.sonderr.client.session.views.AttachmentView.openDefault(item, openFile, openUrl) },
    ...
    private fun onTurnAdded(turn: ai.sonderr.client.session.model.Turn) {
    ...
    private fun onTurnUpdated(turn: ai.sonderr.client.session.model.Turn) {
    ...
    private fun diffsOf(turn: ai.sonderr.client.session.model.Turn) =
