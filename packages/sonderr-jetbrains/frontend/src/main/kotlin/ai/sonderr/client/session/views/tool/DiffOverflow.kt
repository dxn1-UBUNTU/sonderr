 ...
 * [ai.sonderr.client.session.ui.style.SessionUiStyle.View.Tool.DIFF_MAX_LINES]. Building an editor
...
internal fun diffOverflowPanel(open: () -> Unit): JComponent {
    val message = JBLabel(SonderrBundle.message("diff.overflow.message")).apply {
        foreground = SessionUiStyle.Text.Secondary.foreground()
    }
    val link = HyperlinkLabel(SonderrBundle.message("diff.overflow.open")).apply {
