 ...
 * (`Sonderr.Session.ContextMenu`) and the prompt bar's "more" popup (`Sonderr.Session.PromptMenu`).
 *
...
internal object SessionActionsKeys {
    val ACTIONS: DataKey<SessionActions> = DataKey.create("sonderr.session.actions")
}
