...
abstract class SessionHost(
    ...
    private val resolve: (String) -> Workspace = { dir -> service<SonderrWorkspaceService>().workspace(dir) },
    ...
    private fun schedule(ui: SessionUi) {
        cancel(ui)
        val delay = Registry.intValue("sonderr.session.inactive.disposeTimeoutMs").coerceAtLeast(0)
