package ai.sonderr.client.ui.list
...
internal fun activeListRenameCell(label: String = SonderrBundle.message("common.rename")) = ActiveListCell(
...
internal fun activeListDeleteCell(label: String = SonderrBundle.message("common.delete")) = ActiveListCell(
...
internal fun activeListMenuCell(label: String = SonderrBundle.message("common.more.actions")) = ActiveListCell(
