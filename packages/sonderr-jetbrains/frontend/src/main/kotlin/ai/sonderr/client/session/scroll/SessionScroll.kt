package ai.sonderr.client.session.scroll
...
internal class SessionScroll(
    ...
    init {
        jump = JBLabel(ScrollButtonIcon.create()).apply {
            ...
            toolTipText = SonderrBundle.message("session.scroll.bottom")
            isVisible = false
    ...
    private fun syncIcon() {
        ...
        jump.toolTipText = SonderrBundle.message(if (question) "session.scroll.question" else "session.scroll.bottom")
    }
