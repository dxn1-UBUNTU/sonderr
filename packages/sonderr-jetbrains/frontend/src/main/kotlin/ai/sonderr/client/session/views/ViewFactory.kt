...
import ai.sonderr.client.session.views.base.GenericView
...
import ai.sonderr.client.session.views.tool.GlobToolView
import ai.sonderr.client.session.views.tool.ReadToolView
import ai.sonderr.client.session.views.tool.SearchToolView
