...
internal class AutoApproveContent(
    ...
    private val tools = SettingsInlineList(
        empty = SonderrBundle.message("settings.autoApprove.tools.empty"),
    ...
    init {
        ...
        section(SonderrBundle.message("settings.autoApprove.title")).row(tools)
        next(SettingsRow(
            SonderrBundle.message("settings.autoApprove.showReason.title"),
            SonderrBundle.message("settings.autoApprove.showReason.description"),
            SettingsToggle(SonderrPluginSettings.getShowApprovalReason()) { visible ->
                SonderrPluginSettings.setShowApprovalReason(visible)
    ...
    private fun granularSection(tool: String, kind: ExceptionKind): GranularToolSection {
        ...
        return GranularToolSection(
            tool,
            SonderrBundle.message("settings.autoApprove.tool.$tool"),
            SonderrBundle.message("settings.autoApprove.wildcardLabel.$wildcardKey"),
            SonderrBundle.message("settings.autoApprove.filters.empty.$emptyKey"),
            SonderrBundle.message("settings.autoApprove.$addKey"),
            SonderrBundle.message("settings.autoApprove.$placeholderKey"),
            picker,
    ...
    private fun toolRow(draft: PermissionDraft, tool: String) = PermissionListRow(
        ...
        description = SonderrBundle.message("settings.autoApprove.tool.$tool"),
    ...
    private fun groupedRow(draft: PermissionDraft) = PermissionListRow(
        ...
        description = SonderrBundle.message("settings.autoApprove.tool.todoreadwrite"),
