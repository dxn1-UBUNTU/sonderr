...
import ai.sonderr.client.ui.diagram.Painters
 ...
 *
 * The engine's [ai.sonderr.client.ui.diagram.Limits] cap the model, not the geometry it lays out, so a
...
private val LOG = SonderrLog.create(DiagramCanvas::class.java)
