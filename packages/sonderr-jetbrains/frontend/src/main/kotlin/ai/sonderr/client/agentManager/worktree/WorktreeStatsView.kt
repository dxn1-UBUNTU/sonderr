...
import ai.sonderr.client.ui.list.ActiveListHitCell
 ...
 * stamp reused for every row, and [Stack] and [ai.sonderr.client.ui.layout.Align] clamp a child's
...
internal class WorktreeStatsView(
    ...
    init {
        ...
        diff.toolTipText = SonderrBundle.message("worktree.stats.tooltip", 0, 0, 0, 0)
    ...
    private fun sync(next: State) {
        ...
        behind.toolTipText = SonderrBundle.message("worktree.stats.behind.tooltip")
        behind.isVisible = s.behind > 0
        ahead.text = s.ahead.toString()
        ahead.toolTipText = SonderrBundle.message("worktree.stats.ahead.tooltip")
        ...
        // clicking does.
        val changeTip = SonderrBundle.message("worktree.stats.tooltip", s.ahead, s.behind, s.additions, s.deletions)
