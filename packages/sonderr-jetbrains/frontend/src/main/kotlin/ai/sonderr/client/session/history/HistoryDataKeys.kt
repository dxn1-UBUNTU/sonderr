...
object HistoryDataKeys {
    val SELECTION: DataKey<HistorySelection> = DataKey.create("ai.sonderr.client.session.history.HistorySelection")
    val CONTROLLER: DataKey<HistoryController> = DataKey.create("ai.sonderr.client.session.history.HistoryController")
     ...
     */
    val RENAME: DataKey<(LocalHistoryItem) -> Unit> = DataKey.create("ai.sonderr.client.session.history.HistoryRename")
}
