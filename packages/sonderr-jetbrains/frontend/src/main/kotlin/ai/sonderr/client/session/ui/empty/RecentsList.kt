...
import ai.sonderr.client.session.history.HistoryActivitySnapshot
import ai.sonderr.client.session.history.HistoryTime
import ai.sonderr.client.session.history.LocalHistoryItem
import ai.sonderr.client.session.history.itemAt
import ai.sonderr.client.session.history.title
...
internal class RecentsList(
    ...
    private val title = JBLabel(SonderrBundle.message("session.empty.recent")).apply {
