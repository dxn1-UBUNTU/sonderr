...
internal class BranchChangesBadge(
    ...
    init {
        ...
        toolTipText = SonderrBundle.message("diff.editor.branch.tooltip")
        getAccessibleContext().accessibleName = SonderrBundle.message("diff.editor.branch.tooltip")
    ...
    private fun set(n: Int, add: Int, del: Int): Boolean {
        ...
        additions = add
        deletions = del
        count.text = SonderrBundle.message(
    ...
    private companion object {
        const val ACTIVATE = "sonderr.branch.changes.activate"
    }
}
