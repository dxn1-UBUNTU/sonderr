...
class ShareSessionAction : AnAction(), DumbAware {
    ...
    override fun update(e: AnActionEvent) {
        ...
        val prefix = if (actions.share != null) "action.Sonderr.Session.Share.stop" else "action.Sonderr.Session.Share"
        e.presentation.isEnabledAndVisible = true
        e.presentation.text = SonderrBundle.message("$prefix.text")
        e.presentation.description = SonderrBundle.message("$prefix.description")
    }
