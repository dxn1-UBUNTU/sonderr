...
class RulesSettingsUiTest : BasePlatformTestCase() {
    ...
    private lateinit var agent: SonderrAgentBehaviorService
    ...
    fun `test content scroll renders an editor field`() {
        edt {
            val field = ai.sonderr.client.ui.CodeViewField(
                "# Rules",
                ai.sonderr.client.settings.base.settingsEditorFileType("./RULES.md", "# Rules"),
                true,
            )
            val scroll = ai.sonderr.client.settings.base.settingsContentScroll(field)
    ...
    private fun install() {
        ...
        app = SonderrAppService(appCoroutines.scope, rpc)
        workspaces = SonderrWorkspaceService(appCoroutines.scope, workspaceRpc)
        agent = SonderrAgentBehaviorService(appCoroutines.scope, agentRpc)
        val state = SonderrAppStateDto(
