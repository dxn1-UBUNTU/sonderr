...
class MdViewTest : BasePlatformTestCase() {
    ...
    fun `test set renders prose file refs as underlined brown links`() {
        view.set("See packages/cli/src/session/prompt.ts")
        val color = MdCommon.hex(SessionUiStyle.View.Markdown.string())
        val html = view.html()
        val sheet = view.overrideSheet()

        assertTrue(html.contains("<a class=\"sonderr-file-ref\" href=\"packages/cli/src/session/prompt.ts\">packages/cli/src/session/prompt.ts</a>"))
        assertTrue(sheet.contains("a.sonderr-file-ref, code a.sonderr-file-ref { color: $color; font-family:"))
    ...
    fun `test inline code file refs keep code color and become file links`() {
        ...
        assertTrue(html.contains("<code style=\"color: $color\"><a class=\"sonderr-file-ref\" href=\"packages/cli/src/session/prompt.ts\">packages/cli/src/session/prompt.ts</a></code>"))
        assertFalse(html.contains("background:"))
    }

    fun `test file refs keep line suffix and trailing punctuation outside link`() {
        view.set("See sonderr/session/prompt.ts:302 and native-plan-prompt.txt:37-38.")
        val html = view.html()

        assertTrue(html.contains("href=\"sonderr/session/prompt.ts:302\">sonderr/session/prompt.ts:302</a>"))
    ...
    fun `test framework names are not file ref links`() {
        ...
        assertFalse(html.contains("sonderr-file-ref"))
    }

    fun `test existing markdown links are not file ref links`() {
        view.set("[prompt](packages/cli/src/session/prompt.ts)")
        val html = view.html()
    ...
    fun `test fenced code file refs are not file ref links`() {
        ...
        assertTrue(html.contains("packages/cli/src/session/prompt.ts"))
        assertFalse(html.contains("sonderr-file-ref"))
    }
    ...
    fun `test inline code urls become underlined link colored links`() {
        view.set("Release PR: `https://github.com/Sonderr-Org/sonderr/pull/13524`")
        ...
        assertTrue(
            html.contains(
                "<code style=\"color: $code\">" +
                    "<a class=\"sonderr-url-ref\" href=\"https://github.com/Sonderr-Org/sonderr/pull/13524\">" +
                    "https://github.com/Sonderr-Org/sonderr/pull/13524</a></code>",
            ),
        )
        assertTrue(sheet.contains("a.sonderr-url-ref, code a.sonderr-url-ref { color: $link; font-family:"))
        assertTrue(sheet.contains("monospace; text-decoration: underline"))
    }
    ...
    fun `test inline code urls exclude trailing punctuation and unbalanced brackets`() {
        ...
        assertTrue(html.contains("(<a class=\"sonderr-url-ref\" href=\"https://example.com/b\">https://example.com/b</a>)"))
    }
    ...
    fun `test autolinked urls are not wrapped again`() {
        ...
        assertFalse(html.contains("sonderr-url-ref"))
    }
    ...
    fun `test inline code urls do not swallow following file refs`() {
        view.set("`https://example.com/a` then packages/cli/src/session/prompt.ts")
        val html = view.html()

        assertTrue(html.contains("href=\"https://example.com/a\">https://example.com/a</a>"))
        assertTrue(html.contains("<a class=\"sonderr-file-ref\" href=\"packages/cli/src/session/prompt.ts\">"))
    }
    ...
    fun `test code font override appears in override sheet`() {
        ...
        assertTrue(sheet.contains("a.sonderr-file-ref, code a.sonderr-file-ref { color:"))
    ...
    fun `test prose keeps transcript font while inline code uses editor font`() {
        ...
        view.applyStyle(style)
        view.set("hello `code` packages/cli/src/session/prompt.ts")
        val sheet = view.overrideSheet()
