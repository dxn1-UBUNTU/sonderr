...
class ReadToolViewTest : BasePlatformTestCase() {
    ...
    fun `test read file output renders filename hyperlink`() {
        ...
        val path = "/Users/kirillk/work/sonderr/.sonderr/worktrees/agreeable-marlin/packages/sonderr-jetbrains/frontend/src/test/kotlin/ai/sonderr/client/session/SessionUiLayoutTest.kt"
        val t = tool().also {
            it.output = """
                <path>$path</path>
                <type>file</type>
    ...
    fun `test read directory output remains plain text`() {
        val path = "/Users/kirillk/work/sonderr/packages/sonderr-jetbrains"
        val t = tool().also {
            it.output = """
                <path>$path</path>
                <type>directory</type>
