...
class BaseSettingsUiTest : BasePlatformTestCase() {
    ...
    override fun setUp() {
        ...
        app = SonderrAppService(appScope, FakeAppRpcApi())
        workspaces = SonderrWorkspaceService(appScope, FakeWorkspaceRpcApi())
    }
    ...
    fun `test login banner can be shown`() {
        ...
        edt { assertTrue(text(view).contains("Sign in to Sonderr")) }
    }
    ...
    fun `test login banner can be disabled`() {
        ...
        edt { assertFalse(text(view).contains("Sign in to Sonderr")) }
    }
    ...
    private class FakePanel(
        ...
        override fun draft(state: SonderrAppStateDto): Draft = draft
