...
class EditorContextGathererTest : BasePlatformTestCase() {
    ...
    fun `test gather filters sonderrignore files from open tabs`() {
        ...
        myFixture.addFileToProject(".sonderrignore", "ignored/\n")
        val manager = FileEditorManager.getInstance(project)
    ...
    fun `test gather returns empty when setting is off`() {
        SonderrPluginSettings.setAutoEditorContext(false)
