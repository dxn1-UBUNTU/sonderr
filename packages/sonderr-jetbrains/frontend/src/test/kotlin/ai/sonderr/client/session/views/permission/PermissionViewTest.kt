...
import ai.sonderr.client.session.views.tool.FileLinkLabel
...
class PermissionViewTest : BasePlatformTestCase() {
    ...
    override fun setUp() {
        super.setUp()
        SonderrPluginSettings.unsetPermissionRulesExpanded()
        view = PermissionView(
    ...
    fun `test rules expansion persists for new view`() {
        ...
        view.rulesForTest().toggle()
        assertTrue(SonderrPluginSettings.getPermissionRulesExpanded())
