 ...
 */
class SonderrBundleLocaleTest : BasePlatformTestCase() {
    ...
    private fun load(locale: String): Properties {
        val name = if (locale == "en") "/messages/SonderrBundle.properties" else "/messages/SonderrBundle_$locale.properties"
    ...
    private companion object {
        ...
        val PLAIN = listOf(
            ...
            "action.Sonderr.NewSession.toolbar",
            "action.Sonderr.NewWorktree.toolbar",
        )
    }
}
