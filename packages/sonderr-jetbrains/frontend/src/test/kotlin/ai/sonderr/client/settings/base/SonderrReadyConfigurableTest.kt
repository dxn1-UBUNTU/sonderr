...
class SonderrReadyConfigurableTest : BasePlatformTestCase() {
    ...
    fun `test disconnected shows unavailable and does not create ready component`() {
        ...
        edt {
            val text = text(root)
            assertTrue(text, text.contains(SonderrBundle.message("settings.cli.unavailable.title")))
            assertTrue(text, text.contains(SonderrBundle.message("settings.cli.unavailable.message")))
    ...
    fun `test ready transition creates ready component once`() {
        ...
        rpc.state.value = SonderrAppStateDto(SonderrAppStatusDto.READY)
        ...
        edt {
            ...
            assertFalse(text(root).contains(SonderrBundle.message("settings.cli.unavailable.title")))
        }
    }
