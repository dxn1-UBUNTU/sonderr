...
import ai.sonderr.client.session.ui.PickerRow
...
import ai.sonderr.client.ui.list.ActiveListActive
...
import ai.sonderr.client.ui.list.ACTIVE_LIST_CHANGES_CELL
import ai.sonderr.client.ui.list.ACTIVE_LIST_MENU_CELL
...
class SettingsListViewTest : BasePlatformTestCase() {
    ...
    fun `test changes badge is hit tested with cursor tooltip and action`() {
        edt {
            ...
            assertEquals(SonderrBundle.message("worktree.stats.tooltip", 0, 0, 3, 2), view.list.getToolTipText(event(view.list, center(area))))
