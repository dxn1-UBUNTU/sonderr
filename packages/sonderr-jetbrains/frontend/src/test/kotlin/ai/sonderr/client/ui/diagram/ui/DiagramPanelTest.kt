...
class DiagramPanelTest {
    ...
    fun `test block copies fence text and offers copy plus open in editor`() {
        ...
        assertTrue(buttons.any { it.toolTipText == SonderrBundle.message("diagram.open") })
        assertTrue(buttons.any { it.toolTipText == SonderrBundle.message("session.copy.hover") })
