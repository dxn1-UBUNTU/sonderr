...
import ai.sonderr.client.session.history.CloudHistoryItem
import ai.sonderr.client.session.history.HistoryController
import ai.sonderr.client.session.history.HistoryDataKeys
import ai.sonderr.client.session.history.HistorySelection
import ai.sonderr.client.session.history.HistorySource
...
import ai.sonderr.rpc.dto.CloudSessionDto
...
class HistorySessionActionsTest : BasePlatformTestCase() {
    ...
    override fun setUp() {
        ...
        sessions = SonderrSessionService(project, coroutines.scope, rpc)
    ...
    fun `test frontend descriptor registers history actions`() {
        val xml = javaClass.classLoader.getResourceAsStream("sonderr.jetbrains.frontend.xml")
            ?.bufferedReader()
            ?.use { it.readText() }
            ?: error("missing frontend descriptor")

        assertTrue(xml.contains("id=\"Sonderr.Session.Open\""))
        assertTrue(xml.contains("id=\"Sonderr.Session.Rename\""))
        assertTrue(xml.contains("id=\"Sonderr.Session.Delete\""))
        assertTrue(xml.contains("id=\"Sonderr.Worktree.Rename\""))
        assertTrue(xml.contains("id=\"Sonderr.Worktree.Delete\""))
        assertTrue(xml.contains("id=\"Sonderr.Worktree.OpenPr\""))
        assertTrue(xml.contains("id=\"Sonderr.Worktree.OpenDiff\""))
        assertTrue(xml.contains("id=\"Sonderr.WorktreeSession.Rename\""))
        assertTrue(xml.contains("id=\"Sonderr.WorktreeSession.Delete\""))
        assertTrue(xml.contains("id=\"Sonderr.Worktree.RowMenu\""))
        assertTrue(xml.contains("id=\"Sonderr.WorktreeSession.RowMenu\""))
        assertTrue(xml.contains("id=\"Sonderr.History.ContextMenu\""))
        assertTrue(xml.contains("id=\"Sonderr.Session.ContextMenu\""))
        assertTrue(xml.contains("ref=\"Sonderr.Session.Open\""))
        assertTrue(xml.contains("ref=\"Sonderr.Session.Rename\""))
        assertTrue(xml.contains("ref=\"Sonderr.Session.Delete\""))
        assertTrue(xml.contains("ref=\"Sonderr.Worktree.Rename\""))
        assertTrue(xml.contains("ref=\"Sonderr.Worktree.Delete\""))
        assertTrue(xml.contains("ref=\"Sonderr.Worktree.OpenPr\""))
        assertTrue(xml.contains("ref=\"Sonderr.Worktree.OpenDiff\""))
        assertTrue(xml.contains("ref=\"Sonderr.WorktreeSession.Rename\""))
        assertTrue(xml.contains("ref=\"Sonderr.WorktreeSession.Delete\""))
        assertTrue(xml.contains("ref=\"${'$'}Copy\""))

        // Row menu order: rename, (separator), open pr, open diff, (separator), delete.
        val rename = xml.indexOf("ref=\"Sonderr.Worktree.Rename\"")
        val openPr = xml.indexOf("ref=\"Sonderr.Worktree.OpenPr\"")
        val openDiff = xml.indexOf("ref=\"Sonderr.Worktree.OpenDiff\"")
        val delete = xml.indexOf("ref=\"Sonderr.Worktree.Delete\"")
