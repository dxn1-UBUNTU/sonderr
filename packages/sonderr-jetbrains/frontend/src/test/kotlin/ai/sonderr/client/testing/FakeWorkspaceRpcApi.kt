...
/**
 * Fake [SonderrWorkspaceRpcApi] for testing.
 *
 ...
 */
class FakeWorkspaceRpcApi : SonderrWorkspaceRpcApi {

    var directory = "/test"
    val state = MutableStateFlow(SonderrWorkspaceStateDto(SonderrWorkspaceStatusDto.PENDING))
    var resolveCalls = 0
        private set
    var reloads = 0
        private set
    ...
    var openResult = true
    var localConfigPath = "/test/.sonderr/sonderr.jsonc"
    var globalConfigPath = "/config/sonderr.jsonc"
