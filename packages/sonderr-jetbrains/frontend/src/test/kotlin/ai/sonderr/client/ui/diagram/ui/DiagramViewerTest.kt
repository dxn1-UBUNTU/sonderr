...
import ai.sonderr.client.ui.diagram.Rect
...
class DiagramViewerTest : BasePlatformTestCase() {
    ...
    fun `test overlay stacks zoom controls and copy in one column`() = edtWait {
        ...
        assertEquals(
            listOf(
                SonderrBundle.message("diagram.zoom.in"),
                SonderrBundle.message("diagram.zoom.out"),
                SonderrBundle.message("diagram.zoom.fit"),
                SonderrBundle.message("diagram.copy"),
            ),
    ...
    fun `test copy puts the whole diagram on the clipboard as a picture`() = edtWait {
        ...
        buttons(viewer).single { it.toolTipText == SonderrBundle.message("diagram.copy") }.doClick()
