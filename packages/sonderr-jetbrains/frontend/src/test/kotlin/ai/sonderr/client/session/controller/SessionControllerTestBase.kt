...
/**
 * Base class for [ai.sonderr.client.session.controller.SessionController] tests.
 *
...
abstract class SessionControllerTestBase : BasePlatformTestCase() {
    ...
    protected data class Snapshot(
        ...
        val diff: List<ai.sonderr.rpc.dto.DiffFileDto>,
        val todos: List<ai.sonderr.rpc.dto.TodoDto>,
        val compacted: Int,
    ) {
    ...
    override fun setUp() {
        ...
        workspaces = SonderrWorkspaceService(scope, projectRpc)
    ...
    protected fun controller(
        ...
        val m = SessionController(
            ...
            timers = timers,
            log = log ?: SonderrLog.create(SessionController::class.java),
        )
        controllers.add(m)
        roots[m] = root
        return m
    ...
    protected fun assertQuestionReply(expected: String, replies: List<Triple<String, String, ai.sonderr.rpc.dto.QuestionReplyDto>>) {
    ...
    protected fun workspaceReady(
        ...
        connected: List<String> = listOf("sonderr"),
        defaults: Map<String, String> = emptyMap(),
    ) = SonderrWorkspaceStateDto(
