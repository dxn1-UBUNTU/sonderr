 ...
 */
@Rpc
interface SonderrRunRpcApi : RemoteApi<Unit> {
    companion object {
        suspend fun getInstance(): SonderrRunRpcApi =
            RemoteApiProviderService.resolve(remoteApiDescriptor<SonderrRunRpcApi>())
    }
