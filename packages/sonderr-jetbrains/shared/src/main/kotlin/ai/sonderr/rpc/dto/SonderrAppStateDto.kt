...
@Serializable
enum class SonderrAppStatusDto {
    DISCONNECTED,
    DOWNLOADING,
    CONNECTING,
    LOADING,
...
@Serializable
data class ProfileSonderrPassDto(
...
data class ProfileDto(
    ...
    val sonderrPass: ProfileSonderrPassDto? = null,
...
@Serializable
data class SonderrAppStateDto(
    val status: SonderrAppStatusDto,
