...
object LogConfig {
    ...
    const val LEVEL_PROPERTY = "sonderr.dev.log.level"
    const val CONTENT_PROPERTY = "sonderr.dev.log.chat.content"
    const val PREVIEW_PROPERTY = "sonderr.dev.log.chat.preview.max"
