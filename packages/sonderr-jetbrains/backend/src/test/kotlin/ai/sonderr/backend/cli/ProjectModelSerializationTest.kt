...
import ai.sonderr.jetbrains.api.model.AppSkills200ResponseInner
import ai.sonderr.jetbrains.api.model.Command
import ai.sonderr.jetbrains.api.model.ProviderList200Response
...
class ProjectModelSerializationTest {
    ...
    fun `provider list with isFree and status`() {
        ...
        assertEquals(
            ai.sonderr.jetbrains.api.model.Model.Status.BETA,
            model.status,
        )
    }
