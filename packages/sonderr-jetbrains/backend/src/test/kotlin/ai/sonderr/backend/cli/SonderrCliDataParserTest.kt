...
import ai.sonderr.rpc.dto.AgentConfigPatchDto
import ai.sonderr.rpc.dto.CompactionPatchDto
import ai.sonderr.rpc.dto.ConfigDto
import ai.sonderr.rpc.dto.ConfigPatchDto
import ai.sonderr.rpc.dto.ConfigUpdateDto
import ai.sonderr.rpc.dto.EditorContextDto
...
import ai.sonderr.rpc.dto.PermissionRuleDto
import ai.sonderr.rpc.dto.ModelSelectionDto
import ai.sonderr.rpc.dto.ModelStateDto
import ai.sonderr.rpc.dto.PartSourceDto
import ai.sonderr.rpc.dto.PartSourceTextDto
import ai.sonderr.rpc.dto.PromptDto
import ai.sonderr.rpc.dto.PromptPartDto
import ai.sonderr.rpc.dto.QuestionReplyDto
import ai.sonderr.rpc.dto.SessionChangeKindDto
import ai.sonderr.rpc.dto.SkillsPatchDto
import ai.sonderr.rpc.dto.WatcherPatchDto
...
/**
 * Pure unit tests for [SonderrCliDataParser].
 *
 ...
 */
class SonderrCliDataParserTest {
    ...
    inner class SseEvents {
        ...
        fun `extractEventType - parses type from JSON data`() {
            val result = SonderrCliDataParser.extractEventType(
        ...
        fun `extractEventType - returns unknown for missing type`() {
            assertEquals("unknown", SonderrCliDataParser.extractEventType("""{"data":"something"}"""))
        }

        @Test
        fun `extractEventType - returns unknown for empty string`() {
            assertEquals("unknown", SonderrCliDataParser.extractEventType(""))
        }
        ...
        fun `parseChatEvent - message updated with GlobalEvent wrapper`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("message.updated", data)
        ...
        fun `parseChatEvent - message part delta`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("message.part.delta", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - message part updated`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("message.part.updated", data)
            assertNotNull(result)
        ...
        fun `ChatEventNormalizer - user part updated sanitizes text`() {
            val norm = SonderrCliDataParser.ChatEventNormalizer()
        ...
        fun `parseChatEvent - todowrite part parses typed todo metadata`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("message.part.updated", data) as ChatEventDto.PartUpdated
        ...
        fun `parseChatEvent - turn open`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("session.turn.open", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - turn close`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("session.turn.close", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session error`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("session.error", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session error preserves nested named error details`() {
            val data = globalEvent("""
                ...
                "properties": {
                    ...
                    "error": {
                        "name": "UnknownError",
                        "data": {
                            "message": "Cannot find module '@sonderr/plugin' from '/workspace/.sonderr/tool/github-triage.ts'",
                            "ref": "err_123"
                        }
                    }
                }
            ...
            assertEquals("Cannot find module '@sonderr/plugin' from '/workspace/.sonderr/tool/github-triage.ts'", result.error?.message)
        ...
        fun `parseChatEvent - message removed`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("message.removed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - message part removed`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("message.part.removed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session idle`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            val result = SonderrCliDataParser.parseChatEvent("session.idle", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session compacted`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            val result = SonderrCliDataParser.parseChatEvent("session.compacted", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session queue changed`() {
            ...
            """)
            val result = SonderrCliDataParser.parseChatEvent("session.queue.changed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session updated`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("session.updated", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session created`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("session.created", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session diff`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("session.diff", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session diff clamps large counts`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("session.diff", data) as ChatEventDto.SessionDiffChanged
        ...
        fun `parseChatEvent - todo updated`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("todo.updated", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session status idle`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("session.status", data) as ChatEventDto.SessionStatusChanged
        ...
        fun `parseChatEvent - permission asked`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("permission.asked", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - permission replied`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("permission.replied", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question asked`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("question.asked", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question replied`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("question.replied", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question rejected`() {
            ...
            val result = SonderrCliDataParser.parseChatEvent("question.rejected", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - unknown type returns null`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            assertNull(SonderrCliDataParser.parseChatEvent("some.unknown.event", data))
        }

        @Test
        fun `parseChatEvent - malformed JSON returns null`() {
            assertNull(SonderrCliDataParser.parseChatEvent("message.updated", "not json"))
        }

        @Test
        fun `parseChatEvent - missing properties returns null`() {
            assertNull(SonderrCliDataParser.parseChatEvent("message.updated", """{"payload":{"type":"x"}}"""))
        }
        ...
        fun `parseChatEvent - missing sessionID returns null`() {
            ...
            """)
            assertNull(SonderrCliDataParser.parseChatEvent("message.updated", data))
        }
        ...
        fun `parseSessionStatus - valid status event`() {
            ...
            val result = SonderrCliDataParser.parseSessionStatus(data)
            assertNotNull(result)
        ...
        fun `parseSessionStatus - missing sessionID returns null`() {
            ...
            assertNull(SonderrCliDataParser.parseSessionStatus(data))
        }
        ...
        fun `parseSessionChange - created carries the session directory`() {
            val data = sessionLifecycle("session.created", "ses_new", "/repo/.sonderr/worktrees/feature", "Fix the bug")
            val result = SonderrCliDataParser.parseSessionChange("session.created", data)
            assertNotNull(result)
            assertEquals("ses_new", result.id)
            assertEquals("/repo/.sonderr/worktrees/feature", result.directory)
            assertEquals(SessionChangeKindDto.CREATED, result.kind)
        }

        @Test
        fun `parseSessionChange - updated and deleted map to their kinds`() {
            val updated = SonderrCliDataParser.parseSessionChange(
                "session.updated",
                sessionLifecycle("session.updated", "ses_1", "/repo", "Renamed"),
            )
            val deleted = SonderrCliDataParser.parseSessionChange(
                "session.deleted",
        ...
        fun `parseSessionChange - falls back to the info id when sessionID is absent`() {
            ...
            """)
            assertEquals("ses_from_info", SonderrCliDataParser.parseSessionChange("session.created", data)?.id)
        }
        ...
        fun `parseSessionChange - ignores unrelated types and unusable payloads`() {
            // Wrong event type.
            assertNull(
                SonderrCliDataParser.parseSessionChange(
                    "session.status",
            ...
            // Malformed JSON.
            assertNull(SonderrCliDataParser.parseSessionChange("session.created", "not json"))
        }
        ...
        fun `parsePermissionRequests - parses list`() {
            ...
            val result = SonderrCliDataParser.parsePermissionRequests(raw)
        ...
        fun `parsePermissionRequests - empty list`() {
            assertEquals(emptyList(), SonderrCliDataParser.parsePermissionRequests("[]"))
        }
        ...
        fun `parseQuestionRequests - parses list`() {
            ...
            val result = SonderrCliDataParser.parseQuestionRequests(raw)
            assertEquals(1, result.size)
    ...
    inner class HttpResponses {
        ...
        fun `parseConfig - local mcp server`() {
            val cfg = SonderrCliDataParser.parseConfig(
        ...
        fun `parseConfig - disabled mcp form remains present`() {
            val cfg = SonderrCliDataParser.parseConfig("""{"mcp":{"sample":{"enabled":false}}}""")
            val mcp = cfg.mcp["sample"]
        ...
        fun `parseConfig - scalars instructions and skills`() {
            val cfg = SonderrCliDataParser.parseConfig(
                """{
                    ...
                    "skills":{"paths":[".sonderr/skills"],"urls":["https://example.test/skill.md"]}
                }"""
            )
            ...
            assertEquals(listOf(".sonderr/skills"), cfg.skills?.paths)
        ...
        fun `parseConfig - malformed body returns empty config`() {
            assertEquals(ConfigDto(), SonderrCliDataParser.parseConfig("not json"))
            assertEquals(ConfigDto(), SonderrCliDataParser.parseConfig("[]"))
        }
            ...
            val cfg = SonderrCliDataParser.parseConfig(
                """{
                    ...
                    "mcp":{
                        "sample":{
                            "type":"local",
                            "command":["node",".sonderr/mcp/sample-server.js"],
                            "environment":{"TOKEN":"x"},
                            "enabled":true,
                            "timeout":12000
                        }
        ...
        fun `parseSession - full session response`() {
            ...
            val result = SonderrCliDataParser.parseSession(raw)
        ...
        fun `parseSession - reads the share url`() {
            ...
            assertEquals("https://app.kilo.ai/s/tok", SonderrCliDataParser.parseSession(raw).share?.url)
        }
        ...
        fun `parseSession - ignores a blank or absent share url`() {
            ...
            assertNull(SonderrCliDataParser.parseSession(session(""", "share": { "url": "" }""")).share)
            assertNull(SonderrCliDataParser.parseSession(session(""", "share": {}""")).share)
        }
        ...
        fun `parseMessages - empty array`() {
            assertEquals(emptyList(), SonderrCliDataParser.parseMessages("[]"))
        }
        ...
        fun `parseMessages - user and assistant messages`() {
            ...
            val result = SonderrCliDataParser.parseMessages(raw)
        ...
        fun `parseMessages - preserves synthetic and source metadata`() {
            ...
            val result = SonderrCliDataParser.parseMessages(raw).single()
        ...
        fun `parseMessages - step finish part with tokens`() {
            ...
            val part = SonderrCliDataParser.parseMessages(raw)[0].parts[0]
        ...
        fun `parseMessages - malformed JSON returns empty`() {
            assertEquals(emptyList(), SonderrCliDataParser.parseMessages("not json"))
        }
        ...
        fun `parseCloudSessions maps cloud session list`() {
            ...
            val result = SonderrCliDataParser.parseCloudSessions(raw)
        ...
        fun `parseCloudSessions tolerates malformed response`() {
            assertEquals(emptyList(), SonderrCliDataParser.parseCloudSessions("not json").sessions)
            assertNull(SonderrCliDataParser.parseCloudSessions("{}").nextCursor)
        }
        ...
        fun `parseProviders - maps provider id, name, source, connected, and defaults`() {
            ...
            val result = SonderrCliDataParser.parseProviders(raw)
        ...
        fun `parseProviders - maps model capabilities, limit, and recommendedIndex`() {
            ...
            val provider = SonderrCliDataParser.parseProviders(raw).providers[0]
        ...
        fun `parseProviders - maps model preview metadata`() {
            val raw = """{
                "all": [{
                    "id": "sonderr", "name": "Sonderr", "source": "api", "env": [], "options": {},
                    "models": {
                        "auto": {
                            "id": "auto",
                            "name": "Sonderr Auto",
            ...
            val model = SonderrCliDataParser.parseProviders(raw).providers.single().models.getValue("auto")
        ...
        fun `parseProviders - malformed optional preview metadata is ignored`() {
            ...
            val model = SonderrCliDataParser.parseProviders(raw).providers.single().models.getValue("m")
        ...
        fun `parseProviders - orders variants by effort rank then name`() {
            ...
            val model = SonderrCliDataParser.parseProviders(raw).providers[0].models["m"]
            assertNotNull(model)
        ...
        fun `parseProviders - missing collections default to empty`() {
            val result = SonderrCliDataParser.parseProviders("""{"all":[],"default":{},"connected":[]}""")
        ...
        fun `parseProviderSettingsProviders - preserves provider metadata and unknown fields`() {
            ...
            val result = SonderrCliDataParser.parseProviderSettingsProviders(raw)
        ...
        fun `parseProviderSettingsProviders - malformed metadata becomes null`() {
            ...
            val provider = SonderrCliDataParser.parseProviderSettingsProviders(raw).first.single()
        ...
        fun `parseProviders - throws for malformed JSON`() {
            assertFailsWith<Exception> {
                SonderrCliDataParser.parseProviders("not json")
            }
        }
        ...
        fun `parseProviders - throws for non-object JSON`() {
            assertFailsWith<Exception> {
                SonderrCliDataParser.parseProviders("""[1,2,3]""")
            }
        }
        ...
        fun `parseProviderAuth - maps structured select options`() {
            ...
            val prompt = SonderrCliDataParser.parseProviderAuth(raw).getValue("azure").single().prompts.single()
        ...
        fun `parseCommands - maps name, description, source, and hints`() {
            ...
            val result = SonderrCliDataParser.parseCommands(raw)
        ...
        fun `parseCommands - empty array`() {
            assertEquals(emptyList<CommandInfo>(), SonderrCliDataParser.parseCommands("[]"))
        }
        ...
        fun `parsePathState - extracts state from valid path response`() {
            val raw = """{"home":"/home/user","state":"/home/user/.local/state/sonderr","config":"/home/user/.config/sonderr","worktree":"/project","directory":"/project"}"""
            assertEquals("/home/user/.local/state/sonderr", SonderrCliDataParser.parsePathState(raw))
            assertEquals("/home/user/.config/sonderr", SonderrCliDataParser.parsePathConfig(raw))
            assertEquals("/home/user", SonderrCliDataParser.parsePathHome(raw))
        }

        @Test
        fun `parsePathState - returns null for missing state field`() {
            assertNull(SonderrCliDataParser.parsePathState("""{"home":"/home/user"}"""))
        }

        @Test
        fun `parsePathState - returns null for malformed JSON`() {
            assertNull(SonderrCliDataParser.parsePathState("not json"))
        }

        @Test
        fun `parsePathState - returns null for non-string state value`() {
            assertNull(SonderrCliDataParser.parsePathState("""{"state":42}"""))
            assertNull(SonderrCliDataParser.parsePathState("""{"state":null}"""))
            assertNull(SonderrCliDataParser.parsePathState("""{"state":{}}"""))
        }
    }
    ...
    inner class RequestBuilders {
        ...
        fun `buildPromptJson - text only`() {
            ...
            val result = SonderrCliDataParser.buildPromptJson(prompt)
        ...
        fun `buildProviderOAuthJson - numeric method index`() {
            val result = SonderrCliDataParser.buildProviderOAuthJson("0", mapOf("deploymentType" to "github.com"))
        ...
        fun `buildCommandJson - file part includes source metadata`() {
            ...
            val result = SonderrCliDataParser.buildCommandJson("review", "", prompt)
        ...
        fun `buildCommandJson - includes agent variant model and arguments`() {
            ...
            val result = SonderrCliDataParser.buildCommandJson("review", "src/", prompt)

            assertEquals(
                """{"command":"review","arguments":"src/","agent":"code","variant":"high","model":"sonderr/gpt-5"}""",
                result,
            )
        }
        ...
        fun `buildSummarizeJson - writes provider and model`() {
            val result = SonderrCliDataParser.buildSummarizeJson(ModelSelectionDto("anthropic", "claude-4"))
        ...
        fun `buildRevertJson - writes message only`() {
            val result = SonderrCliDataParser.buildRevertJson("m1", null)
            assertEquals("""{"messageID":"m1"}""", result)
        }

        @Test
        fun `buildRevertJson - writes message and part`() {
            val result = SonderrCliDataParser.buildRevertJson("m1", "p1")
            assertEquals("""{"messageID":"m1","partID":"p1"}""", result)
        }

        @Test
        fun `buildRevertJson - escapes ids`() {
            val result = SonderrCliDataParser.buildRevertJson("m\"\\1", "p\"\\1")
        ...
        fun `buildConfigPartial - model only`() {
            val result = SonderrCliDataParser.buildConfigPartial(ConfigUpdateDto(model = "anthropic/claude-4"))
            assertEquals("""{"model":"anthropic/claude-4"}""", result)
        }

        @Test
        fun `buildConfigPartial - agent and temperature`() {
            val result = SonderrCliDataParser.buildConfigPartial(
        ...
        fun `buildConfigPartial - empty update`() {
            val result = SonderrCliDataParser.buildConfigPartial(ConfigUpdateDto())
            assertEquals("{}", result)
        }
        ...
        fun `buildConfigPatch - top-level model set`() {
            ...
            assertEquals("{\"model\":\"anthropic/claude\"}", SonderrCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - top-level model clear emits null`() {
            val patch = ConfigPatchDto(values = linkedMapOf("model" to null))
            assertEquals("{\"model\":null}", SonderrCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - small and subagent values`() {
            val patch = ConfigPatchDto(values = linkedMapOf("small_model" to "sonderr/auto-small", "subagent_model" to null, "subagent_variant" to null))
            assertEquals("{\"small_model\":\"sonderr/auto-small\",\"subagent_model\":null,\"subagent_variant\":null}", SonderrCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - per-agent model set`() {
            val patch = ConfigPatchDto(agents = linkedMapOf("code" to AgentConfigPatchDto(model = "sonderr/gpt-5")))
            assertEquals("{\"agent\":{\"code\":{\"model\":\"sonderr/gpt-5\"}}}", SonderrCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - per-agent model clear emits null`() {
            ...
            assertEquals("{\"agent\":{\"code\":{\"model\":null}}}", SonderrCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - per-agent description patch does not clear model`() {
            ...
            assertEquals("{\"agent\":{\"code\":{\"description\":\"New description\"}}}", SonderrCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - agent behavior top-level fields`() {
            val patch = ConfigPatchDto(
                ...
                skills = SkillsPatchDto(paths = listOf(".sonderr/skills"), urls = listOf("https://example.com/skill")),
            )

            assertEquals(
                "{\"default_agent\":\"build\",\"instructions\":[\"AGENTS.md\"],\"skills\":{\"paths\":[\".sonderr/skills\"],\"urls\":[\"https://example.com/skill\"]}}",
                SonderrCliDataParser.buildConfigPatch(patch),
            )
        }
        ...
        fun `buildConfigPatch - full agent permission object`() {
            ...
            assertEquals(
                "{\"agent\":{\"custom\":{\"model\":\"sonderr/gpt-5\",\"mode\":\"primary\",\"hidden\":false,\"temperature\":0.2,\"top_p\":0.9,\"steps\":12,\"permission\":{\"bash\":{\"*\":\"ask\",\"npm test\":\"allow\"},\"read\":null}}}}",
                SonderrCliDataParser.buildConfigPatch(patch),
            )
        }
        ...
        fun `buildConfigPatch - empty patch`() {
            assertEquals("{}", SonderrCliDataParser.buildConfigPatch(ConfigPatchDto()))
        }

        @Test
        fun `buildConfigPatch - escapes special characters`() {
            val patch = ConfigPatchDto(values = linkedMapOf("model" to "sonderr/a\\b\"c"))
            assertEquals("{\"model\":\"sonderr/a\\\\b\\\"c\"}", SonderrCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPartial - temperature without agent defaults to ask`() {
            val result = SonderrCliDataParser.buildConfigPartial(ConfigUpdateDto(temperature = 0.5))
        ...
        fun `buildPermissionReplyJson - once reply`() {
            val result = SonderrCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "once"))
            assertEquals("""{"reply":"once"}""", result)
        }

        @Test
        fun `buildPermissionReplyJson - always reply with message`() {
            val result = SonderrCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "always", message = "approved"))
        ...
        fun `buildPermissionReplyJson - interactive reply serializes interactive true`() {
            ...
            val result = SonderrCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "once", interactive = true))
        ...
        fun `buildPermissionReplyJson - non-interactive reply omits the interactive field`() {
            val result = SonderrCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "once", interactive = false))
        ...
        fun `buildPermissionAlwaysRulesJson - approved list`() {
            val result = SonderrCliDataParser.buildPermissionAlwaysRulesJson(
        ...
        fun `buildQuestionReplyJson - single question single answer`() {
            val result = SonderrCliDataParser.buildQuestionReplyJson(QuestionReplyDto(answers = listOf(listOf("A"))))
            assertEquals("""{"answers":[["A"]]}""", result)
        }

        @Test
        fun `buildQuestionReplyJson - multiple questions`() {
            val result = SonderrCliDataParser.buildQuestionReplyJson(
        ...
        fun `parseModelState - parses favorites`() {
            val result = SonderrCliDataParser.parseModelState(
                """{"favorite":[{"providerID":"sonderr","modelID":"auto"},{"providerID":"openai","modelID":"gpt"}]}""",
            )
            assertEquals(listOf("sonderr/auto", "openai/gpt"), result.favorite.map { "${it.providerID}/${it.modelID}" })
        }
        ...
        fun `parseModelState - parses model selections and variants`() {
            val result = SonderrCliDataParser.parseModelState(
                """{"model":{"code":{"providerID":"sonderr","modelID":"auto"}},"variant":{"sonderr/auto":"medium"}}""",
            )
            assertEquals("sonderr", result.model["code"]?.providerID)
            assertEquals("auto", result.model["code"]?.modelID)
            assertEquals("medium", result.variant["sonderr/auto"])
        }

        @Test
        fun `parseModelState - drops malformed favorites`() {
            val result = SonderrCliDataParser.parseModelState(
                """{"favorite":[{"providerID":"sonderr"},false,{"providerID":"openai","modelID":"gpt"}]}""",
            )
        ...
        fun `parseModelState - malformed inputs return empty favorites`() {
            for (raw in listOf("", "not-json", "[]", "42", "null")) {
                assertTrue(SonderrCliDataParser.parseModelState(raw).favorite.isEmpty(), raw)
            }
        }
        ...
        fun `parseModelState - drops malformed model selections and variants`() {
            val result = SonderrCliDataParser.parseModelState(
                """{"model":{"bad":false,"ok":{"providerID":"sonderr","modelID":"auto"}},"variant":{"":"low","sonderr/auto":false,"openai/gpt":"high"}}""",
            )
        ...
        fun `buildModelStateJson - preserves unrelated keys and replaces favorites`() {
            val raw = """{"model":{"code":{"providerID":"sonderr","modelID":"auto"}},"recent":[{"providerID":"old","modelID":"recent"}],"variant":{"sonderr/auto":"fast"},"extra":true,"favorite":[]}"""
            val result = SonderrCliDataParser.buildModelStateJson(raw, listOf(ModelSelectionDto("anthropic", "claude")))
            ...
            assertEquals(listOf("anthropic/claude"), SonderrCliDataParser.parseModelState(result).favorite.map { "${it.providerID}/${it.modelID}" })
        }

        @Test
        fun `buildModelStateJson - writes model selections and variants`() {
            val raw = """{"recent":[],"extra":true}"""
            val result = SonderrCliDataParser.buildModelStateJson(
                raw,
                ModelStateDto(
                    model = mapOf("code" to ModelSelectionDto("sonderr", "auto")),
                    variant = mapOf("sonderr/auto" to "medium"),
                    recent = listOf(ModelSelectionDto("anthropic", "claude")),
                ),
            )

            val state = SonderrCliDataParser.parseModelState(result)
            assertEquals("auto", state.model["code"]?.modelID)
            assertEquals("medium", state.variant["sonderr/auto"])
    ...
    fun `sanitizeUserPromptText - removes read payload lines`() {
        ...
        assertEquals("before\nafter", SonderrCliDataParser.sanitizeUserPromptText(text))
    }
    ...
    fun `sanitizeUserPromptText - preserves ordinary prose without path key`() {
        ...
        assertEquals(text, SonderrCliDataParser.sanitizeUserPromptText(text))
    }
    ...
    fun `sanitizeUserPromptText - collapses only blanks introduced by payload removal`() {
        ...
        assertEquals("before\n\nafter\n\n\nkeep", SonderrCliDataParser.sanitizeUserPromptText(text))
    }
