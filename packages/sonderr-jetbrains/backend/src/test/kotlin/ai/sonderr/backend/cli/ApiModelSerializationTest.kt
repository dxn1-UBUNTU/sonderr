...
import ai.sonderr.jetbrains.api.infrastructure.Serializer
import ai.sonderr.jetbrains.api.model.Config
import ai.sonderr.jetbrains.api.model.GlobalHealth200Response
import ai.sonderr.jetbrains.api.model.SonderrNotifications200ResponseInner
import ai.sonderr.jetbrains.api.model.SonderrNotifications200ResponseInnerAction
import ai.sonderr.jetbrains.api.model.SonderrProfile200Response
import ai.sonderr.jetbrains.api.model.SonderrProfile200ResponseBalance
import ai.sonderr.jetbrains.api.model.SonderrProfile200ResponseProfile
import ai.sonderr.jetbrains.api.model.SonderrProfile200ResponseProfileOrganizationsInner
...
class ApiModelSerializationTest {
    ...
    @Test
    fun `SonderrNotifications200ResponseInner with action`() {
        val src = """{
            "id": "notif-1",
        ...
        val obj = json.decodeFromString<SonderrNotifications200ResponseInner>(src)
    ...
    @Test
    fun `SonderrNotifications200ResponseInner without action`() {
    ...
    @Test
    fun `SonderrNotifications200ResponseInner with showIn and suggestModelId`() {
        val src = """{
            "id": "n3",
            "title": "Try new model",
    ...
    fun `empty notifications array`() {
        val list = json.decodeFromString<List<SonderrNotifications200ResponseInner>>("[]")
        assertTrue(list.isEmpty())
    }

    @Test
    fun `SonderrProfile200Response with balance`() {
        val src = """{
        ...
        val obj = json.decodeFromString<SonderrProfile200Response>(src)
    ...
    @Test
    fun `SonderrProfile200Response with null balance`() {
        val src = """{
    ...
    @Test
    fun `SonderrProfile200Response with organizations`() {
        val src = """{
            "profile": {
                "email": "user@test.com",
                "organizations": [
    ...
    @Test
    fun `SonderrProfile200Response with sonderr pass`() {
        val src = """{
            "profile": {"email": "user@test.com"},
        ...
        val obj = json.decodeFromString<SonderrProfile200Response>(src)
        assertNotNull(obj.sonderrPass)
        assertEquals(199.0, obj.sonderrPass!!.currentPeriodBaseCreditsUsd)
        assertEquals(73.27, obj.sonderrPass!!.currentPeriodUsageUsd)
        assertEquals(99.5, obj.sonderrPass!!.currentPeriodBonusCreditsUsd)
        assertEquals("2026-07-01T00:00:00.000Z", obj.sonderrPass!!.nextBillingAt)
    }
