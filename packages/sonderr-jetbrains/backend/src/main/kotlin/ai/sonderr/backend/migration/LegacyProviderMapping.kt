...
/**
 * Port of packages/sonderr-vscode/src/legacy-migration/provider-mapping.ts
 *
...
val PROVIDER_MAP: Map<String, ProviderMapping> = mapOf(
    ...
    "sonderr" to ProviderMapping(id = "sonderr", key = "sonderrToken", name = "Sonderr (Gateway)", modelField = "sonderrModel", organizationIdField = "sonderrOrganizationId"),
