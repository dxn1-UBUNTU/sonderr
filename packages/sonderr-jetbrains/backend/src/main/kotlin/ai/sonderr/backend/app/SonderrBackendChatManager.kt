 ...
 * calls [start] after [SonderrAppState.Ready] and [stop] on disconnect.
 *
 * All JSON parsing is delegated to [SonderrCliDataParser].
 */
class SonderrBackendChatManager(
    ...
    private var normalizer = SonderrCliDataParser.ChatEventNormalizer()
    ...
    fun start(http: OkHttpClient, port: Int, sse: SharedFlow<SseEvent>) {
        ...
        watcher = cs.launch {
            sse.collect { event ->
                val type = if (event.type in CHAT_EVENTS) event.type else SonderrCliDataParser.extractEventType(event.data)
    ...
    fun stop() {
        ...
        client = null
        base = null
        normalizer = SonderrCliDataParser.ChatEventNormalizer()
    ...
    suspend fun enhancePrompt(dir: String, text: String): String {
        ...
        val url = requireBase()
        val body = SonderrCliDataParser.buildEnhancePromptJson(text)
        ...
        return call.await().use { response ->
            ...
            SonderrCliDataParser.parseEnhancedPrompt(raw)
        }
    }
    ...
    fun prompt(id: String, dir: String, prompt: PromptDto) {
        ...
        val body = SonderrCliDataParser.buildPromptJson(prompt)
    ...
    fun command(id: String, dir: String, command: String, args: String, prompt: PromptDto) {
        ...
        val body = SonderrCliDataParser.buildCommandJson(command, args, prompt)
    ...
    fun compact(id: String, dir: String, model: ModelSelectionDto) {
        ...
        val http = requireClient()
        val url = requireBase()
        val body = SonderrCliDataParser.buildSummarizeJson(model)
        val request = Request.Builder()
    ...
    suspend fun revert(id: String, dir: String, message: String, part: String?) {
        ...
        val body = SonderrCliDataParser.buildRevertJson(message, part)
    ...
    fun messages(id: String, dir: String): List<MessageWithPartsDto> {
        ...
        return http.newCall(request).execute().use { response ->
            ...
            val parsed = SonderrCliDataParser.parseMessages(raw)
    ...
    fun updateConfig(dir: String, update: ConfigUpdateDto) {
        ...
        val partial = SonderrCliDataParser.buildConfigPartial(update)
    ...
    fun replyPermission(requestId: String, dir: String, reply: PermissionReplyDto) {
        ...
        val body = SonderrCliDataParser.buildPermissionReplyJson(reply)
    ...
    fun savePermissionRules(requestId: String, dir: String, rules: PermissionAlwaysRulesDto) {
        ...
        val body = SonderrCliDataParser.buildPermissionAlwaysRulesJson(rules)
    ...
    fun replyQuestion(requestId: String, dir: String, answers: QuestionReplyDto) {
        ...
        val body = SonderrCliDataParser.buildQuestionReplyJson(answers)
    ...
    fun pendingPermissions(dir: String): List<PermissionRequestDto> {
        ...
        val parsed = SonderrCliDataParser.parsePermissionRequests(raw)
    ...
    fun pendingQuestions(dir: String): List<QuestionRequestDto> {
        ...
        val parsed = SonderrCliDataParser.parseQuestionRequests(raw)
