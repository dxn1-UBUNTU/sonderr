...
/**
 * OkHttp implementation of [LegacyMigrationBackend] against `sonderr serve`.
 *
 ...
 * constraints getting in the way. Mirrors the pattern in SonderrBackendChatManager.
 *
...
class LegacyMigrationHttpBackend(
    ...
    override fun importProject(project: JsonObject): String {
        ...
        val url = "$base/sonderr/session-import/project?directory=${encode(dir)}"
    ...
    override fun importSession(session: JsonObject): LegacyImportResult {
        ...
        val url = "$base/sonderr/session-import/session?directory=${encode(dir)}"
    ...
    override fun importMessage(message: JsonObject) {
        ...
        val url = "$base/sonderr/session-import/message?sessionID=${encode(sessionId)}"
    ...
    override fun importPart(part: JsonObject) {
        ...
        val url = "$base/sonderr/session-import/part?sessionID=${encode(sessionId)}"
