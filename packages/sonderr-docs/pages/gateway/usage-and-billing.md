---
title: "Usage & Billing"
description: "Understand how the Sonderr AI Gateway tracks costs, manages balances, and enforces organization-level spending controls."
---

# Usage & Billing

The Sonderr AI Gateway tracks usage and costs for every request with microdollar precision (1 USD = 1,000,000 microdollars). This enables accurate billing even for very low-cost requests.
...
- **BYOK requests**: When using your own API key, the cost is set to $0 on Sonderr's side. You pay the provider directly based on your agreement with them

## Balance management

Model inference is deducted from your balance at the upstream provider's rate with no markup. A 5% payment-processing fee applies when you purchase Sonderr credits; the fee is charged separately and does not increase your balance. For example, $1 of purchased credits funds $1 of usage.

### Individual accounts

Your account balance is the difference between total credits purchased and total usage. Check your balance in the [Sonderr dashboard](https://app.kilo.ai).
