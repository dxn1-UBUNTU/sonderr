---
title: "API Reference"
description: "Complete API reference for the Sonderr AI Gateway, including chat completions, FIM completions, and model listing endpoints."
---

# API Reference

The Sonderr AI Gateway provides an OpenAI-compatible API. All endpoints use the base URL:
