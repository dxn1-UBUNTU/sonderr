...
const terminalContent = {
  installation: (
    <>
      <span className="terminal-comment"># Install Sonderr VS Code Extension</span>
      {"\n"}
      <span className="terminal-prompt">$</span> code --install-extension sonderr.sonderr-code
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Or install via CLI</span>
      {"\n"}
      <span className="terminal-prompt">$</span> npm install -g @sonderr/cli
    </>
  ),
  gateway: (
    <>
      <span className="terminal-comment"># Call Sonderr Gateway with a quick curl script</span>
      {"\n"}
      <span className="terminal-prompt">$</span> export SONDERR_API_KEY="YOUR_API_KEY"
      {"\n"}
      ...
      {`  -d '{"model":"anthropic/claude-sonnet-4.5","messages":[{"role":"user","content":"Say hi from Sonderr Gateway"}]}'`}
    </>
  ),
  firstTask: (
    <>
      <span className="terminal-comment"># Start a new task with Sonderr</span>
      {"\n"}
      <span className="terminal-prompt">$</span> sonderr "Create a React component for a user profile"
      {"\n"}
      {"\n"}
      <span className="terminal-comment">
        # Or for interactive sessions, just run the Sonderr CLI in your project folder
      </span>
      {"\n"}
      <span className="terminal-prompt">$</span> sonderr
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Run in architect mode for planning</span>
      {"\n"}
      <span className="terminal-prompt">$</span> sonderr --mode architect "Design a REST API"
    </>
  ),
  customRules: (
    <>
      ...
      {"\n"}
      <span className="terminal-prompt">$</span> touch .sonderr/rules/rules.md
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Or use the CLI to add rules</span>
      {"\n"}
      <span className="terminal-prompt">$</span> sonderr rules add "Always use TypeScript"
      {"\n"}
      <span className="terminal-prompt">$</span> sonderr rules add "Follow React best practices"
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># List all active rules</span>
      {"\n"}
      <span className="terminal-prompt">$</span> sonderr rules list
    </>
  ),
}
...
const categories = [
  {
    title: "Get Started",
    description: "Install Sonderr and get up and running in minutes",
  ...
  {
    title: "Code with AI",
    description: "Learn how to use Sonderr to write, edit, and understand code",
    href: "/code-with-ai",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Sonderr for Teams", href: "/collaborate" },
  ...
  {
    title: "Contributing",
    description: "Help improve Sonderr and learn about its architecture",
    href: "/contributing",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <path
...
export default function HomePage() {
  ...
  return (
    <div className="homepage">
      <Head>
        <title>Sonderr Docs: Setup, Models, MCP, Custom Modes & CLI</title>
      </Head>
      ...
      <section className="hero">
        <div className="hero-content">
          <h1 className="hero-title">Sonderr Documentation</h1>
          <p className="hero-subtitle">
            Explore guides and examples for the Sonderr platform — from coding agents and AI-powered development to
            automation and hosted agentic infrastructure.
          </p>
          <div className="hero-buttons">
            <Link href="/getting-started" className="btn btn-primary">
              Get started with Sonderr →
            </Link>
            <Link href="/gateway" className="btn btn-secondary">
              Explore Sonderr Gateway
            </Link>
          </div>
        </div>
        ...
        <div className="quick-panel">
          <div className="quick-section">
            <h3 className="quick-title">SONDERR CODE</h3>
      ...
      <section className="terminal-section">
        <div className="terminal-intro">
          ...
          <p className="terminal-description">Get started quickly with Sonderr and Sonderr Gateway</p>
        </div>
        ...
        <div className="footer-grid">
          ...
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/Sonderr-Org/sonderr/releases" className="footer-link">
                Changelog
              </Link>
            </div>
          </div>
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/Sonderr-Org/sonderr/issues" className="footer-link">
                Report an issue
              </Link>
            </div>
          </div>
