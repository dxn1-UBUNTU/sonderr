---
title: "Using ZenMux with Sonderr | Unified AI Gateway"
description: "Access OpenAI, Anthropic, Google, and other AI models through ZenMux in Sonderr with automatic routing and cost optimization."
sidebar_label: ZenMux
---

# Using ZenMux With Sonderr
...
3. **Configure in Sonderr:** Add your API key to Sonderr settings.
...
- Check the [Sonderr GitHub repository](https://github.com/Sonderr-Org/sonderr) for integration-specific issues
