---
title: "Using Inception Labs with Sonderr"
description: "Connect Inception Labs' Mercury diffusion LLMs to Sonderr for ultra-fast code generation. Setup guide for VS Code and the CLI."
sidebar_label: Inception
---

# Using Inception With Sonderr
...
3. **Create a Key:** Click "Create new API key". Give your key a descriptive name (e.g., "Sonderr").
4. **Copy the Key:** **Important:** Copy the API key _immediately_. You will not be able to see it again. Store it securely.

## Supported Models

Sonderr supports Inception's available models. Model selection and capabilities may vary based on your account tier.
...
- **Docs Feedback:** Report documentation issues at [Sonderr-Org/sonderr issues](https://github.com/Sonderr-Org/sonderr/issues/new?title=Documentation%20Issue:%20/docs/ai-providers/inception).
