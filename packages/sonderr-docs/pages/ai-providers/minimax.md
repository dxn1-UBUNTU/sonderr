---
title: "Using MiniMax with Sonderr"
description: "Configure MiniMax AI models in Sonderr. Guide to getting an API key and setup for VS Code and the CLI."
sidebar_label: MiniMax
---

# Using MiniMax With Sonderr
...
3. **Create a Key:** Click to generate a new API key and give it a descriptive name (e.g., "Sonderr").
