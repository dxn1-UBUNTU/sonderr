---
title: "Using Anthropic Claude with Sonderr"
description: "Configure Anthropic's Claude models in Sonderr. Guide to getting an API key, setting up Claude Sonnet and Opus in VS Code and the CLI."
sidebar_label: Anthropic
---

# Using Anthropic With Sonderr
...
3.  **Create a Key:** Click "Create Key". Give your key a descriptive name (e.g., "Sonderr").
