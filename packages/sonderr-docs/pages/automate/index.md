---
title: "Automate"
description: "Automate your development workflows with Sonderr"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend Sonderr's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect Sonderr to external tools and services:
...
- [**Using MCP in Sonderr**](/docs/automate/mcp/using-in-sonderr-code) — Configuration guide
...
Connect Sonderr with your development tools:
...
Customize and extend Sonderr's capabilities:
...
2. Configure [MCP servers](/docs/automate/mcp/using-in-sonderr-code) for external integrations
