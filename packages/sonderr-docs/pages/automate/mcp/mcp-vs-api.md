...
## Why Sonderr Uses MCP

Sonderr leverages MCP to provide:
...
MCP creates a universal connector between Sonderr and external services, with REST APIs often powering those services behind the scenes.
