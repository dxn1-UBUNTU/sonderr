...
Sonderr implements the Model Context Protocol to:
...
- [Using MCP in Sonderr](using-in-sonderr-code) - Get started with MCP in Sonderr, including creating simple servers
