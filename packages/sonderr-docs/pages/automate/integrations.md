---
title: "Integrations"
description: "Overview of Sonderr integrations"
---

# Sonderr Integrations

Sonderr Integrations lets you connect GitHub or GitLab for repository workflows and DoltHub for Dolt-versioned data. Once connected, Sonderr can access authorized resources securely, enabling features like **Code Reviews**, **Cloud Agents**, **Sonderr Deploy**, and data workflows through **Sonderr Connect**.
...
- **Connect GitHub, GitLab, or DoltHub to Sonderr** in a few clicks
- **Enable advanced features** like Cloud Agents, Code Reviews, and Sonderr Deploy
- **Authorize GitHub or GitLab repository access** so Sonderr can analyze and work with your code
...
- For GitHub: You need permission to install GitHub Apps for the repositories you want Sonderr to access.
...
2. You'll be redirected to GitHub to authorize the **SonderrConnect** App.
3. Select the GitHub account or organization you want to connect.

### 3. Choose Repository Access

GitHub will ask which repositories you want Sonderr to access:
...
- You'll return to the Sonderr Integrations page.
- GitHub will show a **Connected** status.
- Your Sonderr workspace can now access GitHub repositories securely.
...
4. You'll be redirected back to Sonderr with the connection active
...
4. In Sonderr, go to the GitLab integration page
...
> PAT tokens cannot be refreshed automatically. When your token expires, create a new one in GitLab and reconnect in Sonderr.
...
Use the DoltHub integration page to connect your DoltHub account. Sonderr uses this OAuth connection for [Sonderr Connect](/docs/code-with-ai/platforms/sonderr-connect) and as the default auth method for [Gas Town Wasteland](/docs/code-with-ai/gastown/wasteland).
...
3. Approve Sonderr on DoltHub.
4. Return to Sonderr and confirm DoltHub shows a **Connected** status.

{% image src="/docs/img/integrations/dolthub/connect.png" alt="DoltHub integration page before OAuth connection" width="900" caption="DoltHub integration page in Sonderr" /%}

{% image src="/docs/img/integrations/dolthub/authorize.png" alt="DoltHub OAuth authorization screen for Sonderr" width="700" caption="DoltHub OAuth authorization screen" /%}
...
Once your integrations are connected, the following features are enabled in Sonderr:

### Cloud Agents

- Run Sonderr in the cloud from any device
...
- Deploy Next.js 14 & 15 apps directly from Sonderr
...
- Update which repositories Sonderr has access to
...
> Disconnecting from Sonderr does not revoke OAuth tokens on GitLab's side. You can manually revoke them from **GitLab → User Settings → Applications → Authorized Applications**.
...
- Disconnect DoltHub from Sonderr
...
Ensure the SonderrConnect App is installed for the correct GitHub org and that repo access includes the repositories you need.
...
- **PAT**: Create a new token in GitLab and reconnect in Sonderr.
