---
title: Semantic Search Tool | Sonderr Docs
...
- When Sonderr needs to find code related to specific functionality across your project
...
- When implementing a new feature, Sonderr searches for "authentication middleware" to understand existing patterns before writing new code.
- When debugging an issue, Sonderr searches for "error handling in API calls" to find related error patterns across the codebase.
- When refactoring code, Sonderr searches for "database transaction patterns" to ensure consistency across all database operations.
- When onboarding to a new codebase, Sonderr searches for "configuration loading" to understand how the application bootstraps.
