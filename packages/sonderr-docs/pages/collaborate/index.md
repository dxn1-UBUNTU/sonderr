---
title: "Collaborate"
description: "Work together with Sonderr team features"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Sonderr makes it easy to work together with your team. Share sessions, manage team settings, and track AI adoption across your organization.
{% /callout %}

## Sessions & Sharing

Sessions are your platform-agnostic interaction with Sonderr. They remember your repository, task, and conversation so you can pause and resume work without losing context.

- [**Sessions & Sharing**](/docs/collaborate/sessions-sharing) — Share and collaborate on Sonderr sessions
...
Sonderr's paid plans provide powerful team management features:
