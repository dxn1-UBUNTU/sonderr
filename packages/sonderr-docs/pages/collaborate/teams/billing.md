...
Sonderr seats use a transparent, two-part billing system: a monthly subscription per seat, plus pay-as-you-go Sonderr credits. Model inference is charged at provider rates with no markup. A separate 5% payment-processing fee applies when you purchase credits.

{% callout type="note" %}

Sonderr seats purchases of Teams or Enterprise are separate from Sonderr credits.

No Sonderr credits are included with a Teams or Enterprise purchase.
...
Organization Owners can purchase Sonderr credits on the [Organization dashboard](https://app.kilo.ai).

Organization credits are purchased on behalf of all users in the organization. Every member of the organization can use the credits in the organization's balance with the Sonderr model provider.
...
Organization members can use organization credits by choosing the correct organization profile in the dropdown in the Profiles tab of the Sonderr extension.
...
In order to add Members to your Sonderr Organization, you must have seat(s) available for them.
...
## Sonderr Pass for Organizations

Organizations can subscribe to [Sonderr Pass](https://kilo.ai/pricing/sonderr-pass) at the organization level, pooling the subscription's credit capacity across the team instead of each member holding a personal Sonderr Pass. Personal Sonderr Pass subscriptions stay separate and are not affected.
...
- **Pooled credits** — each service window's Sonderr Pass credits are issued to the organization's pool rather than to individuals.
...
Organization owners and billing managers can purchase Sonderr Pass, manage allocations, and cancel from your organization's **Subscriptions** page on the [Organization dashboard](https://app.kilo.ai). Cancellation takes effect at the end of the current paid period. Regular members do not see these controls.
...
Ensure your team has uninterrupted access to Sonderr by enabling [Automatic Top-Up](https://kilo.ai/features/auto-top-ups). This feature keeps your organization's balance funded so you never have to worry about manual recharges. Auto top-up is also available for individual accounts — see [Adding Credits](/docs/getting-started/adding-credits) for details.
...
- **Automatic Thresholds** — Once enabled, Sonderr will automatically recharge your balance whenever it falls below $50.00.
...
Invoices for any payment on the Sonderr platform, for seats or credits, will be available in the Invoices tab.
