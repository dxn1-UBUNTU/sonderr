---
title: "About Plans"
description: "Overview of Sonderr plans and pricing"
---

# About Plans

Sonderr accelerates development with AI-driven code generation and task automation. You can use Sonderr as an open source extension in VS Code or JetBrains IDEs.
...
Sonderr's paid plans, Teams and Enterprise, are the solution for these organizations.

{% callout type="note" %}

Purchases of Sonderr's paid plans are separate from model provider credits.

No credits are included with a Teams or Enterprise plan purchase.

{% /callout %}

## What You Get from Sonderr Teams
...
## What You Get from Sonderr Enterprise
