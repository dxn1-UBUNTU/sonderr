...
**Action:** Install the Sonderr CLI to enable AI-assisted terminal workflows:
...
**Action:** Use [Sonderr Deploy](/docs/deploy-secure/deploy) to spin up live URLs for branches, allowing your team to verify changes before merging.
...
Most teams start with Code mode and stop there. But Sonderr's other modes unlock additional value.
...
4. Consider Sonderr Deploy to validate AI output
