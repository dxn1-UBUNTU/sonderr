---
title: "Installation"
description: "How to install Sonderr on your system"
---

# Installation

Get started with Sonderr by installing it on your preferred platform. Choose your development environment below:
...
The current Sonderr extension is built on the [Sonderr CLI](https://github.com/Sonderr-Org/sonderr) and is distributed as the **pre-release version** on the VS Code Marketplace.
...
For VS Code-compatible editors like VSCodium, Gitpod, Eclipse Theia, and Windsurf, you can browse and install directly from the [Sonderr page on Open VSX Registry](https://open-vsx.org/extension/sonderr/Sonderr-Code).
...
4. Search for "Sonderr"
5. Select "Sonderr" and click **Install**
...
1. **Download the VSIX file:**
   - Find official releases on the [Sonderr GitHub Releases page](https://github.com/Sonderr-Org/sonderr/releases)
   - Download the `.vsix` file from the [latest release](https://github.com/Sonderr-Org/sonderr/releases/latest)
...
1. Open the [Sonderr GitHub Releases page](https://github.com/Sonderr-Org/sonderr/releases)
...
{% image src="/docs/img/installing-vsix.png" alt="Installing Sonderr using VS Code's Install from VSIX dialog" width="600px" caption="Installing Sonderr using VS Code's \"Install from VSIX\" dialog" /%}
...
- Restart VS Code
- Verify Sonderr is listed and enabled in Extensions
- Try disabling and re-enabling the extension in Extensions
- Check Output panel for errors (View → Output, select "Sonderr")
...
2. **[Run your first task](/docs/getting-started/quickstart)** — Learn how to chat with Sonderr to complete tasks
...
- Submit issues on [GitHub](https://github.com/Sonderr-Org/sonderr/issues)
