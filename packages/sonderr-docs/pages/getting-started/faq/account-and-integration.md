...
description: "Questions about accounts and integrations in Sonderr"
tocDepth: 2
---

# Account and Integration

This section contains questions about accounts and integrations in Sonderr.
...
This process involves removing the **Sonderr Connect** application from your GitHub account settings.
...
2. Find **Sonderr Connect** in the list of installed applications
3. Click **Configure** next to Sonderr Connect
4. From the configuration page, you can either:
   - **Uninstall** the integration completely, or
   - **Edit** which repositories are connected

{% callout type="tip" %}
If you'd like to reconnect GitHub later, simply open your Sonderr profile, go to **Integrations**, and connect GitHub again.
{% /callout %}
