...
description: "Configure Sonderr and connect to your AI providers"
---

# Authentication

When you install Sonderr, you'll be prompted to sign in or create a free account. This automatically configures everything you need to get started. You can sign in with your email address, Google, Apple, GitHub, GitLab, Discord, LinkedIn, or Anaconda, or through your organization's single sign-on.

## Quick Start with Sonderr Account

{% tabs %}
{% tab label="VS Code" %}

The extension prompts you to sign in when you first open Sonderr in VS Code. Click **Sign In** and complete the browser-based flow. Sign-in applies across extension surfaces, including the sidebar and Agent Manager.
...
[Add credits to your account](https://app.kilo.ai/profile), or sign up for [Sonderr Pass](https://kilo.ai/pricing/sonderr-pass).
{% /callout %}

## Sonderr Gateway API Key

If you're using the [Sonderr AI Gateway](/docs/gateway/) outside of the Sonderr extension (for example, with the Vercel AI SDK or OpenAI SDK), you'll need an API key:
...
If you prefer to use your own API key or existing subscription, Sonderr supports **over 30 providers**. Here are some popular options to get started:
...
These are just a few examples! Sonderr supports many more providers including Google Gemini, DeepSeek, Mistral, Ollama (for local models), AWS Bedrock, Google Vertex, and more. See the complete list at [AI Providers](/docs/ai-providers/).
{% /callout %}

### ChatGPT Plus/Pro Subscription

Already have a ChatGPT subscription? You can use it with Sonderr through the [OpenAI ChatGPT provider](/docs/ai-providers/openai-chatgpt-plus-pro)—no API key needed.
...
These settings apply across the extension, including the sidebar and Agent Manager. Agent Manager does not need separate provider or Sonderr CLI authentication setup.
...
Or use `sonderr auth login` for providers that support OAuth, such as GitHub Copilot or ChatGPT Plus/Pro.
