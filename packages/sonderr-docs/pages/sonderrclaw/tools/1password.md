...
description: "Connect your SonderrClaw agent to 1Password to securely manage credentials"
---
...
Connect your SonderrClaw agent to 1Password to securely manage credentials. This allows your agent to fetch API keys or passwords without ever seeing them in plain text.
...
2. Create a **New Vault** (e.g., name it `Sonderr-Agent-Vault`).
...
## Step 3: Configure SonderrClaw

1. Navigate to your SonderrClaw dashboard: [app.kilo.ai/claw](https://app.kilo.ai/claw).
