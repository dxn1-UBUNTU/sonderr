...
description: "Connect a GitHub account to your SonderrClaw agent for repository access"
---
...
Connect a GitHub account to your SonderrClaw agent so it can clone repositories, push commits, open pull requests, and leave code reviews — all autonomously.
...
SonderrClaw uses a [fine grained Personal Access Token](https://github.com/settings/tokens?type=beta) to authenticate as your bot. When creating the token, use these settings:

| Setting | Recommended Value |
|---|---|
| **Token name** | `sonderrclaw-bot` (or any descriptive name) |
...
### Step 3: Enter credentials in SonderrClaw
...
SonderrClaw accepts both GitHub token formats:
...
When your instance starts, SonderrClaw automatically:
...
- Tokens are encrypted at rest using SonderrClaw's secret management system
