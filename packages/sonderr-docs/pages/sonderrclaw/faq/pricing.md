---
title: "Pricing"
description: "Pricing details for SonderrClaw instances and model inference"
---
...
SonderrClaw uses Sonderr Gateway credits by default — if you route requests through BYOK, model usage is billed directly by your provider instead.
...
To see which models are currently free, check the [Sonderr Leaderboard](https://kilo.ai/leaderboard#all-models) — free models are marked accordingly.

## Adding Credits

You can add Gateway credits from your [Sonderr account](https://app.kilo.ai). Credits are shared across all Sonderr products (VSCode extension, CLI, Cloud Agents, and SonderrClaw).
