---
title: "Discord"
description: "Use SonderrClaw with Discord: setup, DM access control, and channel configuration"
---
...
This page covers everything you need to use SonderrClaw with Discord: connecting your bot, controlling who can DM it, and adding it to specific channels.

## Connecting SonderrClaw to Discord

Create a bot in the Discord Developer Portal and link it to your SonderrClaw dashboard.
...
2. Copy the token that appears and paste it into the **Discord Bot Token** field in your SonderrClaw dashboard.

{% image src="/docs/img/sonderrclaw/discord.png" alt="Connect account screen" width="800" caption="Discord bot token entry" /%}

Enter the token in the Settings tab and click **Save**. You can remove or replace a configured token at any time.

## Redeploy to Apply Changes

After saving your token, click **Redeploy** (the yellow button at the top of the SonderrClaw dashboard) to apply the changes. The server will restart in about 30–45 seconds. Wait for the redeploy to complete before pairing.
...
## Restricting SonderrClaw to DMs Only (Just You)

By default, SonderrClaw will respond to any DMs. To lock it down to only DMs with you:
...
## Adding SonderrClaw to a Specific Discord Channel

By default, your SonderrClaw will not respond in channels, even if added. To have SonderrClaw participate in a specific channel:
