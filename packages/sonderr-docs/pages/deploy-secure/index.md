---
title: "Deploy & Secure"
description: "Deploy applications and manage security with Sonderr"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Deploy your applications directly from Sonderr and manage security with AI-powered reviews and scans.
{% /callout %}
