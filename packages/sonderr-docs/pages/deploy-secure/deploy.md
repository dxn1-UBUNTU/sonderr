---
title: "Deploy"
description: "Deploy your applications with Sonderr"
---

# Deploy

Sonderr Deploy lets you ship **Next.js** and **static sites** directly from Sonderr, with:

- **One-click deployment** from the Sonderr dashboard
...
2. Click **Configure** and follow the prompts to connect GitHub to Sonderr
...
Sonderr Deploy does **not** include built-in database hosting, but you can connect to any external database service.

---

## Environment Variables

Sonderr Deploy supports Environment Variables and Secrets. Add the variable **key** and **value** during the **Create New Deployment** step, and toggle to mark as secrets.
