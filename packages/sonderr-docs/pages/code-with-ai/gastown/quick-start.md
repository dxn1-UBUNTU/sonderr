...
- A [Sonderr account](https://app.kilo.ai) (free tier works)
...
Gastown uses the [Sonderr GitHub App](https://github.com/apps/sonderr-code) to access your repository. You'll be prompted to install it if you haven't already.
