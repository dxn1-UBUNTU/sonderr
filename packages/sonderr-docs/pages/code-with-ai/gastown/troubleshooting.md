...
**Fix:**
1. Check that the [Sonderr GitHub App](https://github.com/apps/sonderr-code) is installed on your repository
...
| Cause | Fix |
|---|---|
| GitHub App uninstalled | Reinstall at [github.com/apps/sonderr-code](https://github.com/apps/sonderr-code) |
