---
title: "App Builder"
description: "Build complete applications with Sonderr"
---
...
Sonderr's **App Builder** lets you create end-to-end applications through natural language conversation. Describe what you want to build, watch it come to life in a real-time preview, and deploy directly from your Sonderr dashboard. No local environment setup required.
...
- You pay only for the AI model usage via Sonderr credits
...
1. Navigate to **[App Builder](https://app.kilo.ai/app-builder)** from your Sonderr dashboard.
