...
const mainNavItems: NavItem[] = [
  ...
  { label: "Sonderr Gateway", href: "/gateway" },
  { label: "SonderrClaw", href: "/sonderrclaw" },
  { label: "Contributing", href: "/contributing" },
]

const contributingItems: DropdownItem[] = [
  { label: "Contributing Guide", href: "/contributing", description: "How to contribute to Sonderr" },
  {
    label: "Code of Conduct",
    href: "https://github.com/Sonderr-Org/sonderr?tab=coc-ov-file",
    description: "Our community guidelines",
  },
  { label: "GitHub Repository", href: "https://github.com/Sonderr-Org/", description: "View source and issues" },
...
const helpItems: DropdownItem[] = [
  ...
  {
    label: "Changelog",
    href: "https://github.com/Sonderr-Org/sonderr/releases",
    ...
    <header className="top-header">
      ...
      <div className="top-bar">
        ...
        <Link href="/" className="logo-link flex gap-2 items-center">
          ...
          <div>
            <span className="logo-text font-brand">Sonderr</span>
      ...
      <div className="announcement-banner">
        <p>
          The all-new Sonderr extension is here, rebuilt on the{" "}
          <Link href="/code-with-ai/platforms/vscode/whats-new">Sonderr CLI</Link> for speed, flexibility, and continued
          access to 500+ models via the Sonderr Gateway →
        </p>
      </div>
