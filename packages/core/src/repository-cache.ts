...
export class Service extends Context.Service<Service, Interface>()("@sonderr/RepositoryCache") {}
          ...
          return yield* flock
            .withLock(
              Effect.gen(function* () {
                ...
                const root = yield* fs.existsSafe(path.join(localPath, ".git")) // sonderr_change - avoid Windows path spelling differences
                // sonderr_change start - canonicalize file remotes rewritten by Git on Windows
                const match =
