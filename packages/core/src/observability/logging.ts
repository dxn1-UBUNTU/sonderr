...
export function fileLogger(file = path.join(Global.Path.log, "sonderr.log"), id: string = runID) {
...
export function loggers() {
  return process.env.SONDERR_PRINT_LOGS === "1" ? [fileLogger(), stderrLogger] : [fileLogger()]
}
