...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@sonderr/llm"
...
export class Service extends Context.Service<Service, Interface>()("@sonderr/v2/ToolRegistry") {}
