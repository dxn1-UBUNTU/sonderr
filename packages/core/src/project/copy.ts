...
import { Event } from "@sonderr/schema/project-directories"
import { ProjectCopy } from "@sonderr/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@sonderr/ProjectCopy") {}
