...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@sonderr/schema/prompt"
import { Provider } from "@sonderr/schema/provider"
import { Project } from "@sonderr/schema/project"
import { ProjectDirectories } from "@sonderr/schema/project-directories"
import { PermissionV1 } from "@sonderr/schema/permission-v1"
...
import { Command } from "@sonderr/schema/command"
import { Connection } from "@sonderr/schema/connection"
import { Credential } from "@sonderr/schema/credential"
import { FileSystem } from "@sonderr/schema/filesystem"
import { Integration } from "@sonderr/schema/integration"
import { LLM } from "@sonderr/schema/llm"
import { Permission } from "@sonderr/schema/permission"
import { Plugin } from "@sonderr/schema/plugin"
import { Pty } from "@sonderr/schema/pty"
import { Reference } from "@sonderr/schema/reference"
import { SessionTodo } from "@sonderr/schema/session-todo"
import { Skill } from "@sonderr/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@sonderr/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@sonderr/core/command"),
    import("@sonderr/core/integration/connection"),
    import("@sonderr/core/credential"),
    import("@sonderr/core/filesystem"),
    import("@sonderr/core/integration"),
    import("@sonderr/core/location"),
    import("@sonderr/llm"),
    import("@sonderr/core/permission"),
    import("@sonderr/core/v1/permission"),
    import("@sonderr/core/project/copy"),
    import("@sonderr/core/pty"),
    import("@sonderr/core/project/schema"),
    import("@sonderr/core/reference"),
    import("@sonderr/core/session/input"),
    import("@sonderr/core/session/message"),
    import("@sonderr/core/session/todo"),
    import("@sonderr/core/session/prompt"),
    import("@sonderr/core/skill"),
    import("@sonderr/core/v2-schema"),
    import("@sonderr/core/schema"),
    import("@sonderr/core/workspace"),
  ])
