...
export function Select<T>(props: SelectProps<T> & Omit<ButtonProps, "children">) {
  ...
  return (
    ...
    <Kobalte<T, { category: string; options: T[] }>
      ...
      overlap={local.triggerVariant === "settings"} // sonderr_change
      fitViewport={local.triggerVariant === "settings"} // sonderr_change
      overflowPadding={local.triggerVariant === "settings" ? 12 : undefined} // sonderr_change
      gutter={4}
      value={local.current}
      options={grouped()}
