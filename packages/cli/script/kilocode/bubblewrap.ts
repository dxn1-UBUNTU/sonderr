...
const cache = process.env.SONDERR_BWRAP_CACHE ?? path.join(os.tmpdir(), "sonderr-bubblewrap", commit)
...
#define PACKAGE_STRING "bubblewrap ${version} for Sonderr"
...
Sonderr distributes Bubblewrap as a separate executable. The complete license text is
