...
export namespace TestCli {
  export const ENV = "SONDERR_TEST_CLI_PATH"
  ...
  async function fingerprint(root: string): Promise<string> {
    ...
    const ignored = new Set(["sonderr-vscode", "sonderr-jetbrains", "sonderr-docs"])
  ...
  export async function build(root: string, targetDir?: string) {
    ...
    const result = await Bun.build({
      ...
      external: ["node-gyp", "@opentui/core-*", "@sonderr/sonderr-memory", "@sonderr/sonderr-memory/*"],
