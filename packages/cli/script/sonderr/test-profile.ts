  ...
  const profiles = {
    darwin: {
      ...
      groups: {
        filesystem: [
          "filesystem/*.test.ts",
          "sonderr/{external-directory-boundary,read-directory}.test.ts",
        ...
        runtime: [
          ...
          "sonderr/cli/install-artifact.test.ts",
          "sonderr/cli/tui/thread.test.ts",
          "sonderr/core-watcher.test.ts",
          "sonderr/interactive-terminal.test.ts",
          "tool/shell.test.ts",
          "util/{process,which}.test.ts",
        ],
        sandbox: ["sonderr/sandbox/*.test.ts"],
      },
    },
  } as const
