...
import { parseModelsSnapshot } from "../src/sonderr/provider/models-snapshot-shape" // sonderr_change
...
const modelsUrl = process.env.SONDERR_MODELS_URL || "https://models.dev"
