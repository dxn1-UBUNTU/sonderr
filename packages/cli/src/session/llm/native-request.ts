import type { JsonSchema, LLMRequest, ProviderMetadata } from "@sonderr/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@sonderr/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @sonderr/llm request objects from sonderr's session/AI SDK-shaped data.
  return LLM.request({
