...
You are configured for high output capacity (up to 200,000 tokens per response). Use this for substantial code generation tasks:
...
The output limit is configured via `output_token_max` in `sonderr.json` (default: 200000). The UI handles large outputs — you do not need to worry about truncation.
