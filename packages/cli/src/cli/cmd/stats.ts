...
// sonderr_change start - expose Effect stats aggregation for Sonderr regression coverage
      ...
      Effect.gen(function* () {
        ...
        for (const message of messages) {
          if (message.info.role === "assistant") {
            // sonderr_change start - count propagated subagent cost once but keep child model stats (#6321)
            ...
            sessionModelUsage[modelKey].cost += cost // sonderr_change
