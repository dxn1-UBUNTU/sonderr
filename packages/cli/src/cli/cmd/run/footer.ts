...
import { SonderrKeymapProvider } from "@sonderr/tui/keymap"
import { RUN_COMMAND_PANEL_ROWS, RUN_SUBAGENT_PANEL_ROWS } from "./footer.command"
import { RUN_INTERACTIVE_TERMINAL_ROWS } from "@/sonderr/cli/cmd/run/interactive-terminal" // sonderr_change
...
export class RunFooter implements FooterApi {
  ...
  constructor(
    ...
    void render(
      () =>
        createComponent(SonderrKeymapProvider, {
