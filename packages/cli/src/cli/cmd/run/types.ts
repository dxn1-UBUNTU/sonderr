// Shared type vocabulary for the direct interactive mode (`sonderr --mini`).
//
...
import type { SonderrClient, PermissionRequest, QuestionRequest, ToolPart } from "@sonderr/sdk/v2"
import type { RunInteractiveTerminalSnapshot } from "@/sonderr/cli/cmd/run/types" // sonderr_change
import type { TuiConfig } from "@sonderr/tui/config"
...
type PromptModel = Parameters<SonderrClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<SonderrClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<SonderrClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<SonderrClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<SonderrClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<SonderrClient["experimental"]["resource"]["list"]>>["data"]>
...
export type FooterView =
  ...
  | { type: "interactive_terminal"; terminal: RunInteractiveTerminalSnapshot } // sonderr_change
...
export type PermissionReply = Parameters<SonderrClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<SonderrClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<SonderrClient["question"]["reject"]>[0]
