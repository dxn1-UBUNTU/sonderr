...
import type { Event, Part, PermissionRequest, QuestionRequest, ToolPart } from "@sonderr/sdk/v2" // sonderr_change - revert to upstream native Event type
...
export type SessionData = {
  ...
  terminal?: RunInteractiveTerminalSnapshot // sonderr_change
...
export function reduceSessionData(input: SessionDataInput): SessionDataOutput {
  ...
  // sonderr_change start - direct interactive mode terminal footer
