...
//
// The saved variant persists across sessions in ~/.local/state/sonderr/model.json // sonderr_change
...
class Service extends Context.Service<Service, VariantService>()("@sonderr/RunVariant") {}
