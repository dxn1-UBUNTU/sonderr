// Per-tool display rules shared across `sonderr run` output paths. // sonderr_change
//
...
import type { ToolPart } from "@sonderr/sdk/v2"
...
import type { InteractiveTerminalTool } from "@/sonderr/tool/interactive-terminal" // sonderr_change
...
type ToolDefs = {
  ...
  interactive_terminal: typeof InteractiveTerminalTool // sonderr_change
