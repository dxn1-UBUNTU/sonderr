...
import { MemoryEvents as Core } from "@sonderr/sonderr-memory/effect/events"
 ...
 * event sink to sonderr's Bus. The package stays free of the host event system until `install()`. */
