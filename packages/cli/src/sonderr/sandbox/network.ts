...
import { assertNetwork, assertSandbox, networkHttpLayer } from "@sonderr/sandbox"
import { host, opaque } from "./network-tools"

const Builtin = Symbol("sonderr.sandbox.builtinTool")
const Remote = Symbol("sonderr.sandbox.remoteMcp")
