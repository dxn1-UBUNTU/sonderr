 ...
 * prompts (plain `sonderr run`). Permission asks originating from their child
 ...
 */
export namespace SonderrHeadless {
  ...
  export const denies = Effect.fn("SonderrHeadless.denies")(function* (id: string) {
