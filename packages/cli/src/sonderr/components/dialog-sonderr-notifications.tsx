...
/**
 * Sonderr Notifications Dialog
 *
 * Displays all notifications from Sonderr API in a scrollable dialog.
...
interface DialogSonderrNotificationsProps {
  notifications: SonderrNotification[]
}

export function DialogSonderrNotifications(props: DialogSonderrNotificationsProps) {
