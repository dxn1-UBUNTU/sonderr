...
/**
 * Sonderr Gateway Organization Selection Dialog
 *
...
import { getOrganizationOptions, getDefaultOrganizationSelection } from "@sonderr/sonderr-gateway/tui"
...
interface DialogSonderrOrganizationProps {
...
export function DialogSonderrOrganization(props: DialogSonderrOrganizationProps) {
    ...
    <DialogSelect
      ...
      onSelect={async (option: any) => {
        try {
          ...
          await sdk.client.sonderr.organization.set({
