...
import type { SonderrProfile, SonderrBalance } from "@sonderr/sonderr-gateway"

interface DialogSonderrProfileProps {
  profile: SonderrProfile
  balance: SonderrBalance | null
  currentOrgId?: string | null
}

export function DialogSonderrProfile(props: DialogSonderrProfileProps) {
