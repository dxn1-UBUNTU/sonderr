...
import { fmtAttemptCost, fmtScore } from "@/sonderr/components/model-info-panel-utils"
import {
  aggregateMetrics,
  failed,
  formatCost,
  ...
  type StepMetrics,
  type UsageResult,
} from "@/sonderr/plugins/model-usage"
import { ModelRow, UsageRow } from "@/sonderr/plugins/sidebar-usage-row"

const id = "internal:sonderr-sidebar-usage"
