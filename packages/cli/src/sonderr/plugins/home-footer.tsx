...
/**
 * Sonderr-specific home footer plugin.
 *
...
const id = "internal:sonderr-home-footer"

// ---------------------------------------------------------------------------
// Sub-components (mirror upstream home/footer with sonderr additions)
// ---------------------------------------------------------------------------
...
function View(props: { api: TuiPluginApi }) {
  const sonderr = createMemo(() => props.api.state.provider.some((p) => p.id === "sonderr"))
