import type { SonderrSessionModelUsageResponse, Session, StepFinishPart } from "@sonderr/sdk/v2"

export type SessionModelUsage = SonderrSessionModelUsageResponse
...
// future i18n sweep only touches one file — the sonderr CLI does not yet
...
//
// When samples carry `elapsedMs` (sonderr_change: persisted on the
