...
import { invalidateAfterProviderAuthChange } from "@/sonderr/server/provider-auth-lifecycle"
...
export class Service extends Context.Service<Service, Interface>()("@sonderr/AnacondaDesktop") {}
