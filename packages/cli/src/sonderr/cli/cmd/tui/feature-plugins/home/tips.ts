...
export const SONDERR_TIPS: Tip[] = [
  ...
  "Create {highlight}sonderr.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.sonderr/command/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.sonderr/agent/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.sonderr/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.sonderr/plugins/{/highlight} for event hooks",
  ...
  "Create JSON theme files in {highlight}.sonderr/themes/{/highlight} directory",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/sonderr-org/sonderr{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with Sonderr Gateway for curated, tested models",
