...
type Client = {
  session: Pick<SonderrClient["session"], "get">
  terminal: Pick<SonderrClient["interactiveTerminal"], "write" | "resize" | "close">
}

export namespace SonderrRunTerminal {
  export function create(sdk: SonderrClient, session: () => string) {
