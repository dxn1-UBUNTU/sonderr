...
const TABLE_PATH = root + "packages/sonderr-docs/markdoc/partials/cli-commands-table.md"
const REFERENCE_PATH = root + "packages/sonderr-docs/pages/code-with-ai/platforms/cli-reference.md"
