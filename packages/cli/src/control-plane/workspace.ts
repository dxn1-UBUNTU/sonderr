...
import { WorkspaceEvent } from "@sonderr/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@sonderr/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        SONDERR_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        SONDERR_WORKSPACE_ID: config.id,
        SONDERR_EXPERIMENTAL_WORKSPACES: "true",
