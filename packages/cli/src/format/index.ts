...
export class Service extends Context.Service<Service, Interface>()("@sonderr/Format") {}
              ...
              const result = yield* appProcess
                .run(
                  ChildProcess.make(replaced[0]!, replaced.slice(1), {
                    cwd: dir,
                    env: modelEnv(item.environment), // sonderr_change - formatters must not inherit backend credentials
                    extendEnv: false, // sonderr_change
                    stdin: "ignore",
                    stdout: "ignore",
                    stderr: "ignore",
                  }),
