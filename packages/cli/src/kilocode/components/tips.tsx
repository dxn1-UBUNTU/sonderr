...
const TIPS = [
  ...
  "Sonderr can {highlight}configure itself{/highlight} if you ask it",
  "Ask Sonderr to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Sonderr to {highlight}create a review agent for this project{/highlight}",
  "Ask Sonderr to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Sonderr to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Sonderr to {highlight}make my review agent read-only{/highlight}",
  "Ask Sonderr to {highlight}require approval before git push{/highlight}",
  "Ask Sonderr to {highlight}turn off auto-formatting{/highlight}",
  "Ask Sonderr to {highlight}block access to .env files{/highlight}",
  "Ask Sonderr to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Sonderr to {highlight}match my terminal theme{/highlight}",
  "Ask Sonderr to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Sonderr to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Sonderr to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Sonderr to {highlight}save this workflow as a /command{/highlight}",
  "Sonderr auto-handles OAuth for remote MCP servers requiring auth",
  "Sonderr auto-formats files using prettier, gofmt, ruff, and more",
  "Sonderr uses LSP servers for intelligent code analysis",
