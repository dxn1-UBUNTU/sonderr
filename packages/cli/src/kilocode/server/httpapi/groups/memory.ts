...
import { MemoryContract } from "@sonderr/sonderr-memory/effect/httpapi"
...
import { MemoryApiClientError, MemoryApiServerError } from "@sonderr/sonderr-memory/effect/errors"
  ...
  .add(
    HttpApiGroup.make("memory")
      ...
      .annotateMerge(
        OpenApi.annotations({
          title: "memory",
          description: "Sonderr memory routes.",
        }),
      )
