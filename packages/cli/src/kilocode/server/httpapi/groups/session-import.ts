...
const root = "/sonderr/session-import"

const ResultSchema = Schema.Struct({
  ok: Schema.Boolean,
  id: Schema.String,
  skipped: Schema.optional(Schema.Boolean),
}).annotate({ identifier: "SonderrSessionImportResult" })
    ...
    HttpApiGroup.make("session-import")
      .add(
        HttpApiEndpoint.post("project", SessionImportPaths.project, {
          ...
          OpenApi.annotations({
            identifier: "sonderr.sessionImport.project",
        ...
        HttpApiEndpoint.post("session", SessionImportPaths.session, {
          ...
          OpenApi.annotations({
            identifier: "sonderr.sessionImport.session",
        ...
        HttpApiEndpoint.post("message", SessionImportPaths.message, {
          ...
          OpenApi.annotations({
            identifier: "sonderr.sessionImport.message",
        ...
        HttpApiEndpoint.post("part", SessionImportPaths.part, {
          ...
          OpenApi.annotations({
            identifier: "sonderr.sessionImport.part",
      ...
      .annotateMerge(
        OpenApi.annotations({
          ...
          description: "Sonderr legacy session import routes.",
        }),
      )
