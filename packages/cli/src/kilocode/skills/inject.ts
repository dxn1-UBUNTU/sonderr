...
import { SKILL_SHELL_DISABLED, SKILL_SHELL_UNTRUSTED } from "@/sonderr/skills/display"
...
// kill-switch (SONDERR_DISABLE_SKILL_SHELL), and one batch bash ask naming every command
