...
export namespace SonderrSessionRevert {
  ...
  export const apply = Effect.fn("SonderrSessionRevert.apply")(function* <A, E, R>(
  ...
  export const restore = Effect.fn("SonderrSessionRevert.restore")(function* (
    snap: Snapshot.Interface,
    hash: string,
    files: string[],
  ) {
