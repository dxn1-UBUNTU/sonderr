...
export namespace SonderrCostPropagation {
  /**
   ...
   */
  export const childCost = Effect.fn("SonderrCostPropagation.childCost")(function* (
   ...
   */
  export const propagate = Effect.fn("SonderrCostPropagation.propagate")(function* (
    sessions: Session.Interface,
    sid: SessionID,
    mid: MessageID,
    amount: number,
