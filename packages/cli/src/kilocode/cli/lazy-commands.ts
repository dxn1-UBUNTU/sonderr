...
export const RunCommand = lazy({
  command: "run [message..]",
  describe: "run sonderr with a message",
...
export const UpgradeCommand = lazy({
  ...
  describe: "upgrade sonderr to the latest or a specific version",
  load: async () => (await import("@/cli/cmd/upgrade")).UpgradeCommand,
})

export const UninstallCommand = lazy({
  command: "uninstall",
  describe: "uninstall sonderr and remove all related files",
