...
class StateService extends Context.Service<StateService, State>()("@sonderr/NotebookState") {}
...
export class Service extends Context.Service<Service, Interface>()("@sonderr/Notebook") {}
