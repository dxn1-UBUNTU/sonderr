/**
 * SonderrClaw chat slash-command autocomplete.
 *
 ...
 * with sonderrclaw's own `/new` for conversations.
 *
...
import { useBindings, useSonderrModeStack } from "@tui/keymap"
...
export function ClawAutocomplete(props: {
  ...
  useBindings(() => ({
    ...
    bindings: [
      { key: "up", desc: "Previous command", group: "SonderrClaw", cmd: () => move(-1) },
      { key: "ctrl+p", desc: "Previous command", group: "SonderrClaw", cmd: () => move(-1) },
      { key: "down", desc: "Next command", group: "SonderrClaw", cmd: () => move(1) },
      { key: "ctrl+n", desc: "Next command", group: "SonderrClaw", cmd: () => move(1) },
      { key: "escape", desc: "Hide autocomplete", group: "SonderrClaw", cmd: hide },
      { key: "return", desc: "Select command", group: "SonderrClaw", cmd: select },
      { key: "tab", desc: "Select command", group: "SonderrClaw", cmd: select },
      {
        key: "right",
        fallthrough: true,
        cmd: () => {
