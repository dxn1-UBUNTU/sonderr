...
/**
 * SonderrClaw TUI types — Sonderr Chat protocol.
 *
 * Mirrors `@sonderr/sonderr-chat` from the cloud monorepo. We carry our own
...
export type ClawStatus = {
  ...
  secretCount?: number
  userId?: string
  // User-chosen name for the SonderrClaw bot, set during onboarding via the
  ...
  // literal string "SonderrClaw" when null.
  botName?: string | null
}
