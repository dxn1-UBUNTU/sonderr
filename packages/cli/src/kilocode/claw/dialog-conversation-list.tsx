/**
 * Conversation selector for the SonderrClaw chat.
 *
...
export function DialogConversationList(props: Props) {
  ...
  return (
    <DialogSelect
      title="SonderrClaw Conversations"
      options={options()}
      ...
      actions={[
        ...
        {
          command: "sonderrclaw.conversation.new",
          title: "new",
          side: "right",
          onTrigger: async () => {
      ...
      bindings={[{ key: "ctrl+n", cmd: "sonderrclaw.conversation.new" }]}
    />
  )
}
