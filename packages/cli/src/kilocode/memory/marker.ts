...
import type { SonderrMemory } from "@sonderr/sonderr-memory/effect"
import { MemoryMarkerMeta } from "@sonderr/sonderr-memory/marker-meta"
...
export namespace MemoryMarker {
  ...
  export function fromBlocks(blocks: SonderrMemory.Block[]): Info | undefined {
