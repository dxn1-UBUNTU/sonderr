...
class StateService extends Context.Service<StateService, State>()("@sonderr/AgentManager.State") {}
...
export class Service extends Context.Service<Service, Interface>()("@sonderr/AgentManager") {}
