...
import { isIndexingPlugin } from "@sonderr/sonderr-indexing/detect"
import { ensureAtomicChatPlugin, isAtomicChatPlugin } from "@/sonderr/atomic-chat-feature"
import { ensureIndexingPlugin, INDEXING_PLUGIN } from "@/sonderr/indexing-feature"

type Log = {
  debug: (msg: string, data?: Record<string, unknown>) => void
}

export namespace SonderrDefaultPlugins {
