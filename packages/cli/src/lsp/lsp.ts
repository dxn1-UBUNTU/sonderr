...
import { TsClient } from "../sonderr/ts-client" // sonderr_change
import { NonNegativeInt } from "@sonderr/core/schema"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { LspEvent } from "@sonderr/schema/lsp-event"
...
export class Service extends Context.Service<Service, Interface>()("@sonderr/LSP") {}
    ...
    const getClients = Effect.fnUntraced(function* (file: string) {
      ...
      const clients = yield* Effect.promise(async () => {
        ...
        for (const server of Object.values(s.servers)) {
          ...
          // sonderr_change start - use lightweight tsgo-based client when persistent LSP is not enabled
