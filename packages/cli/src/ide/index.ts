...
import { IdeEvent } from "@sonderr/schema/ide-event"
...
export function alreadyInstalled() {
  return process.env["SONDERR_CALLER"] === "vscode" || process.env["SONDERR_CALLER"] === "vscode-insiders"
}

// sonderr_change start - Sonderr's VS Code extension bundles the CLI; auto-install from CLI is not applicable
