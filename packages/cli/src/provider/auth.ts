...
import type { AuthOAuthResult, Hooks } from "@sonderr/plugin"
import { serviceUse } from "@sonderr/core/effect/service-use"
import { Auth } from "@/auth"
import { InstanceState } from "@/effect/instance-state"
import { optional } from "@sonderr/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@sonderr/ProviderAuth") {}
...
const layer: Layer.Layer<Service, never, Auth.Service | Plugin.Service | ModelCache.Service> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const callback = Effect.fn("ProviderAuth.callback")(function* (
      ...
      // sonderr_change start - Update telemetry identity on Sonderr auth
...
export const node = LayerNode.make({ service: Service, layer: layer, deps: [Auth.node, Plugin.node, ModelCache.node] }) // sonderr_change
