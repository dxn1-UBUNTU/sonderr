...
export interface Interface {
  ...
  /**
   * Resolved truncation limits: values from `tool_output` in sonderr config, or MAX_LINES / MAX_BYTES if unset.
   */
  readonly limits: () => Effect.Effect<{ maxLines: number; maxBytes: number }>
}

export class Service extends Context.Service<Service, Interface>()("@sonderr/Truncate") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const cleanup = Effect.fn("Truncate.cleanup")(function* () {
      // sonderr_change start - use file mtimes because encoded IDs wrap
