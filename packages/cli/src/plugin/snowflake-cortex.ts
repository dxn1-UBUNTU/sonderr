...
import { SonderrOauthCallbackPage as OauthCallbackPage } from "@sonderr/core/sonderr/oauth/page" // sonderr_change - Sonderr-branded callback page
        ...
        return {
          ...
          async fetch(requestInput: RequestInfo | URL, init?: RequestInit) {
            ...
            const prepareRequest = () => {
              ...
              headers.set("User-Agent", `sonderr/${InstallationVersion}`)
      ...
      methods: [
        {
          ...
          async authorize(inputs = {}) {
            ...
            return {
              url,
              instructions:
                "Complete Snowflake sign-in in your browser. Sonderr will capture the OAuth callback and store the bearer token automatically.",
