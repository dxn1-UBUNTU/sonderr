...
export class Service extends Context.Service<Service, Interface>()("@sonderr/Storage") {}
...
// sonderr_change start - the storage root is injectable so tests can point Storage at a
