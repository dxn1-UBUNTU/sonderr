...
export namespace RemoteProtocol {
  ...
  export const SessionInfo = z.object({
    ...
    // sonderr_change - K1 W1: per-session platform advertises the platform the
    ...
    // sonderr_change - PR link: the pull request linked to the worktree this
  ...
  // sonderr_change - K1 W1: instance advertisement. Presence on a heartbeat
  ...
  export const Capabilities = z
    .object({
      ...
      // sonderr_change - sessionClone: present only when the CLI accepts a
      // cloud-session clone (create_session.cloneFromSonderrSessionId). The old
  ...
  export const Heartbeat = z.object({
    ...
    instance: InstanceAdvertisement.optional(), // sonderr_change - K1 W1
