 ...
 *   "@sonderr/ServerAuthConfig",
 *   {
 *     password: Config.string("SONDERR_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("SONDERR_SERVER_USERNAME").pipe(Config.withDefault("sonderr")),
 *   },
 * ) {}
 *
