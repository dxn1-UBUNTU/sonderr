...
const disabled = process.env["SONDERR_DISABLE_SHARE"] === "true" || process.env["SONDERR_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@sonderr/ShareNext") {}
...
// sonderr_change start - preserve the share transport contract when stored legacy summary diffs omit file details
