...
import type { AssistantMessage as SonderrAssistantMessage, Message } from "@sonderr/sdk/v2"
...
export type AssistantTokenCost = Pick<SonderrAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<SonderrAssistantMessage, "role"> &
  Partial<Pick<SonderrAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@sonderr/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@sonderr/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@sonderr/ACPUsage") {}
