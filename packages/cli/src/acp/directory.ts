...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@sonderr/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@sonderr/ACPDirectory") {}
