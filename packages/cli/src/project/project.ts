...
export class Service extends Context.Service<Service, Interface>()("@sonderr/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.SONDERR_FAKE_VCS)
