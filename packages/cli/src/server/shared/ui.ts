...
import { ConsoleAssets } from "@/sonderr/console/assets" // sonderr_change
...
export function embeddedUI(disableEmbeddedWebUi: boolean) {
  ...
  return (embeddedUIPromise ??=
    ...
    import("sonderr-web-ui.gen.ts").then((module) => module.default as Record<string, string>).catch(() => null))
}
...
export function serveUIEffect(
  ...
  return Effect.gen(function* () {
    ...
    // sonderr_change start - serve Sonderr Console under /console
    ...
    // sonderr_change - no proxy fallback to app.sonderr.ai; embedded UI only
    return notFound()
  })
}
