      ...
      .add(
        HttpApiEndpoint.get("get", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the current Sonderr configuration settings and preferences.", // sonderr_change
          }),
        ),
        HttpApiEndpoint.patch("update", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Update Sonderr configuration settings and preferences.", // sonderr_change
          }),
        ),
        // sonderr_change start
