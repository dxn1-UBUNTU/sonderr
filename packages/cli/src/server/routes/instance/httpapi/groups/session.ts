...
export const DiffQuery = Schema.Struct({
  ...WorkspaceRoutingQueryFields,
  ...Struct.omit(SessionSummary.DiffInput.fields, ["sessionID", "full"]), // sonderr_change - full is a query boolean
  full: Schema.optional(QueryBoolean), // sonderr_change - request full-content detail
})
...
export const SessionPaths = {
  ...
  viewed: `${root}/viewed`, // sonderr_change
} as const
...
export const SessionApi = HttpApi.make("session")
      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all Sonderr sessions, sorted by most recently updated.", // sonderr_change
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific Sonderr session.", // sonderr_change
          }),
        ),
        ...
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new Sonderr session for interacting with AI assistants and managing conversations.", // sonderr_change
          }),
        ),
        ...
        HttpApiEndpoint.post("fork", SessionPaths.fork, {
          params: { sessionID: SessionID },
          query: WorkspaceRoutingQuery,
          payload: [HttpApiSchema.NoContent, ForkPayload], // sonderr_change - carry upstream bodyless full-session fork support
          success: described(Session.Info, "200"),
          error: [HttpApiError.BadRequest, ApiNotFoundError], // sonderr_change - carry upstream malformed payload response
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.delete("deleteMessage", SessionPaths.deleteMessage, {
          params: { sessionID: SessionID, messageID: MessageID },
          query: DeleteMessageQuery, // sonderr_change
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "sonderr experimental HttpApi",
      version: "0.0.1",
