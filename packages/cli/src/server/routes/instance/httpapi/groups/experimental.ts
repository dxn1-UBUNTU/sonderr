...
export const ExperimentalPaths = {
  ...
  worktreeDiff: "/experimental/worktree/diff", // sonderr_change
  worktreeDiffFile: "/experimental/worktree/diff/file", // sonderr_change
  worktreeDiffSummary: "/experimental/worktree/diff/summary", // sonderr_change
      ...
      .add(
        HttpApiEndpoint.get("capabilities", ExperimentalPaths.capabilities, {
          ...
          OpenApi.annotations({
            ...
            description: "Get experimental features enabled on the Sonderr server.",
          }),
        ),
        ...
        HttpApiEndpoint.post("consoleSwitch", ExperimentalPaths.consoleSwitch, {
          ...
          OpenApi.annotations({
            ...
            description: "Persist a new active Console account/org selection for the current local Sonderr state.",
          }),
        ),
        ...
        HttpApiEndpoint.get("worktree", ExperimentalPaths.worktree, {
          query: WorkspaceRoutingQuery,
          success: described(WorktreeList, "List of worktrees"), // sonderr_change
          error: WorktreeApiError,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "worktree.list",
            summary: "List worktrees",
            description: "List all git worktrees for the current project and whether Sonderr manages them.", // sonderr_change
          }),
        ),
