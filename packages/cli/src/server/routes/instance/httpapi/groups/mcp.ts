...
import { McpApps } from "@/sonderr/mcp/apps" // sonderr_change - MCP Apps schemas live in Sonderr-owned code
...
export const McpPaths = {
  ...
  readResource: "/experimental/resource/read", // sonderr_change
  callTool: "/experimental/mcp/call-tool", // sonderr_change
} as const
  ...
  .add(
    HttpApiGroup.make("mcp")
      .add(
        ...
        // sonderr_change start - MCP Apps experimental endpoints
