...
export const mcpHandlers = HttpApiBuilder.group(InstanceHttpApi, "mcp", (handlers) =>
  Effect.gen(function* () {
    ...
    // sonderr_change start - MCP Apps experimental resource/tool endpoints; logic lives in @/sonderr/mcp/apps
    ...
    return handlers
      ...
      .handle("readResource", readResource) // sonderr_change
      .handle("callTool", callTool) // sonderr_change
  }),
)
