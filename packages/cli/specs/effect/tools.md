...
Practical reference for the current tool-migration state in `packages/cli`.
...
Tool tests should use the existing Effect helpers in `packages/cli/test/lib/effect.ts`:
