...
How we write Effect code in `packages/cli`. The companion roadmap is
[`todo.md`](./todo.md).
...
export class Service extends Context.Service<Service, Interface>()("@sonderr/Foo") {}
...
Read sonderr runtime flags through
