...
import { EventManifest as SchemaEventManifest } from "@sonderr/schema/event-manifest"
...
describe("public event manifest", () => {
  test("contains every latest public wire type once", () => {
    ...
    expect(EventManifest.Latest.size).toBe(90) // sonderr_change - include global.config.updated and worktree.setup.ready
    ...
    expect(EventManifest.Latest.has("global.config.updated")).toBe(true) // sonderr_change
  })
