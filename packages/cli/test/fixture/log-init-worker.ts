...
process.env.SONDERR_TEST_HOME = path.join(dir, "home")

const Log = await import("@sonderr/core/util/log")
...
await fs.mkdir(path.join(dir, "share", "sonderr", "log"), { recursive: true })
