...
describe("tool parameters", () => {
  ...
  describe("shell", () => {
    ...
    // sonderr_change start - description is optional in sonderr (see bash.ts Parameters)
    test("accepts missing description (optional in sonderr)", () => {
  ...
  describe("grep", () => {
    ...
    // sonderr_change start - configurable grep signal controls
  ...
  describe("websearch", () => {
    test("accepts query", () => {
      expect(parse(WebSearch, { query: "sonderr" }).query).toBe("sonderr")
    })
  })
