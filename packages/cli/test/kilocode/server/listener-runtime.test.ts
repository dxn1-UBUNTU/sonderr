...
const previous = {
  flag: Flag.SONDERR_SERVER_PASSWORD,
  env: process.env.SONDERR_SERVER_PASSWORD,
}

afterEach(async () => {
  Flag.SONDERR_SERVER_PASSWORD = previous.flag
  if (previous.env === undefined) delete process.env.SONDERR_SERVER_PASSWORD
  else process.env.SONDERR_SERVER_PASSWORD = previous.env
