...
import type { Event, Session, SessionNetworkWait, SuggestionRequest } from "@sonderr/sdk/v2"
import type { TuiAttentionNotifyInput } from "@sonderr/plugin/tui"
...
describe("Sonderr attention TUI plugin", () => {
