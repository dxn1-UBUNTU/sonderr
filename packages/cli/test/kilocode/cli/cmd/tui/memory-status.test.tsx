...
import type { Event, Message, Part, Session } from "@sonderr/sdk/v2"
import { createSignal } from "solid-js"
import { MemorySidebar } from "@/sonderr/cli/cmd/tui/component/memory-status"
    ...
    setParts([
      {
        ...
        type: "text",
        text: "",
        metadata: { sonderrMemory: { type: "recall", count: 2 } },
      },
    ])
