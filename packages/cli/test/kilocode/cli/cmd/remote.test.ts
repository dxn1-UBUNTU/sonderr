...
// Shared helper lives in sonderr-sessions; remote.ts re-exports for the CLI path.
import { buildInstanceAdvertisement } from "../../../../src/sonderr-sessions/instance-advertisement"
