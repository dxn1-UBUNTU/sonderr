...
import * as Reference from "../../src/sonderr/reference"
import { Reference as CoreReference } from "@sonderr/core/reference"
...
import { locations } from "../../src/sonderr/server/reference-reconciler"
import { testInstanceStoreLayer, tmpdir } from "../fixture/fixture"

function remote() {
  const item = Reference.resolveAll({
    references: { docs: "Sonderr-Org/sonderr" },
    directory: "/workspace",
    worktree: "/workspace",
  })[0]
