...
import type { BackgroundProcessInfo, GlobalEvent, Session } from "@sonderr/sdk/v2"
...
function sessionInfo(id: string, revert?: Session["revert"]): Session {
  return {
    ...
    slug: "session",
    projectID: "proj_test",
    directory: "/tmp/sonderr/packages/cli",
    title: "Session",
    version: "1",
  ...
  test("moves inherited processes between session buckets", async () => {
    ...
    try {
      emit({
        ...
        payload: {
          type: "background_process.updated",
          properties: { info: processInfo(id, child, "parent", 1), scope: "/tmp/sonderr/packages/cli" },
        },
      } as unknown as GlobalEvent)
      ...
      emit({
        ...
        payload: {
          type: "background_process.updated",
          properties: { info: processInfo(id, parent, "session", 2), scope: "/tmp/sonderr/packages/cli" },
        },
      } as unknown as GlobalEvent)
    ...
    try {
      for (const info of [
        ...
        emit({
          ...
          payload: {
            type: "background_process.updated",
            properties: { info, scope: "/tmp/sonderr/packages/cli" },
          },
        } as unknown as GlobalEvent)
      }
          ...
          syncEvent: {
            ...
            data: {
              ...
              info: {
                ...
                mode: "code",
                agent: "code",
                path: { cwd: "/tmp/sonderr", root: "/tmp/sonderr" },
                cost: 0,
          ...
          syncEvent: {
            ...
            data: {
              ...
              info: {
                ...
                role: "user",
                agent: "code",
                model: { providerID: "sonderr", modelID: "sonderr-auto/free" },
                time: { created: 2 },
              },
            },
          },
