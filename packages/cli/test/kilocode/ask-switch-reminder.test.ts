...
import ASK_CODE_SWITCH from "../../src/sonderr/session/ask-code-switch.txt"
...
describe("insertAgentSwitchReminder", () => {
  test("injects Ask to Code reminder when the previous turn was Ask", () => {
    ...
    const added = SonderrSessionPrompt.insertAgentSwitchReminder({
      agent: { name: "code" },
      userMessage: next,
  ...
  test("does not inject after an intermediate non-Ask agent", () => {
    ...
    SonderrSessionPrompt.insertAgentSwitchReminder({
      agent: { name: "code" },
      userMessage: next,
  ...
  test("does not inject twice on the same user message", () => {
    ...
    const first = SonderrSessionPrompt.insertAgentSwitchReminder({
      agent: { name: "code" },
      userMessage: next,
      messages: [ask, reply, next],
    })
    next.parts.push(first!)
    const second = SonderrSessionPrompt.insertAgentSwitchReminder({
      agent: { name: "code" },
      userMessage: next,
      messages: [ask, reply, next],
    })
