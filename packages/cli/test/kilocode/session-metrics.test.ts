...
import { computeMetrics, formatRate } from "@/sonderr/session/metrics"
...
describe("sonderr.session.metrics.computeMetrics", () => {
...
describe("sonderr.session.metrics.formatRate", () => {
  test.each([
    [0, "0 t/s"],
    [12, "12 t/s"],
    [412.5, "412.5 t/s"],
