...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SONDERR_CALLER", () => {
    process.env["SONDERR_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SONDERR_CALLER", () => {
    process.env["SONDERR_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SONDERR_CALLER", () => {
    process.env["SONDERR_CALLER"] = "unknown"
