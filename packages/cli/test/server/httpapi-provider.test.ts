...
import { preparePluginDependencies } from "../sonderr/plugin-dependencies" // sonderr_change
...
function writeProviderAuthPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* Effect.promise(() => preparePluginDependencies(dir)) // sonderr_change

    yield* fs.writeWithDirs(
      path.join(dir, ".sonderr", "plugin", "provider-oauth-parity.ts"), // sonderr_change
      [
        "export default {",
...
function writeProviderAuthValidationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".sonderr", "plugin", "provider-oauth-validation.ts"), // sonderr_change
      [
        "export default {",
...
function writeFunctionOptionsPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".sonderr", "plugin", "provider-function-options.ts"), // sonderr_change
      [
        "export default {",
...
function writeProviderModelsMutationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".sonderr", "plugin", "provider-models-mutation.ts"), // sonderr_change
      [
        "export default {",
...
describe("provider HttpApi", () => {
  it.instance.skip(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* request("/api/provider/missing", {
        headers: { "x-sonderr-directory": directory },
      })
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      const directory = (yield* TestInstance).directory
      const headers = { "x-sonderr-directory": directory, "content-type": "application/json" }
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const headers = { "x-sonderr-directory": directory }
