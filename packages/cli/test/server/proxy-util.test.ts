...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips sonderr-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-sonderr-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-sonderr-directory")).toBeNull()
      expect(result.get("x-sonderr-workspace")).toBeNull()
