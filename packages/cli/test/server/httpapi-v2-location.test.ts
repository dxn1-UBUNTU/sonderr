...
describe("v2 location HttpApi", () => {
  // sonderr_change start - malformed Sonderr location headers are client errors
  ...
  test("streams native EventV2 payloads across locations", async () => {
    ...
    // sonderr_change start - the native handler must encode Sonderr events omitted from upstream's narrower manifest
