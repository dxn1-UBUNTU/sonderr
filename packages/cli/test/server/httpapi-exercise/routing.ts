...
export function parseOptions(args: string[]): Options {
  ...
  return {
    ...
    // sonderr_change start - each shard owns an isolated DB already; --shard <index>/<total> lets the runner
...
// sonderr_change start - allow external (CI) callers to fan the exerciser out across N processes by index
