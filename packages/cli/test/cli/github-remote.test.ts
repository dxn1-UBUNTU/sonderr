...
// sonderr_change start: rebrand fixtures off upstream repo path
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/Sonderr-Org/sonderr.git")).toEqual({
    owner: "Sonderr-Org",
    repo: "sonderr",
  })
})
...
test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/Sonderr-Org/sonderr")).toEqual({ owner: "Sonderr-Org", repo: "sonderr" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:Sonderr-Org/sonderr.git")).toEqual({ owner: "Sonderr-Org", repo: "sonderr" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:Sonderr-Org/sonderr")).toEqual({ owner: "Sonderr-Org", repo: "sonderr" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/Sonderr-Org/sonderr.git")).toEqual({
    owner: "Sonderr-Org",
    repo: "sonderr",
  })
})
...
test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/Sonderr-Org/sonderr")).toEqual({ owner: "Sonderr-Org", repo: "sonderr" })
})
// sonderr_change end
