...
import type { GitContext } from "@/sonderr/commit-message/types"
...
const realLog = await import("@sonderr/core/util/log")
...
mock.module("@sonderr/core/util/log", () => ({
  ...realLog,
  create: () => ({
    info: () => {},
    error: () => {},
...
import { CommitMessageRuntime, generateCommitMessage, NoChangesError } from "../../../src/sonderr/commit-message/generate"
