...
import type { PluginInput } from "@sonderr/plugin"
import { CodexAuthPlugin } from "../../src/plugin/openai/codex"

test("identifies Codex refresh requests as Sonderr", async () => {
  ...
  expect(refresh.headers.get("user-agent")).toMatch(/^sonderr\//)
