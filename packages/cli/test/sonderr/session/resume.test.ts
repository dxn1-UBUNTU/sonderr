...
const setup = Effect.fnUntraced(function* () {
  ...
  yield* fs.writeWithDirs(
    path.join(instance.directory, "sonderr.json"),
    JSON.stringify({
...
it.instance(
  "resumes an aborted Sonderr stream on the original user turn",
  () =>
    Effect.gen(function* () {
...
it.instance(
  "does not restart a completed Sonderr response",
  () =>
    Effect.gen(function* () {
...
it.instance(
  "retains interrupted tool results when resuming an unfinished Sonderr turn",
  () =>
    Effect.gen(function* () {
