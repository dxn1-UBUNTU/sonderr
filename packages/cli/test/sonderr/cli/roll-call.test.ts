...
import { formatTable, formatMarkdown, handle, isTextModel, outputLimit } from "../../../src/sonderr/cli/cmd/roll-call"
...
describe("formatTable", () => {
  test("formats simple table correctly", () => {
    const rows = [
      ["sonderr/test-model", "YES", "Hello!", "1000ms"],
      ["sonderr/another-model", "NO", "(Error)", "500ms"],
    ]
