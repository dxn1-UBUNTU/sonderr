...
describe("installation", () => {
  describe("latest", () => {
    // sonderr_change start - curl/unknown fallback now resolves from the public npm
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(curlCalls).toContain("https://registry.npmjs.org/@sonderr%2fcli/local")
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(npmCalls).toContain(`https://registry.npmjs.org/@sonderr%2fcli/${InstallationChannel}`) // sonderr_change
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(bunCalls).toContain(`https://registry.npmjs.org/@sonderr%2fcli/${InstallationChannel}`) // sonderr_change
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(pnpmCalls).toContain(`https://registry.npmjs.org/@sonderr%2fcli/${InstallationChannel}`) // sonderr_change
      }),
    )
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("Sonderr-Org/tap/sonderr")) return "" // sonderr_change
          if (cmd === "brew" && args.includes("--formula") && args.includes("sonderr")) return "sonderr" // sonderr_change
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("Sonderr-Org/tap/sonderr") && args.includes("--formula")) return "sonderr" // sonderr_change
