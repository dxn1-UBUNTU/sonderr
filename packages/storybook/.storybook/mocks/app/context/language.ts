const dict: Record<string, string> = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Sonderr",
  "dialog.model.unpaid.addMore.title": "Add more models from popular providers",
  "dialog.model.unpaid.viewMoreProviders": "See 70+ more providers",
  "dialog.provider.sonderr.tagline": "Reliable optimized models",
  "dialog.provider.sonderrGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.sonderrZen.line1":
    "Sonderr Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.sonderrZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.sonderrZen.visit.prefix": "Visit ",
  "provider.connect.sonderrZen.visit.link": "sonderr.ai/zen",
  "provider.connect.sonderrZen.visit.suffix": " to collect your API key.",
