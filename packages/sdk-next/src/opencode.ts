import { Sonderr } from "@sonderr/client/effect"
...
import { createEmbeddedRoutes } from "@sonderr/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Sonderr.create")(function* () {
  ...
  const client = yield* Sonderr.make({ baseUrl: "http://sonderr.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@sonderr/sdk-next/Sonderr") {}
