...
export const TypeId: TypeId = "~@sonderr/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@sonderr/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@sonderr/effect-sqlite-node/NodeSqliteClient")
