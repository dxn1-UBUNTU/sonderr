/** Provider id and `sonderr.json` key (see https://atomic.chat and models.dev). */
...
export const LOG_PREFIX = "[@sonderr/plugin-atomic-chat]" as const

export const ATOMIC_CHAT_PLUGIN = "@sonderr/plugin-atomic-chat" as const
