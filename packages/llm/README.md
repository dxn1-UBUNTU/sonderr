...
Schema-first LLM core for sonderr. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@sonderr/llm"
import { OpenAI } from "@sonderr/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@sonderr/llm/providers"
