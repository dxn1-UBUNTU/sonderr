...
class Database extends Context.Service<Database, DatabaseShape>()("@sonderr/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@sonderr/example/UserStore") {
