...
export function AppHeader() {
  return (
    <header class="app-header">
      <A class="header-brand" href="/projects" aria-label="Sonderr Console home">
        <img class="header-mark header-mark-logo" src={`${import.meta.env.BASE_URL}sonderr-logo.svg`} alt="" width="28" height="28" />
