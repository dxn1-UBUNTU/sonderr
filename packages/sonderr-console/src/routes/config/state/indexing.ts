...
import { isFileExtension } from "@sonderr/sonderr-indexing/file-extensions"

export { parseFileExtensions } from "@sonderr/sonderr-indexing/file-extensions"
...
export function providerPatch(provider: IndexingConfig["provider"] | "", model?: string): IndexingConfig {
  return {
    ...
    model: provider === "sonderr" ? model || undefined : undefined,
    dimension: undefined,
  }
}
