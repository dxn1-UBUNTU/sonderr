...
import { IconButton } from "@sonderr/sonderr-web-ui/icon-button"
import type { Model } from "@sonderr/sdk/v2/client"
  ...
  return (
    <Show when={state.snap()}>
      <ConfigPage
        ...
        description="The models Sonderr uses when an agent or command doesn't pin its own."
      >
        ...
        <Card class="ui-card" padding={0}>
          <header class="ui-card-header">
            <div>
              ...
              <p>Control which Sonderr Gateway models appear in model lists.</p>
            </div>
          ...
          <div class="ui-form">
            ...
            >
              <span>
                ...
                <small>Hide Sonderr Gateway models whose providers may use your prompts for training.</small>
            ...
            <Show when={state.gateway()}>
              <div class="models-privacy-filter-group">
                ...
                <button
                  ...
                  type="button"
                  aria-label="Hide Sonderr Gateway models whose providers may use prompts for training"
