...
import { ConfigRow, SectionTitle } from "@sonderr/sonderr-web-ui/console"
...
export function FormattersRoute() {
  ...
  return (
    <ConfigPage
      ...
      description="Control native and custom formatters Sonderr can run after editing files."
      actions={
        <>
          <Button
            variant="secondary"
      ...
      <div class="formatters">
        <section class="formatter-group">
          <SectionTitle
            ...
            description="Native formatter integrations from Sonderr. Edit a row to override command, extensions, or environment."
          >
            Built-in Formatters
          </SectionTitle>
      ...
      <div class="formatters">
        <section class="formatter-group">
          <SectionTitle
            ...
            description="Native LSP servers from Sonderr. Edit a row to disable it or provide a custom launch command."
          >
