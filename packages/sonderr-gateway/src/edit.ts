import { SONDERR_API_BASE } from "./api/constants.js"
...
export type EditTarget =
  ...
  | { provider: "sonderr"; model: string; url: string }
...
const SONDERR_NEXTEDIT_URL = SONDERR_API_BASE + "/api/edit/completions"

/**
 * Pick the upstream edit endpoint for a (provider, model) pair. Today this is
 * either Inception's `/v1/edit/completions` (direct BYOK) or the Sonderr Gateway's
