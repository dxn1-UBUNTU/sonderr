...
import type { SonderrProviderOptions } from "./types.js"
...
/**
 * Debug version of createSonderr with extensive logging
 */
export function createSonderrDebug(options: SonderrProviderOptions = {}): SDK {
  console.log("\n🔍 [SONDERR DEBUG] Creating Sonderr Provider")
  console.log("📋 [SONDERR DEBUG] Options received:", JSON.stringify(options, null, 2))

  // Get API key from options or environment
  const apiKey = getApiKey(options)
  console.log("🔑 [SONDERR DEBUG] API Key extracted:")
  console.log("  - Source:", options.sonderrToken ? "sonderrToken" : options.apiKey ? "apiKey" : "none")
  ...
  console.log("🔗 [SONDERR DEBUG] OpenRouter URL:", openRouterUrl)
  ...
  console.log("📝 [SONDERR DEBUG] Custom headers:", JSON.stringify(customHeaders, null, 2))
  ...
  console.log("✅ [SONDERR DEBUG] Creating OpenRouter provider with configuration\n")

  // Create OpenRouter provider with Sonderr configuration
