...
/**
 * Options for creating a Sonderr provider instance
 */
export interface SonderrProviderOptions {
  /**
   * Sonderr authentication token
   */
  sonderrToken?: string
  ...
  /**
   * Base URL for the Sonderr API
   * Can be overridden by SONDERR_API_URL environment variable
  ...
  /**
   * API key (alternative to sonderrToken)
   */
  apiKey?: string
 ...
 */
export interface SonderrMetadata {
  /**
...
export type SonderrProvider = Provider & {
