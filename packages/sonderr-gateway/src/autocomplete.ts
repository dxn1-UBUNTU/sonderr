export type AutocompleteProviderID = "sonderr" | "mistral" | "inception"
export type DirectAutocompleteProviderID = Exclude<AutocompleteProviderID, "sonderr">
...
interface AutocompleteModelBase {
  ...
  /** Provider key to use for direct BYOK. Empty means Sonderr Gateway. */
...
export type AutocompleteModelDef = AutocompleteModelBase &
  (
    | {
        /** Route through `/sonderr/edit` using the Next Edit pipeline. */
        readonly kind: "edit"
...
const models: AutocompleteModelDef[] = [
  {
    id: "sonderr/mistralai/codestral-2508",
    modelID: "mistralai/codestral-2508",
    label: "Codestral",
    providerID: "sonderr",
    provider: "Sonderr Gateway",
    requestModel: "mistralai/codestral-2508",
    temperature: 0.2,
  },
  {
    id: "sonderr/inception/mercury-edit-2",
  ...
  {
    // Same wire-level model as `sonderr/inception/mercury-edit-2`, but routed
    // through the Sonderr Gateway's Next Edit endpoint instead of FIM. Picked by
    // users who want multi-line next-edit predictions with the jump-to-edit UX.
    id: "sonderr/inception/mercury-next-edit",
    ...
    temperature: 0,
    kind: "edit",
    fimModelID: "sonderr/inception/mercury-edit-2",
  },
  {
...
export const DEFAULT_AUTOCOMPLETE_PROVIDER_ID: AutocompleteProviderID = "sonderr"
...
export function getAutocompleteModel(provider?: string, model?: string): AutocompleteModelDef {
  // When provider is unset, always default to Sonderr Gateway. Direct-provider
