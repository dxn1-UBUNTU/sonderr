...
import { compile, emitEffectImported, emitPromise, write } from "@sonderr/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "SonderrEventEncoded",
              import: 'import type { SonderrEventEncoded } from "@sonderr/protocol/groups/event"',
            },
          },
        }),
