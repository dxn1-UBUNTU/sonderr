 ...
 * metadata. Sonderr-hosted embedding catalog metadata is fetched from Cloud so the
...
export function normalizeSonderrModelId(modelId: string | undefined): string | undefined {
  return modelId
}
