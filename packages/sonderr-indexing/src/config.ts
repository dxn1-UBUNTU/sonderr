...
export const IndexingConfig = z
  .object({
    ...
    sonderr: z
      ...
      .strict()
      .optional()
      .describe("Sonderr-hosted embedding provider options"),
    openai: z
...
export const IndexingSchema = Schema.Struct({
  ...
  sonderr: Schema.optional(
    Schema.Struct({
      apiKey: Schema.optional(Schema.String),
      baseUrl: Schema.optional(Schema.String),
      organizationId: Schema.optional(Schema.String),
    }),
  ).annotate({ description: "Sonderr-hosted embedding provider options" }),
...
export function toIndexingConfigInput(cfg: IndexingConfig | undefined): IndexingConfigInput {
  ...
  return {
    ...
    sonderrApiKey: cfg?.sonderr?.apiKey,
    sonderrBaseUrl: cfg?.sonderr?.baseUrl,
    sonderrOrganizationId: cfg?.sonderr?.organizationId,
