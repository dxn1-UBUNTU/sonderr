...
- Effect plugins import `@sonderr/plugin/v2/effect`, not `@sonderr/core`.
- Public domain values use generated `@sonderr/sdk` types.
...
- Define `PluginHost` domain capabilities in `@sonderr/plugin/v2/effect`.
